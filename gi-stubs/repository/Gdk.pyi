...
def cairo_set_source_pixbuf(cr: cairo.Context[_SomeSurface], pixbuf: GdkPixbuf.Pixbuf, pixbuf_x: float, pixbuf_y: float) -> None: ...
def cairo_set_source_rgba(*args, **kwargs): ...
def cairo_set_source_window(*args, **kwargs): ...
def cairo_surface_create_from_pixbuf(pixbuf: GdkPixbuf.Pixbuf, scale: int, for_window: Optional[Window] = None) -> cairo.ImageSurface: ...
...
def pixbuf_get_from_surface(surface: cairo.ImageSurface, src_x: int, src_y: int, width: int, height: int) -> Optional[GdkPixbuf.Pixbuf]: ...

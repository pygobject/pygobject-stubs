...
class Resource:
    def enumerate_children(self, path: str, lookup_flags: ResourceLookupFlags) -> list[str]: ...
    ...
    def open_stream(self, path: str, lookup_flags: ResourceLookupFlags) -> Optional[InputStream]: ...

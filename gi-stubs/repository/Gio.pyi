...
class MenuItem:
    def get_attribute_value(self, attribute: str, expected_type: Optional[GLib.VariantType] = None) -> Optional[GLib.Variant]: ...
    ...
    def set_attribute(self, attributes: list[tuple[str, str, Any]]): ...

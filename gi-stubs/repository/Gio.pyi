...
def content_type_guess(
    filename: str | None, data: bytes | None
) -> tuple[str, bool]: ...
...
class ActionMap(GObject.GInterface):
    ...
    def lookup_action(self, action: str) -> SimpleAction | None: ...
...
class AppInfo:
    ...
    @classmethod
    def get_default_for_uri_scheme(cls, uri_scheme: str) -> AppInfo | None: ...
...
class Application(GObject.Object, ActionGroup, ActionMap):
    ...
    def set_application_id(self, id: str | None) -> None: ...
...
class DBusProxy:
    ...
    def new(
        ...
        interface_name: str,
        cancellable: Cancellable | None,
        callback: AsyncReadyCallbackU | None,
        user_data: Any | None,
    ) -> None: ...
    @classmethod
...
class File:
    ...
    def load_contents_async(
        self, cancellable: Cancellable | None, callback: AsyncReadyCallback
    ) -> None: ...
    @overload
    def load_contents_async(
        self,
...
class Icon(GObject.GInterface):
    @classmethod
    def deserialize(cls, value: GLib.Variant) -> Icon | None: ...
...
class MenuItem:
    ...
    @classmethod
    def new(cls, label: str | None = ..., action: str | None = ...) -> MenuItem: ...
    @classmethod
...
class SimpleProxyResolver(ProxyResolver):
    ...
    @classmethod
    def new(
        cls, default_proxy: str | None, ignore_hosts: str | None
    ) -> SimpleProxyResolver: ...

...
def error_underline_path(cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
...
def glyph_string_path(cr: cairo.Context[_SomeSurface], font: Pango.Font, glyphs: Pango.GlyphString) -> None: ...
...
def show_error_underline(cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def show_glyph_item(cr: cairo.Context[_SomeSurface], text: str, glyph_item: Pango.GlyphItem) -> None: ...
def show_glyph_string(cr: cairo.Context[_SomeSurface], font: Pango.Font, glyphs: Pango.GlyphString) -> None: ...
def show_layout(cr: cairo.Context[_SomeSurface], layout: Pango.Layout) -> None: ...
def show_layout_line(cr: cairo.Context[_SomeSurface], line: Pango.LayoutLine) -> None: ...

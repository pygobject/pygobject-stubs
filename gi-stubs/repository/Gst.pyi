...
def init(argv: Optional[list[str]]) -> list[str]: ...
def init_check(argv: Optional[list[str]]) -> tuple[bool, list[str]]: ...
...
class Bin(ChildProxy, Element):
    ...
    @classmethod
    def new(cls, name: Optional[str]) -> Bin: ...
...
class GhostPad(ProxyPad):
    @classmethod
    def new(cls, name: Optional[str], target: Pad) -> Optional[GhostPad]: ...
...
class Structure:
    ...
    def get_value(self, fieldname: str) -> Optional[GObject.Value]: ...

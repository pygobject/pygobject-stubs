...
def init(self, argv: list[str] | None) -> list[str]: ...
def init_check(self, argv: list[str] | None = ...) -> tuple[bool, list[str]]: ...
...
class ElementFactory(PluginFeature):
    ...
    @classmethod
    def find(cls, name: str) -> ElementFactory | None: ...
    ...
    @classmethod
    def make(cls, factoryname: str, name: str | None) -> Element | None: ...

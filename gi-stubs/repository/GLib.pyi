...
@overload
def timeout_add(mseconds: int, func: Callable[[], Optional[bool]]) -> int: ...
@overload
def timeout_add(mseconds: int, func: Callable[[Any], Optional[bool]], data: Any) -> int: ...
@overload
...
class Uri:
    ...
    @classmethod
    def escape_string(cls, unescaped: str, reserved_chars_allowed: Optional[str], allow_utf8: bool) -> str: ...
...
class Variant:
    ...
    @classmethod
    def new_from_data(cls, type: VariantType, data: bytes, trusted: bool, notify: Callable[..., Any], user_data: Optional[Any] = ...) -> Variant: ...
...
class VariantDict:
    ...
    def lookup_value(self, key: str, expected_type: Optional[VariantType] = ...) -> Optional[Variant]: ...
    @classmethod

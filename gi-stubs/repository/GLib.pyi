...
@overload
def idle_add(
    func: Callable[[Any], Optional[bool]], data: Optional[Any] = ...
) -> int: ...
@overload
...
@overload
def timeout_add(
    mseconds: int, func: Callable[[Any], Optional[bool]], data: Any
) -> int: ...
@overload
def timeout_add_seconds(seconds: int, func: Callable[[], Optional[bool]]) -> int: ...
@overload
def timeout_add_seconds(
    seconds: int, func: Callable[[Any], Optional[bool]], data: Any
) -> int: ...

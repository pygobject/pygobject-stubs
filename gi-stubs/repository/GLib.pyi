...
@overload
def idle_add(func: Callable[[Any], bool | None], data: Any | None = ...) -> int: ...
@overload
def idle_add(func: Callable[[], bool | None]) -> int: ...
...
def markup_escape_text(str: str | bytes, length: int = ...) -> str: ...
...
@overload
def timeout_add(mseconds: int, func: Callable[[], bool | None]) -> int: ...
@overload
def timeout_add(
    mseconds: int, func: Callable[[Any], bool | None], data: Any
) -> int: ...
@overload
def timeout_add_seconds(seconds: int, func: Callable[[], bool | None]) -> int: ...
@overload
def timeout_add_seconds(
    seconds: int, func: Callable[[Any], bool | None], data: Any
) -> int: ...
...
class Bytes:
    ...
    @classmethod
    def new(cls, data: bytes | None) -> Bytes: ...

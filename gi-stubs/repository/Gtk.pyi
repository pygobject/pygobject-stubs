...
import cairo
from gi.repository import Atk, Gdk, GdkPixbuf, Gio, GLib, GObject, Pango
...
def alternative_dialog_button_order(screen: Gdk.Screen | None) -> bool: ...
...
def cairo_transform_to_window(
    cr: cairo.Context, widget: Widget, window: Gdk.Window
) -> None: ...
def check_version(
...
def grab_get_current() -> Widget | None: ...
...
def init(argv: list[str] | None) -> str: ...
def init_check(argv: list[str] | None) -> tuple[bool, list[int]]: ...
def init_with_args(
    argv: list[str] | None,
    parameter_string: str | None,
    entries: list[GLib.OptionEntry] | None,
...
def print_run_page_setup_dialog(
    parent: Window | None, page_setup: PageSetup | None, settings: PrintSettings
) -> PageSetup: ...
...
def render_background_get_clip(
    cr: cairo.Context, x: float, y: float, width: float, height: float
) -> Gdk.Rectangle: ...
def render_check(
    context: StyleContext,
    cr: cairo.Context,
...
def render_icon_surface(
    context: StyleContext, cr: cairo.Context, surface: cairo.Surface, x: float, y: float
) -> None: ...
...
def selection_owner_set(
    widget: Widget | None, selection: Gdk.Atom, time: int
) -> bool: ...
def selection_owner_set_for_display(
    display: Gdk.Display, widget: Widget | None, selection: Gdk.Atom, time: int
) -> bool: ...
...
class AboutDialog(Dialog):
    ...
    def set_logo(self, logo: GdkPixbuf.Pixbuf | None) -> None: ...
    def set_logo_icon_name(self, logo_icon_name: str | None) -> None: ...
...
class AccelGroup(GObject.Object):
    ...
    def disconnect(self, closure: GObject.Closure | None) -> bool: ...
    def disconnect_key(self, accel_key: int, accel_mods: Gdk.ModifierType) -> bool: ...
    def find(self, ind_func: AccelGroupFindFunc, *data: object | None) -> AccelKey: ...
...
class AccelLabel(Label):
    ...
    def set_accel_widget(accel_widget: Widget | None) -> None: ...
...
class Actionable(GObject.GInterface):
    ...
    def set_action_name(self, name: str | None) -> None: ...
...
class Application(Gio.Application):
    ...
    def get_app_menu(self) -> Gio.MenuModel | None: ...
...
class Box(Orientable, Container):
    ...
    def __init__(
        self, orientation: Orientation | None = ..., spacing: int | None = ...
    ) -> None: ...
...
class Button(Actionable, Activatable, Bin):
    ...
    def new(*args, **kwargs): ...
    @classmethod
    def new_from_icon_name(cls, icon_name: str | None, size: IconSize) -> Button: ...
    @classmethod
    ...
    def set_always_show_image(*args, **kwargs): ...
    def set_image(self, image: Widget | None) -> None: ...
...
class ComboBox(CellEditable, CellLayout, Bin):
    ...
    def get_active_iter(self) -> TreeIter | None: ...
...
class Container(Widget):
    ...
    def foreach(
        self, callback: Callable[..., Any], callback_data: Any | None = ...
    ) -> None: ...
...
class Dialog(Window):
    ...
    def __init__(self, title: str | None = ..., **kwargs: Any) -> None: ...
    def add_action_widget(*args, **kwargs): ...
...
class Entry(Widget, CellEditable, Editable):
    ...
    def set_icon_from_icon_name(
        self, icon_pos: EntryIconPosition, icon_name: str | None
    ) -> None: ...
    ...
    def set_icon_tooltip_text(
        self, icon_pos: EntryIconPosition, tooltip: str | None
    ) -> None: ...
...
class FileChooser(GObject.GInterface):
    def __init__(self, action: FileChooserAction = ..., **kwargs: Any) -> None: ...
    ...
    def get_preview_file(self) -> Gio.File | None: ...
    def get_preview_filename(self) -> str | None: ...
    def get_preview_uri(self) -> str | None: ...
    def get_preview_widget(self) -> Widget | None: ...
...
class Grid(Container, Orientable):
    ...
    def __init__(self, row_spacing: int = ..., column_spacing: int = ...) -> None: ...
    def attach(
    ...
    def get_child_at(self, left: int, top: int) -> Widget | None: ...
...
class IconInfo(GObject.Object):
    ...
    def load_surface(self, for_window: Gdk.Window | None) -> cairo.Surface: ...
...
class IconTheme:
    ...
    def list_icons(self, context: str | None) -> list[str]: ...
    def load_icon(
        self, icon_name: str, size: int, flags: IconLookupFlags
    ...
    def set_custom_theme(self, theme_name: str | None) -> None: ...
...
class Image(Widget):
    ...
    @classmethod
    def new_from_icon_name(cls, icon_name: str | None, size: IconSize) -> Image: ...
    @classmethod
    ...
    def new_from_stock(cls, *args, **kwargs): ...
    @classmethod
    def new_from_surface(cls, surface: cairo.Surface | None) -> Image: ...
    def set_from_animation(self, animation: GdkPixbuf.PixbufAnimation) -> None: ...
    def set_from_file(self, filename: str | None) -> None: ...
    def set_from_gicon(self, icon: Gio.Icon, size: int) -> None: ...
    def set_from_icon_name(self, icon_name: str | None, size: IconSize) -> None: ...
    ...
    def set_from_surface(self, surface: cairo.Surface | None) -> None: ...
...
class Label(Misc):
    ...
    def __init__(self, label: str = ..., use_markup: bool = ...) -> None: ...
...
class ListBox(Container):
    def bind_model(
        ...
        create_widget_func: Callable[..., Any] | None,
        *user_data: Any | None,
    ) -> None: ...
    ...
    def get_row_at_index(self, index: int) -> ListBoxRow | None: ...
    ...
    def select_row(self, row: Widget | None) -> None: ...
    def selected_foreach(*args, **kwargs): ...
    def set_activate_on_single_click(self, single: bool) -> None: ...
    def set_adjustment(self, adjustment: Adjustment | None) -> None: ...
    def set_filter_func(
        self, filter_func: Callable[..., Any] | None, user_data: Any | None = ...
    ) -> None: ...
    def set_header_func(
        self,
        update_header: Callable[..., Any] | None,
        user_data: Any | None = ...,
    ) -> None: ...
    def set_placeholder(self, placeholder: Widget | None) -> None: ...
    def set_selection_mode(self, mode: SelectionMode) -> None: ...
    def set_sort_func(
        self, sort_func: Callable[..., Any] | None, user_data: Any | None = ...
    ) -> None: ...
    def unselect_all(self) -> None: ...
...
class ListStore(GObject.Object, TreeModel, TreeSortable, TreeDragDest, TreeDragSource):
    ...
    def append(self, row: list[Any] | None = ...) -> TreeIter: ...
    def clear(self) -> None: ...
    def insert(*args, **kwargs): ...
    ...
    def new(*args, **kwargs): ...
    def prepend(self, row: list[Any] | None = ...) -> TreeIter: ...
...
class Menu(MenuShell):
    ...
    def attach_to_widget(
        self, attach_widget: Widget, detacher: Callable[[Widget, Menu], Any] | None
    ) -> None: ...
    ...
    def popup_at_pointer(self, trigger_event: Gdk.Event | None = ...) -> None: ...
...
class MenuButton(ToggleButton):
    ...
    def get_popup(self) -> Menu | None: ...
    def get_use_popover(self) -> bool: ...
    @classmethod
    def new(cls) -> MenuButton: ...
    def set_align_widget(self, align_widget: Widget | None) -> None: ...
    ...
    def set_popup(self, popup: Menu | None) -> None: ...
    def set_use_popover(self, use_popover: bool) -> None: ...

class MenuItem(Bin, Actionable):
    bin = ...

    def __init__(self, label: str | None = ...) -> MenuItem: ...
...
class Popover(Bin):
    ...
    @classmethod
    def new_from_model(
        cls, relative_to: Widget | None, model: Gio.MenuModel
    ) -> Popover: ...
    ...
    def set_relative_to(self, relative_to: Widget | None) -> None: ...
...
class RadioToolButton(ToggleToolButton):
    def get_group(*args, **kwargs): ...
    @classmethod
    def new_from_widget(cls, group: RadioToolButton | None) -> RadioToolButton: ...
...
class Range(Orientable, Widget):
    ...
    def __init__(self, orientation: Orientation | None = ...) -> None: ...
...
class Stack(Container):
    def __init__(self, vhomogeneous: bool = ...) -> None: ...
...
class TargetList:
    ...
    def find(*args, **kwargs): ...
    @classmethod
    def new(cls, targets: list[TargetEntry] | None) -> TargetList: ...
    def ref(*args, **kwargs): ...
    def remove(*args, **kwargs): ...
    def unref(*args, **kwargs): ...
...
class TextBuffer(GObject.Object):
    ...
    def create_mark(
        self, mark_name: str | None, where: TextIter, left_gravity: bool
    ) -> TextMark: ...
    def create_tag(self, tag_name: str | None = ..., **kwargs: Any) -> TextTag: ...
    def cut_clipboard(*args, **kwargs): ...
...
class TextIter:
    ...
    def backward_search(
        self, str: str, flags: TextSearchFlags, limit: TextIter | None
    ) -> tuple[TextIter, TextIter] | None: ...
    ...
    def ends_tag(self, tag: TextTag | None) -> bool: ...
    ...
    def starts_tag(self, tag: TextTag | None) -> bool: ...
...
class TreeModel(GObject.GInterface):
    def __getitem__(self, item: TreeIter | TreePath | str | int) -> TreeModelRow: ...
    def __delitem__(self, item: TreeIter | TreePath | str | int) -> None: ...
    def filter_new(self, root: TreePath | None = ...) -> TreeModelFilter: ...
    def foreach(self, func: Callable[..., Any], *user_data: Any | None) -> None: ...
    ...
    def get_iter(self, path: str | TreePath) -> TreeIter: ...
    def get_iter_first(self) -> TreeIter | None: ...
    ...
    def iter_children(self, parent: TreeIter | None) -> TreeIter | None: ...
    def iter_has_child(self, iter: TreeIter) -> bool: ...
    def iter_n_children(self, iter: TreeIter | None) -> int: ...
    def iter_next(self, iter: TreeIter) -> TreeIter | None: ...
    def iter_nth_child(self, parent: TreeIter | None, n: int) -> TreeIter | None: ...
    def iter_parent(self, child: TreeIter) -> TreeIter | None: ...
    def iter_previous(self, iter: TreeIter) -> TreeIter | None: ...
    ...
    def rows_reordered(
        self, path: TreePath, iter: TreeIter | None, new_order: list[int]
    ) -> None: ...
...
class TreeSelection(GObject.Object):
    ...
    def get_mode(*args, **kwargs): ...
    def get_selected(self) -> tuple[TreeModel, TreeIter | None]: ...
...
class TreeStore(GObject.Object, TreeModel, TreeSortable):
    ...
    def __init__(self, *args: Any) -> None: ...
    def append(
        self, parent: TreeIter | None, row: list[Any] | None = ...
    ) -> TreeIter: ...
    def clear(self) -> None: ...
    def insert(*args, **kwargs): ...
    def insert_after(*args, **kwargs): ...
...
class TreeView(Container):
    ...
    ) -> tuple[TreePath, TreeViewDropPosition] | None: ...
    ...
    def get_path_at_pos(
        self, x: int, y: int
    ) -> tuple[TreePath | None, TreeViewColumn | None, int, int] | None: ...
    def get_reorderable(*args, **kwargs): ...
    ...
    def set_cursor(
        self,
        path: TreePath,
        focus_column: TreeViewColumn | None = ...,
        start_editing: bool = ...,
    ) -> None: ...
...
class TreeViewColumn(Buildable, CellLayout, GObject.InitiallyUnowned):
    ...
    def __init__(
        self, title: str = ..., cell_renderer: CellRenderer = ..., **attrs: Any
    ) -> None: ...
...
class Widget(GObject.Object):
    ...
    def __init__(self, can_default: bool = ..., no_show_all: bool = ...) -> None: ...
    ...
    def drag_dest_find_target(
        self, context: Gdk.DragContext, target_list: TargetList | None
    ) -> Gdk.Atom: ...
    ...
    def drag_dest_set_target_list(self, targets: TargetList | None) -> None: ...
    ...
    def get_composite_name(self) -> str | None: ...
    @classmethod
    ...
    def get_preferred_size(
        self,
    ) -> tuple[Requisition | None, Requisition | None]: ...
    ...
    def input_shape_combine_region(self, region: cairo.Region | None) -> None: ...
...
class Window(Bin):
    ...
    def set_attached_to(self, attach_widget: Widget | None) -> None: ...
    ...
    def set_default(self, default_widget: Widget | None) -> None: ...
    ...
    def set_icon(self, icon: GdkPixbuf.Pixbuf | None) -> None: ...
...
CellRendererT = TypeVar(  # noqa: Y001
    "CellRendererT",
    CellRendererCombo,
    CellRendererPixbuf,

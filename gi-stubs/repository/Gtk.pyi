...
class FileChooser(GObject.GInterface):
    ...
    def __init__(self, action: FileChooserAction = FileChooserAction.OPEN) -> None: ...
...
class TreeView(Container):
    ...
    def set_cursor(self, path: TreePath, focus_column: Optional[TreeViewColumn], start_editing: bool) -> None: ...

...
def cairo_should_draw_window(cr: cairo.Context[_SomeSurface], window: Gdk.Window) -> bool: ...
def cairo_transform_to_window(cr: cairo.Context[_SomeSurface], widget: Widget, window: Gdk.Window) -> None: ...
...
def drag_set_icon_surface(context: Gdk.DragContext, surface: cairo.ImageSurface) -> None: ...
def drag_set_icon_widget(context: Gdk.DragContext, widget: Widget, hot_x: int, hot_y: int) -> None: ...
def draw_insertion_cursor(widget: Widget, cr: cairo.Context[_SomeSurface], location: Gdk.Rectangle, is_primary: bool, direction: TextDirection, draw_arrow: bool) -> None: ...
...
def render_activity(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_arrow(context: StyleContext, cr: cairo.Context[_SomeSurface], angle: float, x: float, y: float, size: float) -> None: ...
def render_background(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_background_get_clip(cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> Gdk.Rectangle: ...
def render_check(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_expander(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_extension(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float, gap_side: PositionType) -> None: ...
def render_focus(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_frame(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_frame_gap(*args, **kwargs): ...
def render_handle(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_icon(context: StyleContext, cr: cairo.Context[_SomeSurface], pixbuf: GdkPixbuf.Pixbuf, x: float, y: float) -> None: ...
def render_icon_pixbuf(*args, **kwargs): ...
def render_icon_surface(context: StyleContext, cr: cairo.Context[_SomeSurface], surface: cairo.ImageSurface, x: float, y: float) -> None: ...
def render_insertion_cursor(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, layout: Pango.Layout, index: int, direction: Pango.Direction) -> None: ...
def render_layout(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, layout: Pango.Layout) -> None: ...
def render_line(context: StyleContext, cr: cairo.Context[_SomeSurface], x0: float, y0: float, x1: float, y1: float) -> None: ...
def render_option(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float) -> None: ...
def render_slider(context: StyleContext, cr: cairo.Context[_SomeSurface], x: float, y: float, width: float, height: float, orientation: Orientation) -> None: ...
...
class Application(Gio.Application):
    ...
    def add_accelerator(self, accelerator: str, action_name: str, parameter: Optional[GLib.Variant]) -> None: ...
    ...
    def inhibit(self, window: Optional[Window], flags: ApplicationInhibitFlags, reason: Optional[str]) -> int: ...
    ...
    def remove_accelerator(self, action_name: str, parameter: Optional[GLib.Variant]) -> None: ...
...
class Box(Orientable, Container):
    ...
    def __init__(self, orientation: Optional[Orientation] = None, spacing: Optional[int] = None, halign: Optional[Align] = Align.FILL, valign: Optional[Align] = Align.FILL) -> None: ...
...
class IconTheme:
    ...
    def load_surface(self, icon_name: str, size: int, scale: int, for_window: Optional[Gdk.Window], flags: IconLookupFlags) -> Optional[cairo.ImageSurface]: ...
...
class ListStore(GObject.Object, TreeModel, TreeSortable, TreeDragDest, TreeDragSource):
    ...
    def append(self, row: Union[list[Any], tuple[Any, ...], None] = None) -> TreeIter: ...
    def clear(self) -> None: ...
    def insert(*args, **kwargs): ...
...
class Scale(Range):
    ...
    def add_mark(self, value: float, position: PositionType, markup: Optional[str]) -> None: ...
...
class TreeViewColumn(Buildable, CellLayout, GObject.InitiallyUnowned):
    ...
    def set_alignment(*args, **kwargs): ...
    def set_attributes(self, cell_renderer: CellRenderer, **attributes: Any) -> None: ...

...
class Container(Widget, Generic[_T]):
    widget = ...
    ...
    def remove(self, widget: _T) -> None: ...
...
class ListBox(Container[_T]):
    ...
    def unselect_all(self) -> None: ...
    def unselect_row(self, row: _T) -> None: ...

...
def accel_groups_from_object(object: GObject.Object): ...
...
def accelerator_parse(accelerator: str): ...
def accelerator_parse_with_keycode(accelerator: str): ...
def accelerator_set_default_mod_mask(default_mod_mask: Gdk.ModifierType): ...
...
def binding_entry_add_signall(binding_set: BindingSet, keyval: int, modifiers: Gdk.ModifierType, signal_name: str, binding_args: List[BindingArg]): ...
def binding_entry_remove(binding_set: BindingSet, keyval: int, modifiers: Gdk.ModifierType): ...
def binding_entry_skip(binding_set: BindingSet, keyval: int, modifiers: Gdk.ModifierType): ...

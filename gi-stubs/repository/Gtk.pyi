...
class Builder(GObject.Object):
    """
    Gtk.Builder is an auxiliary object that reads textual descriptions of a user interface and instantiates the described objects.
    """
    parent_instance = ...
    priv = ...
...
class Window(Bin):
    """
    Gtk.Window is a toplevel window which can contain other widgets.
    """
    bin = ...

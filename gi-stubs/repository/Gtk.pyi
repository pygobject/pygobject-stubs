...
class ListBox(Container):
    ...
    def drag_highlight_row(self, row: Widget) -> None: ...
    def drag_unhighlight_row(self) -> None: ...
    def get_activate_on_single_click(self) -> bool: ...
    def get_adjustment(self) -> Adjustment: ...
    def get_row_at_index(self, index: int) -> Optional[Widget]: ...
    def get_row_at_y(self, y: int) -> Optional[Widget]: ...
    def get_selected_row(self) -> Optional[Widget]: ...
    def get_selected_rows(self) -> list[Widget]: ...

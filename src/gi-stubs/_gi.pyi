...
class GObjectProtocol(Protocol):
    ...
    def weak_ref(
        self, callback: Callable[..., Any] | None = None, /, *user_data: object
    ) -> GObjectWeakRef: ...
...
class Repository:
    ...
    def require(
        self, namespace: str, version: str | None = None, lazy: bool = False
    ) -> None: ...
...
def enum_register(cls: type[Any], type_name: str | None = None, /) -> None: ...
def flags_add(
    module: object, name: str, g_type: GType, flags_info: object
) -> type[GFlags]: ...
def flags_register(cls: type[Any], type_name: str | None = None, /) -> None: ...
...
def type_register(cls: type[Any], type_name: str | None = None, /) -> type[Any]: ...

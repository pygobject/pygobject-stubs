...
def event_handler_set(
    func: Callable[[Event, Unpack[_DataTs]], None], *data: Unpack[_DataTs]
) -> None: ...
...
def threads_add_idle(
    priority: int, function: Callable[[Unpack[_DataTs]], bool], *data: Unpack[_DataTs]
) -> int: ...
def threads_add_timeout(
    priority: int,
    interval: int,
    function: Callable[[Unpack[_DataTs]], bool],
    *data: Unpack[_DataTs],
) -> int: ...
...
class Event(GObject.GBoxed):
    ...
    def get_state(self) -> tuple[bool, ModifierType]: ...
...
class Screen(GObject.Object):
    ...
    def get_width_mm(self) -> int: ...
    def get_window_stack(self) -> list[Window]: ...
    @staticmethod
    def height() -> int: ...
    @staticmethod
    def height_mm() -> int: ...
...
class Seat(GObject.Object):
    ...
    def grab(
        ...
        prepare_func: Callable[[Seat, Window, Unpack[_DataTs]], None] | None = None,
...
class Window(GObject.Object):
    ...
    def get_children_with_user_data(
        self, user_data: int | Any | None = None
    ) -> list[Window]: ...
    ...
    def invalidate_maybe_recurse(
        self,
        region: cairo.Region,
        child_func: Callable[[Window, Unpack[_DataTs]], bool] | None = None,
...
class WindowClass(_gi.Struct):
    ...
    @property
    def pick_embedded_child(self) -> int: ...
    @property

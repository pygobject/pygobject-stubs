...
) -> typing.Tuple[bool, list[str] | None]: ...
...
) -> typing.Tuple[Meta | None, int]: ...
def meta_get_info(impl: str) -> MetaInfo | None: ...
def meta_register_custom(
    name: str,
    tags: typing.Sequence[str],
    transform_func: typing.Callable[..., bool] | None = None,
...
def value_get_fraction_range_max(value: typing.Any) -> typing.Any | None: ...
def value_get_fraction_range_min(value: typing.Any) -> typing.Any | None: ...
...
def value_serialize(value: typing.Any) -> str | None: ...
...
class Bin(Element, ChildProxy):
    ...
    def get_by_interface(self, iface: typing.Type[typing.Any]) -> Element | None: ...
...
class Buffer(MiniObjectMixin, GObject.GBoxed):
    ...
    def get_meta(self, api: typing.Type[typing.Any]) -> Meta | None: ...
    ...
    def new_wrapped_full(
        ...
        maxsize: int,
        offset: int,
        notify: typing.Callable[..., None] | None = None,
        *user_data: typing.Any,
    ) -> Buffer: ...
...
class Bus(Object):
    ...
    def set_sync_handler(
        self,
        func: typing.Callable[..., BusSyncReply] | None = None,
        *user_data: typing.Any,
    ) -> None: ...
...
class ChildProxyInterface(GObject.GPointer):
    ...
    get_child_by_name: typing.Callable[[ChildProxy, str], GObject.Object | None] = ...
    get_child_by_index: typing.Callable[[ChildProxy, int], GObject.Object | None] = ...
...
class ControlBinding(Object):
    ...
    def do_get_value(self, timestamp: int) -> typing.Any | None: ...
    def do_sync_values(
    ...
    def get_value(self, timestamp: int) -> typing.Any | None: ...
...
class ControlBindingClass(GObject.GPointer):
    ...
    get_value: typing.Callable[[ControlBinding, int], typing.Any | None] = ...
...
class DeviceClass(GObject.GPointer):
    ...
    parent_class: ObjectClass = ...
    create_element: typing.Callable[[Device, str | None], Element | None] = ...
...
class DeviceProviderFactory(PluginFeature):
    ...
    def has_classesv(self, classes: typing.Sequence[str] | None = None) -> bool: ...
    @staticmethod
...
class ElementClass(GObject.GPointer):
    ...
    set_bus: typing.Callable[[Element, Bus | None], None] = ...
    provide_clock: typing.Callable[[Element], Clock | None] = ...
    set_clock: typing.Callable[[Element, Clock | None], bool] = ...
...
class ElementFactory(PluginFeature):
    ...
    def create_with_properties(
        ...
        values: typing.Sequence[typing.Any] | None = None,
    ) -> Element | None: ...
    @staticmethod
...
class Memory(GObject.GBoxed):
    ...
    def make_mapped(self, flags: MapFlags) -> typing.Tuple[Memory | None, MapInfo]: ...
    def map(self, flags: MapFlags) -> MapInfo: ...
    @classmethod
    def new_wrapped(
        cls,
...
class Message(GObject.GBoxed):
    ...
    def get_seqnum(self) -> int: ...
    def get_stream_status_object(self) -> typing.Any | None: ...
    def get_structure(self) -> Structure | None: ...
    def has_name(self, name: str) -> bool: ...
    @classmethod
    ...
    def new_property_notify(
        cls, src: Object, property_name: str, val: typing.Any | None = None
    ) -> Message: ...
    @classmethod
    def new_qos(
        cls,
...
class Object(GObject.InitiallyUnowned):
    ...
    def default_deep_notify(
        ...
        orig: Object,
        pspec: GObject.ParamSpec,
        excluded_props: typing.Sequence[str] | None = None,
    ) -> None: ...
    ...
    def get_value(self, property_name: str, timestamp: int) -> typing.Any | None: ...
...
class Pad(Object):
    ...
    peer: Pad = ...
    linkfunc: typing.Callable[[Pad, Object | None, Pad], PadLinkReturn] = ...
    linkdata: None = ...
    linknotify: typing.Callable[[None], None] = ...
    unlinkfunc: typing.Callable[[Pad, Object | None], None] = ...
    unlinkdata: None = ...
    unlinknotify: typing.Callable[[None], None] = ...
    chainfunc: typing.Callable[[Pad, Object | None, Buffer], FlowReturn] = ...
    chaindata: None = ...
    chainnotify: typing.Callable[[None], None] = ...
    chainlistfunc: typing.Callable[[Pad, Object | None, BufferList], FlowReturn] = ...
    chainlistdata: None = ...
    ...
    eventfunc: typing.Callable[[Pad, Object | None, Event], bool] = ...
    eventdata: None = ...
    eventnotify: typing.Callable[[None], None] = ...
    offset: int = ...
    queryfunc: typing.Callable[[Pad, Object | None, Query], bool] = ...
    querydata: None = ...
    querynotify: typing.Callable[[None], None] = ...
    iterintlinkfunc: typing.Callable[[Pad, Object | None], Iterator] = ...
...
class Plugin(Object):
    ...
    def add_dependency(
        self,
        env_vars: typing.Sequence[str] | None,
        paths: typing.Sequence[str] | None,
...
class PresetInterface(GObject.GPointer):
    ...
    set_meta: typing.Callable[[Preset, str, str, str | None], bool] = ...
...
class Query(MiniObjectMixin, GObject.GBoxed):
    ...
    def add_allocation_meta(
        self, api: typing.Type[typing.Any], params: Structure | None = None
    ) -> None: ...
    ...
    @staticmethod
    def take(new_query: Query | None = None) -> typing.Tuple[bool, Query]: ...
    def writable_structure(self) -> StructureContextManager: ...
...
class Structure(GObject.GBoxed):
    ...
    def get_value(self, fieldname: str) -> typing.Any | None: ...
    def has_field(self, fieldname: str) -> bool: ...
    def has_field_typed(
        self, fieldname: str, type: typing.Type[typing.Any]
    ) -> bool: ...
    def has_name(self, name: str) -> bool: ...
    def id_get_value(self, field: int) -> typing.Any | None: ...
    ...
    def id_str_get_value(self, fieldname: IdStr) -> typing.Any | None: ...
...
class TagList(GObject.GBoxed):
    ...
    def get_value_index(self, tag: str, index: int) -> typing.Any | None: ...
...
class Tracer(Object):
    ...
    @staticmethod
    def register(
        plugin: Plugin | None, name: str, type: typing.Type[typing.Any]
    ) -> bool: ...
...
class URIHandlerInterface(GObject.GPointer):
    ...
    get_uri: typing.Callable[[URIHandler], str | None] = ...

...
def buffer_list_replace(
    new_list: Optional[BufferList] = None,
...
def context_replace(new_context: Optional[Context] = None) -> Tuple[bool, Context]: ...
...
def message_take(new_message: Optional[Message] = None) -> Tuple[bool, Message]: ...
...
def query_take(new_query: Optional[Query] = None) -> Tuple[bool, Query]: ...
...
def tag_list_replace(new_taglist: Optional[TagList] = None) -> Tuple[bool, TagList]: ...
def tag_list_take(new_taglist: Optional[TagList] = None) -> Tuple[bool, TagList]: ...
...
class BufferList(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_list: Optional[BufferList] = None) -> Tuple[bool, BufferList]: ...
    @staticmethod
    def take(new_list: Optional[BufferList] = None) -> Tuple[bool, BufferList]: ...
...
class Context(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_context: Optional[Context] = None) -> Tuple[bool, Context]: ...
    def unref(self) -> None: ...
...
class Message(GObject.GBoxed):
    ...
    @staticmethod
    def take(new_message: Optional[Message] = None) -> Tuple[bool, Message]: ...
    def writable_structure(self) -> Structure: ...
...
class MetaInfo(GObject.GPointer):
    ...
    deserialize_func: Callable[[MetaInfo, Buffer, int, int, int], Optional[Meta]] = ...
...
class Plugin(Object):
    ...
    def get_status_errors(self) -> Optional[list[str]]: ...
    def get_status_infos(self) -> Optional[list[str]]: ...
    def get_status_warnings(self) -> Optional[list[str]]: ...
...
class Query(GObject.GBoxed):
    ...
    @staticmethod
    def take(new_query: Optional[Query] = None) -> Tuple[bool, Query]: ...
    def writable_structure(self) -> Structure: ...
...
class Structure(GObject.GBoxed):
    ...
    def serialize(self, flags: SerializeFlags) -> str: ...
    def serialize_full(self, flags: SerializeFlags) -> Optional[str]: ...
...
class TagList(GObject.GBoxed):
    ...
    @staticmethod
    def replace(new_taglist: Optional[TagList] = None) -> Tuple[bool, TagList]: ...
    def set_scope(self, scope: TagScope) -> None: ...
    @staticmethod
    def take(new_taglist: Optional[TagList] = None) -> Tuple[bool, TagList]: ...
    def to_string(self) -> str: ...
...
class Uri(GObject.GBoxed):
    ...
    def to_string(self) -> str: ...
    def to_string_with_keys(self, keys: Optional[list[str]] = None) -> str: ...
    def unref(self) -> None: ...

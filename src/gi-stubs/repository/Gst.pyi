...
def TIME_ARGS(time: int) -> str: ...  # FIXME Function
...
def deinit() -> None: ...  # FIXME Function
...
def init(argv: typing.Optional[list[str]] = None) -> None: ...  # FIXME Function
def init_check(
    argv: typing.Optional[list[str]] = None,
) -> typing.Tuple[bool, typing.Optional[list[str]]]: ...  # FIXME Function
...
class Bin(Element, ChildProxy):
    ...
    def add(self, *args: Element) -> None: ...  # FIXME Function
...
class Buffer(GObject.GBoxed, MiniObjectMixin):
    ...
    def map(self, flags: MapFlags) -> MapInfo: ...  # FIXME Function
    def map_range(
        self, idx: int, length: int, flags: MapFlags
    ) -> MapInfo: ...  # FIXME Function
    ...
    def unmap(self, mapinfo: MapInfo) -> bool: ...  # FIXME Function
...
class Caps(GObject.GBoxed, MiniObjectMixin):
    ...
    def __getitem__(
        self, index: int
    ) -> typing.Optional[Structure]: ...  # FIXME Function
    def __len__(self): ...  # FIXME Function
    ...
    def writable_structure(
        self, index: int
    ) -> StructureContextManager: ...  # FIXME Function
...
class Context(GObject.GBoxed, MiniObjectMixin):
    ...
    def get_structure(self) -> typing.Optional[Structure]: ...  # FIXME Function
    ...
    def unref(self) -> None: ...
    def writable_structure(self) -> StructureContextManager: ...  # FIXME Function
...
class ElementFactory(PluginFeature):
    ...
    def get_description(self) -> typing.Optional[str]: ...  # FIXME Function
    def get_element_type(self) -> typing.Type[typing.Any]: ...
    def get_klass(self) -> typing.Optional[str]: ...  # FIXME Function
    def get_longname(self) -> typing.Optional[str]: ...  # FIXME Function
    def get_metadata(self, key: str) -> typing.Optional[str]: ...
    def get_metadata_keys(self) -> typing.Optional[list[str]]: ...
...
class Fraction:
    ...
    ::
        ...
        Fraction(**properties)
    """
    def __float__(self) -> float: ...  # FIXME Function
...
class Iterator(GObject.GBoxed):
    ...
    master_cookie: int = ...
    size: int = ...
    def __iter__(self) -> typing.Iterator[typing.Any]: ...  # FIXME Function
...
class MapInfo:
    def __enter__(self) -> Self: ...  # FIXME Function
    def __iter__(self): ...  # FIXME Function
...
class MiniObjectMixin:
    ...
    def is_writable(self) -> bool: ...  # FIXME Function
    def make_writable(self) -> bool: ...  # FIXME Function
...
class Pad(Object):
    ...
    def link(self, pad: Gst.Pad) -> Gst.PadLinkReturn: ...  # FIXME Function
    ...
    def set_active(self, active: bool) -> bool: ...
    def set_caps(self, caps: Caps) -> bool: ...  # FIXME Function
    def set_chain_function(
        self, func: typing.Callable[..., FlowReturn]
    ) -> None: ...  # FIXME Function
...
class PadProbeInfo(GObject.GPointer):
    ...
    def set_object(
        self, obj: typing.Optional[Gst.MiniObject]
    ) -> None: ...  # FIXME Function
...
class PadProbeInfoObjectContextManager:
    def __enter__(self) -> MiniObject: ...  # FIXME Function
...
class Structure(GObject.GBoxed):
    ...
    name: int = ...
    def __enter__(self) -> Self: ...  # FIXME Function
    def __getitem__(self, key: str) -> typing.Any: ...  # FIXME Function
    def __setitem__(self, key: str, value: typing.Any) -> None: ...  # FIXME Function
    ...
    def is_writable(self) -> bool: ...
    def keys(self) -> typing.Iterable[str]: ...  # FIXME Function
    def map_in_place(
        self, func: typing.Callable[..., bool], *user_data: typing.Any
    ) -> bool: ...
    ...
    def set_parent_refcount(self, refcount: int) -> bool: ...
    def set_value(self, key: str, value: typing.Any) -> bool: ...  # FIXME Function
...
class StructureContextManager:
    ...
    """
    def __enter__(self) -> Structure: ...  # FIXME Function
...
class TagList(GObject.GBoxed):
    ...
    mini_object: MiniObject = ...
    def __getitem__(self, index: int) -> typing.Any: ...  # FIXME Function
    def __len__(self) -> int: ...  # FIXME Function
    def __setitem__(self, key: str, value: typing.Any) -> None: ...  # FIXME Function
    ...
    def enumerate(self) -> map[tuple[str, typing.Any]]: ...  # FIXME Function
    def foreach(
        self, func: typing.Callable[..., None], *user_data: typing.Any
    ) -> None: ...
...
class ValueArray:
    ...
    def __getitem__(self, index: int) -> typing.Any: ...  # FIXME Function
    def __len__(self) -> int: ...  # FIXME Function
    def __setitem__(self, index: int, value: typing.Any) -> None: ...  # FIXME Function
    @staticmethod

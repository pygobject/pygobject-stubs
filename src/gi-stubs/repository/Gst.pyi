...
def call_async(func: Callable[..., None], *user_data: Any) -> None: ...
...
def util_simplify_fraction(n_terms: int, threshold: int) -> tuple[int, int]: ...
...
class Pad(Object):
    ...
    def sticky_events_foreach(
        self, foreach_func: Callable[..., tuple[bool, Event]], *user_data: Any
    ) -> None: ...

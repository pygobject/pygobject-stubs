...
def buffer_list_replace(
    old_list: BufferList | None = None, new_list: BufferList | None = None
) -> tuple[bool, BufferList | None]: ...
def buffer_list_take(
    old_list: BufferList, new_list: BufferList | None = None
) -> tuple[bool, BufferList]: ...
def call_async(
    func: Callable[[Unpack[_DataTs]], None], *user_data: Unpack[_DataTs]
) -> None: ...
...
def context_replace(
    old_context: Context, new_context: Context | None = None
) -> tuple[bool, Context]: ...
...
def debug_print_object(ptr: int | Any | None = None) -> str: ...
...
def debug_remove_log_function_by_data(data: int | Any | None = None) -> int: ...
...
def is_caps_features(obj: int | Any | None = None) -> bool: ...
...
def meta_register_custom(
    ...
    transform_func: Callable[
        [Buffer, CustomMeta, Buffer, int, int | Any | None, Unpack[_DataTs]], bool
    ]
    | None = None,
    *user_data: Unpack[_DataTs],
) -> MetaInfo: ...
...
def type_find_register(
    ...
    name: str,
    rank: int,
    func: Callable[[TypeFind, Unpack[_DataTs]], None],
...
class Allocator(Object):
    ...
    @property
    def mem_map_full(self) -> Callable[[Memory, MapInfo, int], int]: ...
    @property
...
class AtomicQueue(GObject.GBoxed):
    ...
    def peek(self) -> int: ...
    def pop(self) -> int: ...
    def push(self, data: int | Any | None = None) -> None: ...
    def ref(self) -> None: ...
    def unref(self) -> None: ...
...
class Buffer(MiniObjectMixin, GObject.GBoxed):
    ...
    def add_meta(
        self, info: MetaInfo, params: int | Any | None = None
    ) -> Meta | None: ...
    ...
    def new_wrapped_full(
        ...
        notify: Callable[[Any | None], None] | None = None,
    ) -> Buffer: ...
...
class Bus(Object):
    ...
    def add_watch(
        self,
        priority: int,
        func: Callable[[Bus, Message, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> int: ...
    def async_signal_func(
        self, message: Message, data: int | Any | None = None
    ) -> bool: ...
    ...
    def set_sync_handler(
        self,
        func: Callable[[Bus, Message, Unpack[_DataTs]], BusSyncReply] | None = None,
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class Caps(MiniObjectMixin, GObject.GBoxed):
    ...
    def filter_and_map_in_place(
        self,
        func: Callable[[CapsFeatures, Structure, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class Clock(Object):
    ...
    def do_change_resolution(
        self, old_resolution: int, new_resolution: int, /
    ) -> int: ...
    ...
    @staticmethod
    def id_compare_func(
        id1: int | Any | None = None, id2: int | Any | None = None
    ) -> int: ...
    @staticmethod
    ...
    @staticmethod
    def id_ref(id: int | Any | None) -> int: ...
    @staticmethod
    ...
    def id_wait_async(
        id: int | Any | None,
        func: Callable[[Clock, int, int | Any | None, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> ClockReturn: ...
    def is_synced(self) -> bool: ...
    def is_system_monotonic(self) -> bool: ...
    def new_periodic_id(self, start_time: int, interval: int) -> int: ...
    def new_single_shot_id(self, time: int) -> int: ...
...
class ClockEntry(_gi.Struct):
    ...
    @property
    def func(self) -> Callable[[Clock, int, int | Any | None, Any | None], bool]: ...
    @property
    def user_data(self) -> int: ...
    @property
    def destroy_data(self) -> Callable[[Any | None], None]: ...
    @property
...
class Context(MiniObjectMixin, GObject.GBoxed):
    ...
    def set_task_pool(self, pool: TaskPool | None = None) -> None: ...
    def unref(self) -> None: ...
...
class Element(Object):
    ...
    def foreach_pad(
        self,
        func: Callable[[Element, Pad, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> bool: ...
...
class ElementClass(_gi.Struct):
    ...
    @property
    def padtemplates(self) -> list[int]: ...
    @property
...
class Iterator(GObject.GBoxed, Generic[T]):
    ...
    def filter(
        self, func: Callable[[Any | None, int | Any | None], int], user_data: Any
    ) -> Iterator: ...
    def find_custom(
        self,
        func: Callable[[Any | None, int | Any | None], int],
        *user_data: Unpack[_DataTs],
    ) -> tuple[bool, Any]: ...
    def fold(
        self,
        func: Callable[[Any, Any, Unpack[_DataTs]], bool],
        ret: Any,
        *user_data: Unpack[_DataTs],
    ) -> IteratorResult: ...
    def foreach(
        self, func: Callable[[Any, Unpack[_DataTs]], None], *user_data: Unpack[_DataTs]
    ) -> IteratorResult: ...
    def free(self) -> None: ...
    @classmethod
...
class Message(GObject.GBoxed):
    ...
    @classmethod
    def new_error(
        cls, src: Object | None, error: GLib.Error, debug: str | None = None
    ) -> Message: ...
    @classmethod
...
class MetaInfo(_gi.Struct):
    ...
    type: type[Any]
    size: int
    init_func: Callable[[Meta, Any | None, Buffer], bool]
    free_func: Callable[[Meta, Buffer], None]
    transform_func: Callable[[Buffer, Meta, Buffer, int, Any | None], bool]
...
class MiniObject(GObject.GBoxed):
    ...
    def set_qdata(
        self, quark: int, data: int | Any | None, destroy: Callable[[Any | None], None]
    ) -> None: ...
...
class Object(GObject.InitiallyUnowned):
    ...
    def flags(self) -> int: ...
    @property
    def control_bindings(self) -> list[int]: ...
    @property
    ...
    def call_async(
        self,
        func: Callable[[Object, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    @staticmethod
    ...
    @staticmethod
    def replace(
        oldobj: Object | None = None, newobj: Object | None = None
...
class Pad(Object):
    ...
    @property
    def activatemodenotify(self) -> Callable[[Any | None], None]: ...
    @property
    def peer(self) -> Pad: ...
    @property
    def linkfunc(self) -> Callable[[Pad, Object | None, Pad], PadLinkReturn]: ...
    @property
    def linkdata(self) -> int: ...
    @property
    def linknotify(self) -> Callable[[Any | None], None]: ...
    @property
    def unlinkfunc(self) -> Callable[[Pad, Object | None], None]: ...
    @property
    def unlinkdata(self) -> int: ...
    @property
    def unlinknotify(self) -> Callable[[Any | None], None]: ...
    @property
    def chainfunc(self) -> Callable[[Pad, Object | None, Buffer], FlowReturn]: ...
    @property
    def chaindata(self) -> int: ...
    @property
    def chainnotify(self) -> Callable[[Any | None], None]: ...
    @property
    def chainlistfunc(
        self,
    ) -> Callable[[Pad, Object | None, BufferList], FlowReturn]: ...
    @property
    def chainlistdata(self) -> int: ...
    @property
    def chainlistnotify(self) -> Callable[[Any | None], None]: ...
    @property
    def getrangefunc(
        self,
    ) -> Callable[[Pad, Object | None, int, int, Buffer], FlowReturn]: ...
    @property
    def getrangedata(self) -> int: ...
    @property
    def getrangenotify(self) -> Callable[[Any | None], None]: ...
    @property
    def eventfunc(self) -> Callable[[Pad, Object | None, Event], bool]: ...
    @property
    def eventdata(self) -> int: ...
    @property
    def eventnotify(self) -> Callable[[Any | None], None]: ...
    @property
    def offset(self) -> int: ...
    @property
    def queryfunc(self) -> Callable[[Pad, Object | None, Query], bool]: ...
    @property
    def querydata(self) -> int: ...
    @property
    def querynotify(self) -> Callable[[Any | None], None]: ...
    @property
    def iterintlinkfunc(self) -> Callable[[Pad, Object | None], Iterator]: ...
    @property
    def iterintlinkdata(self) -> int: ...
    @property
    def iterintlinknotify(self) -> Callable[[Any | None], None]: ...
    @property
    ...
    def set_activate_function_full(
        self, activate: Callable[[Pad, Object], bool], *user_data: Unpack[_DataTs]
    ) -> None: ...
    ...
    def set_chain_function_full(
        self,
        chain: Callable[[Pad, Object | None, Buffer], FlowReturn],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_chain_list_function_full(
        self,
        chainlist: Callable[[Pad, Object | None, BufferList], FlowReturn],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_element_private(self, priv: int | Any | None = None) -> None: ...
    def set_event_full_function_full(
        self,
        event: Callable[[Pad, Object | None, Event], FlowReturn],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_event_function(self, func: Callable[..., FlowReturn]) -> None: ...
    def set_event_function_full(
        self,
        event: Callable[[Pad, Object | None, Event], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_getrange_function_full(
        self,
        get: Callable[[Pad, Object | None, int, int, Buffer], FlowReturn],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_iterate_internal_links_function_full(
        self,
        iterintlink: Callable[[Pad, Object | None], Iterator],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_link_function_full(
        self,
        link: Callable[[Pad, Object | None, Pad], PadLinkReturn],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    ...
    def set_query_function_full(
        self,
        query: Callable[[Pad, Object | None, Query], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_unlink_function_full(
        self, unlink: Callable[[Pad, Object | None], None], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def start_task(
        self, func: Callable[[Unpack[_DataTs]], None], *user_data: Unpack[_DataTs]
    ) -> bool: ...
...
class Plugin(Object):
    ...
    def get_status_errors(self) -> list[str]: ...
    def get_status_infos(self) -> list[str]: ...
    ...
    def register_static_full(
        ...
        name: str,
        description: str,
        init_full_func: Callable[[Plugin, Unpack[_DataTs]], bool],
        version: str,
        license: str,
        source: str,
        package: str,
...
class PluginFeature(Object):
    ...
    def rank_compare_func(
        p1: int | Any | None = None, p2: int | Any | None = None
    ) -> int: ...
...
class Promise(GObject.GBoxed):
    ...
    def new_with_change_func(
        cls,
        func: Callable[[Promise, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> Promise: ...
...
class Registry(Object):
    ...
    def feature_filter(
        self,
        filter: Callable[[PluginFeature, Unpack[_DataTs]], bool],
        first: bool,
        *user_data: Unpack[_DataTs],
    ) -> list[PluginFeature]: ...
    ...
    def plugin_filter(
        self,
        filter: Callable[[Plugin, Unpack[_DataTs]], bool],
        first: bool,
        *user_data: Unpack[_DataTs],
    ) -> list[Plugin]: ...
...
class Structure(GObject.GBoxed):
    ...
    def filter_and_map_in_place(
        self,
        func: Callable[[int, Any, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def filter_and_map_in_place_id_str(
        self,
        func: Callable[[IdStr, Any, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class TagList(GObject.GBoxed):
    ...
    def foreach(
        self,
        func: Callable[[TagList, str, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class Task(Object):
    ...
    @property
    def func(self) -> Callable[[Any | None], None]: ...
    @property
    def user_data(self) -> int: ...
    @property
    def notify(self) -> Callable[[Any | None], None]: ...
    @property
    ...
    @classmethod
    def new(
        cls, func: Callable[[Unpack[_DataTs]], None], *user_data: Unpack[_DataTs]
    ) -> Task: ...
    def pause(self) -> bool: ...
    def resume(self) -> bool: ...
    def set_enter_callback(
        self,
        enter_func: Callable[[Task, GLib.Thread, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_leave_callback(
        self,
        leave_func: Callable[[Task, GLib.Thread, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class TaskPool(Object):
    ...
    def __init__(self, *, name: str | None = ..., parent: Object = ...) -> None: ...
    def cleanup(self) -> None: ...
    def dispose_handle(self, id: int | Any | None = None) -> None: ...
    def do_cleanup(self) -> None: ...
    def do_dispose_handle(self, id: int | Any | None, /) -> None: ...
    def do_join(self, id: int | Any | None, /) -> None: ...
    def do_prepare(self) -> None: ...
    def do_push(
        self, func: Callable[[Any | None], None], user_data: int | Any | None, /
    ) -> int: ...
    def join(self, id: int | Any | None = None) -> None: ...
    @classmethod
...
class TaskPoolClass(_gi.Struct):
    ...
    def push(
        self,
    ) -> Callable[[TaskPool, Callable[[Any | None], None], Any | None], int]: ...
    @property
    def join(self) -> Callable[[TaskPool, Any | None], None]: ...
    @property
    def dispose_handle(self) -> Callable[[TaskPool, Any | None], None]: ...
...
class TypeFind(_gi.Struct):
    ...
    def peek(self, offset: int) -> bytes: ...
    @staticmethod
    def register(
        plugin: Plugin | None,
        name: str,
...
class Uri(GObject.GBoxed):
    ...
    def set_query_table(self, query_table: Mapping[str, str] | None = None) -> bool: ...
    def set_query_value(
...
class ValueTable(_gi.Struct):
    ...
    hash: Callable[[Any], tuple[bool, int]]

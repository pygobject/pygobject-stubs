...
class CharAttributes(GObject.GPointer):
    ...
    def column(self) -> int: ...
    @property
    def fore(self) -> Pango.Color: ...
    @property
    def back(self) -> Pango.Color: ...
    @property
...
class TerminalClass(GObject.GPointer):
    @property
    def parent_class(self) -> _Gtk3.WidgetClass: ...
    @property
    def eof(self) -> Callable[[Terminal], None]: ...
    @property
    def child_exited(self) -> Callable[[Terminal, int], None]: ...
    @property
    def encoding_changed(self) -> Callable[[Terminal], None]: ...
    @property
    def char_size_changed(self) -> Callable[[Terminal, int, int], None]: ...
    @property
    def window_title_changed(self) -> Callable[[Terminal], None]: ...
    @property
    def icon_title_changed(self) -> Callable[[Terminal], None]: ...
    @property
    def selection_changed(self) -> Callable[[Terminal], None]: ...
    @property
    def contents_changed(self) -> Callable[[Terminal], None]: ...
    @property
    def cursor_moved(self) -> Callable[[Terminal], None]: ...
    @property
    def commit(self) -> Callable[[Terminal, str, int], None]: ...
    @property
    def deiconify_window(self) -> Callable[[Terminal], None]: ...
    @property
    def iconify_window(self) -> Callable[[Terminal], None]: ...
    @property
    def raise_window(self) -> Callable[[Terminal], None]: ...
    @property
    def lower_window(self) -> Callable[[Terminal], None]: ...
    @property
    def refresh_window(self) -> Callable[[Terminal], None]: ...
    @property
    def restore_window(self) -> Callable[[Terminal], None]: ...
    @property
    def maximize_window(self) -> Callable[[Terminal], None]: ...
    @property
    def resize_window(self) -> Callable[[Terminal, int, int], None]: ...
    @property
    def move_window(self) -> Callable[[Terminal, int, int], None]: ...
    @property
    def increase_font_size(self) -> Callable[[Terminal], None]: ...
    @property
    def decrease_font_size(self) -> Callable[[Terminal], None]: ...
    @property
    def text_modified(self) -> Callable[[Terminal], None]: ...
    @property
    def text_inserted(self) -> Callable[[Terminal], None]: ...
    @property
    def text_deleted(self) -> Callable[[Terminal], None]: ...
    @property
    def text_scrolled(self) -> Callable[[Terminal, int], None]: ...
    @property
    def copy_clipboard(self) -> Callable[[Terminal], None]: ...
    @property

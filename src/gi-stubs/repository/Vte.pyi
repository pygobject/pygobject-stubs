...
class Terminal(Gtk.Widget, Atk.ImplementorIface, Gtk.Buildable, Gtk.Scrollable):
    ...
    def hyperlink_check_event(self, event: Gdk.Event) -> str | None: ...
    ...
    def match_check_event(self, event: Gdk.Event) -> Tuple[str | None, int]: ...
    def match_remove(self, tag: int) -> None: ...
    def match_remove_all(self) -> None: ...
    def match_set_cursor(self, tag: int, cursor: Gdk.Cursor | None = None) -> None: ...
    ...
    def set_color_bold(self, bold: Gdk.RGBA | None = None) -> None: ...
    def set_color_cursor(self, cursor_background: Gdk.RGBA | None = None) -> None: ...
    def set_color_cursor_foreground(
        self, cursor_foreground: Gdk.RGBA | None = None
    ) -> None: ...
    def set_color_foreground(self, foreground: Gdk.RGBA) -> None: ...
    def set_color_highlight(
        self, highlight_background: Gdk.RGBA | None = None
    ) -> None: ...
    def set_color_highlight_foreground(
        self, highlight_foreground: Gdk.RGBA | None = None
    ) -> None: ...
    def set_colors(
        self,
        foreground: Gdk.RGBA | None = None,
        background: Gdk.RGBA | None = None,
        palette: Sequence[Gdk.RGBA] | None = None,
    ) -> None: ...

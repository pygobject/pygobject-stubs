...
class AudioBuffer(_gi.Struct):
    ...
    @property
    def priv_planes_arr(self) -> list[int]: ...
    @property
...
class AudioClock(Gst.SystemClock):
    ...
    @property
    def func(self) -> Callable[[Gst.Clock, Any | None], int]: ...
    @property
    def user_data(self) -> int: ...
    @property
    def destroy_notify(self) -> Callable[[Any | None], None]: ...
    @property
    ...
    def new(
        cls,
        name: str,
        func: Callable[[Gst.Clock, Unpack[_DataTs]], int],
        *user_data: Unpack[_DataTs],
    ) -> AudioClock: ...
...
class AudioRingBuffer(Gst.Object):
    ...
    def callback(
        self,
    ) -> Callable[[AudioRingBuffer, Sequence[int], int, Any | None], None]: ...
    @property
    ...
    @property
    def cb_data_notify(self) -> Callable[[Any | None], None]: ...
    @property
    ...
    def set_callback(
        self,
        cb: Callable[[AudioRingBuffer, Sequence[int], int, Unpack[_DataTs]], None]
        | None = None,
        *user_data: Unpack[_DataTs],
    ) -> None: ...

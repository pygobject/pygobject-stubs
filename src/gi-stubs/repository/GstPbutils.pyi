...
def codec_utils_h264_get_level(sps: typing.Sequence[int]) -> str | None: ...
def codec_utils_h264_get_level_idc(level: str) -> int: ...
def codec_utils_h264_get_profile(sps: typing.Sequence[int]) -> str | None: ...
...
def codec_utils_opus_create_caps(
    ...
    stream_count: int,
    coupled_count: int,
    channel_mapping: typing.Sequence[int] | None = None,
) -> Gst.Caps | None: ...
...
def codec_utils_opus_create_header(
    ...
    stream_count: int,
    coupled_count: int,
    channel_mapping: typing.Sequence[int] | None,
    pre_skip: int,
    output_gain: int,
) -> Gst.Buffer | None: ...
...
def install_plugins_sync(
    details: typing.Sequence[str], ctx: InstallPluginsContext | None = None
) -> InstallPluginsReturn: ...

...
def base64_encode(
    data: typing.Optional[typing.Union[typing.Sequence[int], bytes]] = None
) -> str: ...
def base64_encode_close(break_lines: bool) -> typing.Tuple[int, bytes, int, int]: ...
def base64_encode_step(
    in_: typing.Union[typing.Sequence[int], bytes], break_lines: bool
...
def byte_array_append(
    array: typing.Union[typing.Sequence[int], bytes], data: int, len: int
) -> bytes: ...
def byte_array_free(
    array: typing.Union[typing.Sequence[int], bytes], free_segment: bool
) -> int: ...
def byte_array_free_to_bytes(
    array: typing.Union[typing.Sequence[int], bytes]
) -> Bytes: ...
def byte_array_new() -> bytes: ...
def byte_array_new_take(data: typing.Union[typing.Sequence[int], bytes]) -> bytes: ...
def byte_array_prepend(
    array: typing.Union[typing.Sequence[int], bytes], data: int, len: int
) -> bytes: ...
def byte_array_ref(array: typing.Union[typing.Sequence[int], bytes]) -> bytes: ...
def byte_array_remove_index(
    array: typing.Union[typing.Sequence[int], bytes], index_: int
) -> bytes: ...
def byte_array_remove_index_fast(
    array: typing.Union[typing.Sequence[int], bytes], index_: int
) -> bytes: ...
def byte_array_remove_range(
    array: typing.Union[typing.Sequence[int], bytes], index_: int, length: int
) -> bytes: ...
def byte_array_set_size(
    array: typing.Union[typing.Sequence[int], bytes], length: int
) -> bytes: ...
def byte_array_sized_new(reserved_size: int) -> bytes: ...
def byte_array_sort(
    array: typing.Union[typing.Sequence[int], bytes],
    compare_func: typing.Callable[[None, None], int],
) -> None: ...
...
def byte_array_unref(array: typing.Union[typing.Sequence[int], bytes]) -> None: ...
...
def compute_checksum_for_data(
    checksum_type: ChecksumType, data: typing.Union[typing.Sequence[int], bytes]
) -> typing.Optional[str]: ...
...
def compute_hmac_for_data(
    ...
    key: typing.Union[typing.Sequence[int], bytes],
    data: typing.Union[typing.Sequence[int], bytes],
) -> str: ...
...
def convert(
    str: typing.Union[typing.Sequence[int], bytes], to_codeset: str, from_codeset: str
) -> typing.Tuple[bytes, int]: ...
def convert_error_quark() -> int: ...
def convert_with_fallback(
    str: typing.Union[typing.Sequence[int], bytes],
    to_codeset: str,
    from_codeset: str,
    fallback: str,
) -> typing.Tuple[bytes, int]: ...
...
def file_set_contents(
    filename: str, contents: typing.Union[typing.Sequence[int], bytes]
) -> bool: ...
def file_set_contents_full(
    filename: str,
    contents: typing.Union[typing.Sequence[int], bytes],
...
def locale_to_utf8(
    opsysstring: typing.Union[typing.Sequence[int], bytes]
...
def uri_escape_bytes(
    unescaped: typing.Union[typing.Sequence[int], bytes],
...
class BookmarkFile(GObject.GBoxed):
    ...
    def load_from_data(
        self, data: typing.Union[typing.Sequence[int], bytes]
    ) -> bool: ...
...
class ByteArray(GObject.GBoxed):
    ...
    @staticmethod
    def free_to_bytes(array: typing.Union[typing.Sequence[int], bytes]) -> Bytes: ...
    @staticmethod
    def new() -> bytes: ...
    @staticmethod
    def new_take(data: typing.Union[typing.Sequence[int], bytes]) -> bytes: ...
    @staticmethod
    def prepend(
        array: typing.Union[typing.Sequence[int], bytes], data: int, len: int
    ) -> bytes: ...
    @staticmethod
    def ref(array: typing.Union[typing.Sequence[int], bytes]) -> bytes: ...
    @staticmethod
    def remove_index(
        array: typing.Union[typing.Sequence[int], bytes], index_: int
    ) -> bytes: ...
    @staticmethod
    def remove_index_fast(
        array: typing.Union[typing.Sequence[int], bytes], index_: int
    ) -> bytes: ...
    @staticmethod
    def remove_range(
    ...
    @staticmethod
    def unref(array: typing.Union[typing.Sequence[int], bytes]) -> None: ...
...
class Bytes(GObject.GBoxed):
    ...
    @classmethod
    def new(
        cls, data: typing.Optional[typing.Union[typing.Sequence[int], bytes]] = None
    ) -> Bytes: ...
...
class Checksum(GObject.GBoxed):
    ...
    def update(self, data: typing.Union[typing.Sequence[int], bytes]) -> None: ...
...
class IOChannel(GObject.GBoxed):
    ...
    def write_chars(
        self, buf: typing.Union[typing.Sequence[int], bytes], count: int

...
def aligned_alloc(n_blocks: int, n_block_bytes: int, alignment: int) -> int: ...
def aligned_alloc0(n_blocks: int, n_block_bytes: int, alignment: int) -> int: ...
def aligned_free(mem: int | Any | None = None) -> None: ...
...
def async_queue_new_full(
    item_free_func: Callable[[Any | None], None] | None = None,
) -> AsyncQueue: ...
...
def atomic_int_dec_and_test(atomic: int | Any | None = None) -> bool: ...
...
def atomic_int_get(atomic: int | Any | None = None) -> int: ...
def atomic_int_inc(atomic: int | Any | None = None) -> None: ...
...
def atomic_pointer_compare_and_exchange(
    atomic: int | Any | None,
    oldval: int | Any | None = None,
    newval: int | Any | None = None,
) -> bool: ...
...
def atomic_pointer_exchange(
    atomic: int | Any | None = None, newval: int | Any | None = None
) -> int: ...
def atomic_pointer_get(atomic: int | Any | None) -> int: ...
def atomic_pointer_or(atomic: int | Any | None, val: int) -> int: ...
def atomic_pointer_set(
    atomic: int | Any | None, newval: int | Any | None = None
) -> None: ...
def atomic_pointer_xor(atomic: int | Any | None, val: int) -> int: ...
def atomic_rc_box_acquire(mem_block: int | Any | None) -> int: ...
def atomic_rc_box_alloc(block_size: int) -> int: ...
def atomic_rc_box_alloc0(block_size: int) -> int: ...
def atomic_rc_box_dup(block_size: int, mem_block: int | Any | None) -> int: ...
...
def atomic_rc_box_release_full(
    mem_block: int | Any | None, clear_func: Callable[[Any | None], None]
) -> None: ...
...
def byte_array_free(array: _Sequence[int], free_segment: bool) -> bytes: ...
...
def byte_array_sort(
    array: _Sequence[int], compare_func: Callable[[Any | None, int | Any | None], int]
) -> None: ...
def byte_array_sort_with_data(
    array: _Sequence[int],
    compare_func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], int],
...
def child_watch_add(
    priority: int,
    pid: int,
    function: Callable[[int, int, Unpack[_DataTs]], None],
    *data: Unpack[_DataTs],
) -> int: ...
@overload
def child_watch_add(
...
@overload
def child_watch_add(
    priority: int, pid: int, *, function: Callable[[int, int, _T], None], data: _T
) -> int: ...
@overload
def child_watch_add(
    priority: int, pid: int, function: Callable[[int, int, _T], None], *, data: _T
...
def child_watch_add(
    pid: int,
    function: Callable[[int, int, _T], None],
    *,
    data: _T,
...
def datalist_foreach(
    datalist: Data,
    func: Callable[[int, int | Any | None, Unpack[_DataTs]], None],
    *user_data: Unpack[_DataTs],
) -> None: ...
def datalist_get_data(datalist: Data, key: str) -> int: ...
def datalist_get_flags(datalist: Data) -> int: ...
def datalist_id_get_data(datalist: Data, key_id: int) -> int: ...
...
def dataset_id_get_data(dataset_location: int | Any | None, key_id: int) -> int: ...
...
def direct_equal(v1: int | Any | None = None, v2: int | Any | None = None) -> bool: ...
def direct_hash(v: int | Any | None = None) -> int: ...
...
def hash_table_find(
    hash_table: Mapping[int | Any | None, int | Any | None],
    predicate: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], bool],
    *user_data: Unpack[_DataTs],
) -> int: ...
def hash_table_foreach(
    hash_table: Mapping[int | Any | None, int | Any | None],
    func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], None],
    *user_data: Unpack[_DataTs],
) -> None: ...
def hash_table_foreach_remove(
    hash_table: Mapping[int | Any | None, int | Any | None],
    func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], bool],
    *user_data: Unpack[_DataTs],
) -> int: ...
...
def idle_add(
    ...
    *user_data: Unpack[_DataTs],
    priority: int = PRIORITY_DEFAULT_IDLE,
) -> int: ...
def idle_remove_by_data(data: int | Any | None = None) -> bool: ...
...
def io_create_watch(channel: IOChannel, condition: _IOConditionValueType) -> Source: ...
...
def log_set_handler(
    ...
    log_func: Callable[[str | None, LogLevelFlags, str, Unpack[_DataTs]], None],
    *user_data: Unpack[_DataTs],
) -> int: ...
def log_set_writer_func(
    func: Callable[
        [LogLevelFlags, _Sequence[LogField], int, Unpack[_DataTs]], LogWriterOutput
    ],
    *user_data: Unpack[_DataTs],
) -> None: ...
...
def main_depth() -> int: ...
def malloc(n_bytes: int) -> int: ...
def malloc0(n_bytes: int) -> int: ...
def malloc0_n(n_blocks: int, n_block_bytes: int) -> int: ...
def malloc_n(n_blocks: int, n_block_bytes: int) -> int: ...
...
def memdup(mem: int | Any | None, byte_size: int) -> int: ...
def memdup2(mem: int | Any | None, byte_size: int) -> int: ...
...
def once_init_enter(location: int | Any | None) -> tuple[bool, int]: ...
def once_init_enter_impl(location: int) -> bool: ...
def once_init_enter_pointer(location: int | Any | None) -> bool: ...
def once_init_leave(location: int | Any | None, result: int) -> int: ...
def once_init_leave_pointer(
    location: int | Any | None, result: int | Any | None = None
) -> None: ...
...
def pointer_bit_lock_mask_ptr(
    ...
    set: bool,
    preserve_mask: int,
    preserve_ptr: int | Any | None = None,
) -> int: ...
...
def rc_box_acquire(mem_block: int | Any | None) -> int: ...
def rc_box_alloc(block_size: int) -> int: ...
def rc_box_alloc0(block_size: int) -> int: ...
def rc_box_dup(block_size: int, mem_block: int | Any | None) -> int: ...
def rc_box_get_size(mem_block: int | Any | None) -> int: ...
def rc_box_release(mem_block: int | Any | None) -> None: ...
def rc_box_release_full(
    mem_block: int | Any | None, clear_func: Callable[[Any | None], None]
) -> None: ...
def realloc(mem: int | Any | None, n_bytes: int) -> int: ...
def realloc_n(mem: int | Any | None, n_blocks: int, n_block_bytes: int) -> int: ...
...
def sequence_foreach_range(
    ...
    func: Callable[[int | Any | None, Unpack[_DataTs]], None],
    *user_data: Unpack[_DataTs],
) -> None: ...
def sequence_get(iter: SequenceIter) -> int: ...
def sequence_insert_before(
    iter: SequenceIter, data: int | Any | None = None
) -> SequenceIter: ...
...
def sequence_set(iter: SequenceIter, data: int | Any | None = None) -> None: ...
def sequence_sort_changed(
    iter: SequenceIter,
    cmp_func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], int],
    *cmp_data: Unpack[_DataTs],
) -> None: ...
def sequence_sort_changed_iter(
    iter: SequenceIter,
    iter_cmp: Callable[[SequenceIter, SequenceIter, Unpack[_DataTs]], int],
    *cmp_data: Unpack[_DataTs],
) -> None: ...
...
def slice_alloc(block_size: int) -> int: ...
def slice_alloc0(block_size: int) -> int: ...
def slice_copy(block_size: int, mem_block: int | Any | None = None) -> int: ...
def slice_free1(block_size: int, mem_block: int | Any | None = None) -> None: ...
...
def source_remove_by_funcs_user_data(
    funcs: SourceFuncs, user_data: int | Any | None = None
) -> bool: ...
def source_remove_by_user_data(user_data: int | Any | None = None) -> bool: ...
...
def spawn_async(
    ...
    flags: SpawnFlags,
    child_setup: Callable[[_T], None] | None,
    user_data: _T,
    standard_input: bool = False,
    standard_output: bool = False,
    standard_error: bool = False,
) -> tuple[Pid, int | None, int | None, int | None]: ...
@overload
def spawn_async(
    argv: _Sequence[str],
    envp: _Sequence[str] | None = None,
    working_directory: str | None = None,
    flags: SpawnFlags = SpawnFlags.DEFAULT,
    child_setup: Callable[[None], None] | None = None,
    user_data: None = None,
    standard_input: bool = False,
    standard_output: bool = False,
    standard_error: bool = False,
...
def spawn_async(
    ...
    working_directory: str | None = None,
    flags: SpawnFlags = SpawnFlags.DEFAULT,
    child_setup: Callable[[_T], None] | None = None,
    *,
    user_data: _T,
    standard_input: bool = False,
    standard_output: bool = False,
...
def spawn_async_with_pipes(
    ...
    envp: _Sequence[str] | None,
    flags: SpawnFlags,
    child_setup: Callable[[Unpack[_DataTs]], None] | None = None,
    *user_data: Unpack[_DataTs],
...
def strdupv(str_array: _Sequence[str] | None = None) -> list[str]: ...
...
def test_add_data_func(
    testpath: str, test_data: int | Any | None, test_func: Callable[[Any | None], None]
) -> None: ...
...
def test_queue_destroy(
    destroy_func: Callable[[Any | None], None], destroy_data: int | Any | None = None
) -> None: ...
def test_queue_free(gfree_pointer: int | Any | None = None) -> None: ...
...
def thread_exit(retval: int | Any | None = None) -> None: ...
...
def trash_stack_peek(stack_p: TrashStack) -> int: ...
def trash_stack_pop(stack_p: TrashStack) -> int: ...
def trash_stack_push(stack_p: TrashStack, data_p: int | Any | None) -> None: ...
def try_malloc(n_bytes: int) -> int: ...
def try_malloc0(n_bytes: int) -> int: ...
def try_malloc0_n(n_blocks: int, n_block_bytes: int) -> int: ...
def try_malloc_n(n_blocks: int, n_block_bytes: int) -> int: ...
def try_realloc(mem: int | Any | None, n_bytes: int) -> int: ...
def try_realloc_n(mem: int | Any | None, n_blocks: int, n_block_bytes: int) -> int: ...
...
def unicode_script_to_iso15924(script: _UnicodeScriptValueType) -> int: ...
def unix_error_quark() -> int: ...
def unix_fd_add_full(
    priority: int,
    fd: int,
    condition: _IOConditionValueType,
    function: Callable[[int, _IOConditionValueType, Unpack[_DataTs]], bool],
    *user_data: Unpack[_DataTs],
) -> int: ...
def unix_fd_source_new(fd: int, condition: _IOConditionValueType) -> Source: ...
def unix_get_passwd_entry(user_name: str) -> int: ...
...
def utf8_normalize(str: str, len: int, mode: _NormalizeModeValueType) -> str | None: ...
...
def utime(filename: str, utb: int | Any | None = None) -> int: ...
...
class AsyncQueue(_gi.Struct):
    ...
    def push_sorted(
        self,
        data: int | Any | None,
        func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], int],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    ...
    def timed_pop(self, end_time: TimeVal) -> int: ...
    def timed_pop_unlocked(self, end_time: TimeVal) -> int: ...
    def timeout_pop(self, timeout: int) -> int: ...
    def timeout_pop_unlocked(self, timeout: int) -> int: ...
    def try_pop(self) -> int: ...
    def try_pop_unlocked(self) -> int: ...
...
class ByteArray(GObject.GBoxed):
    ...
    @staticmethod
    def free(array: _Sequence[int], free_segment: bool) -> bytes: ...
    @staticmethod
    ...
    def sort(
        array: _Sequence[int],
        compare_func: Callable[[Any | None, int | Any | None], int],
    ) -> None: ...
    @staticmethod
    def sort_with_data(
        array: _Sequence[int],
...
class Bytes(GObject.GBoxed):
    ...
    def get_region(self, element_size: int, offset: int, n_elements: int) -> int: ...
    def get_size(self) -> int: ...
    def hash(self) -> int: ...
    @classmethod
...
class Cache(_gi.Struct):
    ...
    def insert(self, key: int | Any | None = None) -> int: ...
    def key_foreach(
        self,
        func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def remove(self, value: int | Any | None = None) -> None: ...
    def value_foreach(
        self,
        func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
...
class HashTable(GObject.GBoxed):
    ...
    def find(
        hash_table: Mapping[int | Any | None, int | Any | None],
        predicate: Callable[
            [int | Any | None, int | Any | None, Unpack[_DataTs]], bool
        ],
        *user_data: Unpack[_DataTs],
    ) -> int: ...
    @staticmethod
...
class HashTableIter(_gi.Struct):
    ...
    def replace(self, value: int | Any | None = None) -> None: ...
    def steal(self) -> None: ...
...
class HookList(_gi.Struct):
    ...
    def marshal(
        self,
        may_recurse: bool,
        marshaller: Callable[[Hook, Unpack[_DataTs]], None],
        *marshal_data: Unpack[_DataTs],
    ) -> None: ...
    def marshal_check(
        self,
        may_recurse: bool,
        marshaller: Callable[[Hook, Unpack[_DataTs]], bool],
        *marshal_data: Unpack[_DataTs],
    ) -> None: ...
...
class IOChannel(GObject.GBoxed):
    ...
    @property
    def read_cd(self) -> int: ...
    @property
    def write_cd(self) -> int: ...
    @property
...
class IOFuncs(_gi.Struct):
    ...
    def io_create_watch(
        self,
    ) -> Callable[[IOChannel, _IOConditionValueType], Source]: ...
    @property
...
class MainContext(GObject.GBoxed):
    ...
    def find_source_by_funcs_user_data(
        self, funcs: SourceFuncs, user_data: int | Any | None = None
    ) -> Source | None: ...
...
class MarkupParseContext(GObject.GBoxed):
    ...
    def __init__(
        ...
        user_data_dnotify: Callable[[Any | None], None],
    ) -> None: ...
    ...
    def pop(self) -> int: ...
    def push(
        self, parser: MarkupParser, user_data: int | Any | None = None
    ) -> None: ...
...
class MarkupParser(_gi.Struct):
    ...
    def start_element(
        self,
    ) -> Callable[[MarkupParseContext, str, str, str, Any | None], None]: ...
    @property
    def end_element(self) -> Callable[[MarkupParseContext, str, Any | None], None]: ...
    @property
    def text(self) -> Callable[[MarkupParseContext, str, int, Any | None], None]: ...
    @property
    def passthrough(
        self,
    ) -> Callable[[MarkupParseContext, str, int, Any | None], None]: ...
    @property
    def error(self) -> Callable[[MarkupParseContext, Error, Any | None], None]: ...
...
class MemChunk(_gi.Struct):
    ...
    def clean(self) -> None: ...
    def destroy(self) -> None: ...
    def free(self, mem: int | Any | None = None) -> None: ...
    @staticmethod
    def info() -> None: ...
...
class MemVTable(_gi.Struct):
    ...
    """
    @property
    def malloc(self) -> Callable[[int], int]: ...
    @property
    def realloc(self) -> Callable[[Any | None, int], int]: ...
    @property
    def free(self) -> Callable[[Any | None], None]: ...
    @property
    def calloc(self) -> Callable[[int, int], int]: ...
    @property
    def try_malloc(self) -> Callable[[int], int]: ...
    @property
    def try_realloc(self) -> Callable[[Any | None, int], int]: ...
...
class Node(_gi.Struct):
    ...
    parent: Node
    children: Node
    def child_index(self, data: int | Any | None = None) -> int: ...
    def child_position(self, child: Node) -> int: ...
    def children_foreach(
        self,
        flags: TraverseFlags,
        func: Callable[[Node, Unpack[_DataTs]], None],
        *data: Unpack[_DataTs],
    ) -> None: ...
    def depth(self) -> int: ...
    def destroy(self) -> None: ...
    ...
    def traverse(
        ...
        flags: TraverseFlags,
        max_depth: int,
        func: Callable[[Node, Unpack[_DataTs]], bool],
        *data: Unpack[_DataTs],
    ) -> None: ...
...
class Once(_gi.Struct):
    ...
    retval: int
    @staticmethod
    def init_enter(location: int | Any | None) -> tuple[bool, int]: ...
    @staticmethod
    def init_enter_impl(location: int) -> bool: ...
    @staticmethod
    def init_enter_pointer(location: int | Any | None) -> bool: ...
    @staticmethod
    def init_leave(location: int | Any | None, result: int) -> int: ...
    @staticmethod
...
class OptionContext(_gi.Struct):
    ...
    def set_translate_func(
        self,
        func: Callable[[str, Unpack[_DataTs]], str] | None = None,
        *data: Unpack[_DataTs],
    ) -> None: ...
...
class Private(_gi.Struct):
    ...
    def get(self) -> int: ...
    def replace(self, value: int | Any | None = None) -> None: ...
    def set(self, value: int | Any | None = None) -> None: ...
...
class Queue(_gi.Struct):
    ...
    def clear(self) -> None: ...
    def clear_full(
        self, free_func: Callable[[Any | None], None] | None = None
    ) -> None: ...
    def foreach(
        self,
        func: Callable[[int | Any | None, Unpack[_DataTs]], None],
    ...
    def free(self) -> None: ...
    def free_full(self, free_func: Callable[[Any | None], None]) -> None: ...
    def get_length(self) -> int: ...
    def index(self, data: int | Any | None = None) -> int: ...
    def init(self) -> None: ...
    def insert_sorted(
        self,
        data: int | Any | None,
    ...
    def pop_nth(self, n: int) -> int: ...
    def pop_tail(self) -> int: ...
    def push_head(self, data: int | Any | None = None) -> None: ...
    def push_nth(self, data: int | Any | None, n: int) -> None: ...
    def push_tail(self, data: int | Any | None = None) -> None: ...
    def remove(self, data: int | Any | None = None) -> bool: ...
    def remove_all(self, data: int | Any | None = None) -> int: ...
...
class Regex(GObject.GBoxed):
    ...
    def replace_eval(
        ...
        start_position: int,
        match_options: RegexMatchFlags,
        eval: Callable[[MatchInfo, String, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> str: ...
    def replace_literal(
        self,
...
class Scanner(_gi.Struct):
    ...
    next_position: int
    @property
    def symbol_table(self) -> dict[int, int]: ...
    @property
    ...
    def scope_add_symbol(
        self, scope_id: int, symbol: str, value: int | Any | None = None
    ) -> None: ...
    ...
    def scope_lookup_symbol(self, scope_id: int, symbol: str) -> int: ...
...
class Sequence(_gi.Struct):
    def append(self, data: int | Any | None = None) -> SequenceIter: ...
    def foreach(
        self,
        func: Callable[[int | Any | None, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ...
    def prepend(self, data: int | Any | None = None) -> SequenceIter: ...
    @staticmethod
    ...
    @staticmethod
    def set(iter: SequenceIter, data: int | Any | None = None) -> None: ...
    def sort(
        self,
        cmp_func: Callable[[int | Any | None, int | Any | None, Unpack[_DataTs]], int],
        *cmp_data: Unpack[_DataTs],
    ...
    def sort_iter(
        self,
        cmp_func: Callable[[SequenceIter, SequenceIter, Unpack[_DataTs]], int],
        *cmp_data: Unpack[_DataTs],
    ) -> None: ...
    @staticmethod
...
class Source(GObject.GBoxed):
    ...
    def add_unix_fd(self, fd: int, events: _IOConditionValueType) -> int: ...
    ...
    def modify_unix_fd(
        self, tag: int | Any | None, new_events: _IOConditionValueType
    ) -> None: ...
    @classmethod
    ...
    @staticmethod
    def remove_by_user_data(user_data: int | Any | None = None) -> bool: ...
...
class SourceCallbackFuncs(_gi.Struct):
    ...
    """
    @property
    def ref(self) -> Callable[[Any | None], None]: ...
    @property
    def unref(self) -> Callable[[Any | None], None]: ...
    @property
    def get(self) -> int: ...
...
class SourceFuncs(_gi.Struct):
    ...
    @property
    def closure_callback(self) -> Callable[[Any | None], bool]: ...
    @property
...
class Thread(GObject.GBoxed):
    ...
    """
    @property
    def func(self) -> Callable[[Any | None], int]: ...
    @property
    def data(self) -> int: ...
    @property
    ...
    def error_quark() -> int: ...
    @staticmethod
    def exit(retval: int | Any | None = None) -> None: ...
    ...
    def new(
        cls,
        name: str | None,
        func: Callable[[Unpack[_DataTs]], int],
        *data: Unpack[_DataTs],
    ) -> Thread: ...
    def ref(self) -> Thread: ...
    @staticmethod
...
class ThreadPool(_gi.Struct):
    ...
    func: Callable[[int | Any | None, Any | None], None]
    user_data: int
    exclusive: bool
    ...
    def move_to_front(self, data: int | Any | None = None) -> bool: ...
    def push(self, data: int | Any | None = None) -> bool: ...
    @staticmethod
...
class TrashStack(_gi.Struct):
    ...
    @staticmethod
    def peek(stack_p: TrashStack) -> int: ...
    @staticmethod
    def pop(stack_p: TrashStack) -> int: ...
    @staticmethod
...
class Tree(GObject.GBoxed):
    ...
    def foreach(
        self,
        func: Callable[[Any | None, int | Any | None, int | Any | None], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def foreach_node(
        self,
        func: Callable[[TreeNode, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def height(self) -> int: ...
    def insert(
        self, key: int | Any | None = None, value: int | Any | None = None
    ) -> None: ...
    def insert_node(
        self, key: int | Any | None = None, value: int | Any | None = None
    ) -> TreeNode | None: ...
    def lookup(self, key: int | Any | None = None) -> int: ...
    def lookup_extended(
        self, lookup_key: int | Any | None = None
    ) -> tuple[bool, int, int]: ...
    def lookup_node(self, key: int | Any | None = None) -> TreeNode | None: ...
    def lower_bound(self, key: int | Any | None = None) -> TreeNode | None: ...
    @classmethod
    def new_full(
        cls,
        key_compare_func: Callable[
            [int | Any | None, int | Any | None, Any | None], int
        ],
        key_compare_data: Any | None,
        key_destroy_func: Callable[[Any | None], None],
    ) -> Tree: ...
    def nnodes(self) -> int: ...
    def node_first(self) -> TreeNode | None: ...
    def node_last(self) -> TreeNode | None: ...
    def ref(self) -> Tree: ...
    def remove(self, key: int | Any | None = None) -> bool: ...
    ...
    def search(
        self,
        search_func: Callable[[Any | None, int | Any | None], int],
        *user_data: Unpack[_DataTs],
    ) -> int: ...
    def search_node(
        self,
    ...
    def steal(self, key: int | Any | None = None) -> bool: ...
    def traverse(
        self,
        traverse_func: Callable[[Any | None, int | Any | None, int | Any | None], bool],
        traverse_type: TraverseType,
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def unref(self) -> None: ...
    def upper_bound(self, key: int | Any | None = None) -> TreeNode | None: ...
...
class Tuples(_gi.Struct):
    ...
    len: int
    def destroy(self) -> None: ...
    def index(self, index_: int, field: int) -> int: ...
...
_IOConditionLiteralType: TypeAlias = Literal[
    "G_IO_ERR",
    "G_IO_HUP",
    "G_IO_IN",
    "G_IO_NVAL",
...
_IOConditionValueType: TypeAlias = (
    IOCondition | _IOConditionLiteralType | tuple[_IOConditionLiteralType, ...]
)
...
_NormalizeModeLiteralType: TypeAlias = Literal[
    "G_NORMALIZE_ALL",
...
_NormalizeModeValueType: TypeAlias = NormalizeMode | _NormalizeModeLiteralType
...
_UnicodeBreakTypeLiteralType: TypeAlias = Literal[
...
_UnicodeBreakTypeValueType: TypeAlias = UnicodeBreakType | _UnicodeBreakTypeLiteralType
...
class UnicodeScript(GObject.GEnum):
    ...
    @staticmethod
    def to_iso15924(script: _UnicodeScriptValueType) -> int: ...

_UnicodeScriptLiteralType: TypeAlias = Literal[
...
_UnicodeScriptValueType: TypeAlias = UnicodeScript | _UnicodeScriptLiteralType
...
_UnicodeTypeLiteralType: TypeAlias = Literal[
...
_UnicodeTypeValueType: TypeAlias = UnicodeType | _UnicodeTypeLiteralType

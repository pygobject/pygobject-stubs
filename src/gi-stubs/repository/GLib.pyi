...
def byte_array_append(array: Sequence[int], data: int, len: int) -> bytes: ...
...
def byte_array_prepend(array: Sequence[int], data: int, len: int) -> bytes: ...
def byte_array_ref(array: Sequence[int]) -> bytes: ...
def byte_array_remove_index(array: Sequence[int], index_: int) -> bytes: ...
def byte_array_remove_index_fast(array: Sequence[int], index_: int) -> bytes: ...
def byte_array_remove_range(
    array: Sequence[int], index_: int, length: int
) -> bytes: ...
def byte_array_set_size(array: Sequence[int], length: int) -> bytes: ...
def byte_array_sized_new(reserved_size: int) -> bytes: ...
def byte_array_sort(
    array: Sequence[int], compare_func: Callable[[None, None], int]
) -> None: ...
def byte_array_sort_with_data(
    array: Sequence[int], compare_func: Callable[..., int], *user_data: Any
) -> None: ...
...
def compute_hmac_for_data(
    digest_type: ChecksumType, key: Sequence[int], data: Sequence[int]
) -> str: ...
...
def environ_getenv(envp: Optional[Sequence[str]], variable: str) -> Optional[str]: ...
def environ_setenv(
    envp: Optional[Sequence[str]], variable: str, value: str, overwrite: bool
) -> list[str]: ...
def environ_unsetenv(envp: Optional[Sequence[str]], variable: str) -> list[str]: ...
...
def file_set_contents_full(
    filename: str, contents: Sequence[int], flags: FileSetContentsFlags, mode: int
) -> bool: ...
...
def log_writer_default_set_debug_domains(domains: Optional[str] = None) -> None: ...
...
def parse_debug_string(string: Optional[str], keys: Sequence[DebugKey]) -> int: ...
...
def strdupv(str_array: Optional[Sequence[str]] = None) -> Optional[list[str]]: ...
def strerror(errnum: int) -> str: ...
def strescape(source: str, exceptions: Optional[str] = None) -> str: ...
def strfreev(str_array: Optional[Sequence[str]] = None) -> None: ...
def strip_context(msgid: str, msgval: str) -> str: ...
def strjoinv(separator: Optional[str], str_array: Sequence[str]) -> str: ...
...
def strndup(str: Optional[str], n: int) -> Optional[str]: ...
...
def strv_contains(strv: Sequence[str], str: str) -> bool: ...
def strv_equal(strv1: Sequence[str], strv2: Sequence[str]) -> bool: ...
def strv_get_type() -> Type: ...
def strv_length(str_array: Sequence[str]) -> int: ...
...
def ucs4_to_utf16(str: Sequence[str]) -> Tuple[int, int, int]: ...
def ucs4_to_utf8(str: Sequence[str]) -> Tuple[str, int, int]: ...
...
def unicode_canonical_ordering(string: Sequence[str]) -> None: ...
...
def utf16_to_ucs4(str: Sequence[int]) -> Tuple[str, int, int]: ...
def utf16_to_utf8(str: Sequence[int]) -> Tuple[str, int, int]: ...
...
class BookmarkFile(GObject.GBoxed):
    ...
    def set_groups(self, uri: str, groups: Optional[Sequence[str]] = None) -> None: ...
...
class ByteArray(GObject.GBoxed):
    ...
    len: int = ...
    @staticmethod
    def append(array: Sequence[int], data: int, len: int) -> bytes: ...
    @staticmethod
    ...
    @staticmethod
    def prepend(array: Sequence[int], data: int, len: int) -> bytes: ...
    @staticmethod
    def ref(array: Sequence[int]) -> bytes: ...
    @staticmethod
    def remove_index(array: Sequence[int], index_: int) -> bytes: ...
    @staticmethod
    def remove_index_fast(array: Sequence[int], index_: int) -> bytes: ...
    @staticmethod
    def remove_range(array: Sequence[int], index_: int, length: int) -> bytes: ...
    @staticmethod
    def set_size(array: Sequence[int], length: int) -> bytes: ...
    @staticmethod
...
class DateTime(GObject.GBoxed):
    ...
    @classmethod
    def new_from_unix_local_usec(cls, usecs: int) -> Optional[DateTime]: ...
    @classmethod
    def new_from_unix_utc(cls, t: int) -> Optional[DateTime]: ...
    @classmethod
    def new_from_unix_utc_usec(cls, usecs: int) -> Optional[DateTime]: ...
    @classmethod
    def new_local(
...
class Hmac(GObject.GBoxed):
    ...
    def get_string(self) -> str: ...
    @classmethod
    def new(cls, digest_type: ChecksumType, key: Sequence[int]) -> Optional[Hmac]: ...
    def ref(self) -> Hmac: ...
    def unref(self) -> None: ...
    def update(self, data: Sequence[int]) -> None: ...
...
class IOChannel(GObject.GBoxed):
    ...
    def write_chars(self, buf: Sequence[int], count: int) -> Tuple[IOStatus, int]: ...
...
class PathBuf(GObject.GPointer):
    ...
    dummy: list[None] = ...
    def clear(self) -> None: ...
    def clear_to_path(self) -> Optional[str]: ...
    @staticmethod
    def equal(v1: None, v2: None) -> bool: ...
    def free(self) -> None: ...
    def free_to_path(self) -> Optional[str]: ...
    def init(self) -> PathBuf: ...
    def init_from_path(self, path: Optional[str] = None) -> PathBuf: ...
    def pop(self) -> bool: ...
    def push(self, path: str) -> PathBuf: ...
    def set_extension(self, extension: Optional[str] = None) -> bool: ...
    def set_filename(self, file_name: str) -> bool: ...
    def to_path(self) -> Optional[str]: ...
...
class Regex(GObject.GBoxed):
    ...
    def match_all_full(
        self, string: Sequence[str], start_position: int, match_options: RegexMatchFlags
    ) -> Tuple[bool, MatchInfo]: ...
    def match_full(
        self, string: Sequence[str], start_position: int, match_options: RegexMatchFlags
    ) -> Tuple[bool, MatchInfo]: ...
...
class String(GObject.GBoxed):
    ...
    @classmethod
    def new_take(cls, init: Optional[str] = None) -> String: ...
...
class Tree(GObject.GBoxed):
    ...
    def insert_node(self, key: None, value: None) -> Optional[TreeNode]: ...
    ...
    def replace_node(self, key: None, value: None) -> Optional[TreeNode]: ...
...
class Variant(GObject.GPointer):
    ...
    def split_signature(signature): ...  # FIXME Function

...
def async_queue_new_full(
    item_free_func: typing.Callable[[None], None] | None = None,
) -> AsyncQueue: ...
...
def base64_encode(data: typing.Sequence[int] | None = None) -> str: ...
...
def environ_getenv(envp: typing.Sequence[str] | None, variable: str) -> str | None: ...
def environ_setenv(
    envp: typing.Sequence[str] | None,
    variable: str,
    value: str,
    overwrite: bool,
) -> list[str]: ...
def environ_unsetenv(envp: typing.Sequence[str] | None, variable: str) -> list[str]: ...
...
def file_open_tmp(tmpl: str | None = None) -> typing.Tuple[int, str]: ...
...
def parse_debug_string(string: str | None, keys: typing.Sequence[DebugKey]) -> int: ...
...
def spawn_async_with_fds(
    ...
    envp: typing.Sequence[str] | None,
    flags: SpawnFlags,
    child_setup: typing.Callable[..., None] | None,
    stdin_fd: int,
    stdout_fd: int,
    stderr_fd: int,
    *user_data: typing.Any,
...
def spawn_async_with_pipes(
    ...
    envp: typing.Sequence[str] | None,
    flags: SpawnFlags,
    child_setup: typing.Callable[..., None] | None = None,
    *user_data: typing.Any,
...
def spawn_async_with_pipes_and_fds(
    ...
    stdout_fd: int,
    stderr_fd: int,
    source_fds: typing.Sequence[int] | None = None,
    target_fds: typing.Sequence[int] | None = None,
    *user_data: typing.Any,
) -> typing.Tuple[bool, int, int, int, int]: ...
...
def strdupv(
    str_array: typing.Sequence[str] | None = None,
) -> list[str] | None: ...
def strerror(errnum: int) -> str: ...
def strescape(source: str, exceptions: str | None = None) -> str: ...
def strfreev(str_array: typing.Sequence[str] | None = None) -> None: ...
def strip_context(msgid: str, msgval: str) -> str: ...
def strjoinv(separator: str | None, str_array: typing.Sequence[str]) -> str: ...
...
def uri_escape_bytes(
    unescaped: typing.Sequence[int], reserved_chars_allowed: str | None = None
) -> str: ...
...
class BookmarkFile(GObject.GBoxed):
    ...
    def set_groups(
        self, uri: str, groups: typing.Sequence[str] | None = None
    ) -> None: ...
...
class ByteArray(GObject.GBoxed):
    ...
    @staticmethod
    def free(array: typing.Sequence[int], free_segment: bool) -> bytes | None: ...
    @staticmethod
...
class Bytes(GObject.GBoxed):
    ...
    """
    @staticmethod
    def __new__(cls: type[Self], data: typing.Sequence[int] | None = None) -> Self: ...
    ...
    def hash(self) -> int: ...
    @classmethod
    def new(cls, data: typing.Sequence[int] | None = None) -> Bytes: ...
    def new_from_bytes(self, offset: int, length: int) -> Bytes: ...
    @classmethod
    def new_take(cls, data: typing.Sequence[int] | None = None) -> Bytes: ...
    def ref(self) -> Bytes: ...
    def unref(self) -> None: ...
...
class Hmac(GObject.GBoxed):
    ...
    @staticmethod
    def __new__(
        cls: type[Self], digest_type: ChecksumType, key: typing.Sequence[int]
    ) -> Self: ...
    def copy(self) -> Hmac: ...
...
class OptionContext(GObject.GPointer):
    ...
    def set_translate_func(
        self, func: typing.Callable[..., str] | None = None, *data: typing.Any
    ) -> None: ...
...
class Queue(GObject.GPointer):
    ...
    def clear(self) -> None: ...
    def clear_full(
        self, free_func: typing.Callable[[None], None] | None = None
    ) -> None: ...
    def foreach(
        self, func: typing.Callable[..., None], *user_data: typing.Any
    ) -> None: ...
...
class Variant(GObject.GPointer):
    ...
    def new_array(
        ...
        children: typing.Sequence[Variant] | None = None,
    ) -> Variant: ...
    @classmethod

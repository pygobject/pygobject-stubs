...
def get_license_name(license: str) -> Optional[str]: ...
def get_license_url(license: str) -> Optional[str]: ...
def gstring_replace(
...
def utils_locale_is_compatible(
    locale1: Optional[str] = None, locale2: Optional[str] = None
) -> bool: ...
...
class Component(GObject.Object):
    ...
    def add_keyword(self, keyword: str, locale: Optional[str] = None) -> None: ...
    ...
    def check_relations(
        self,
        sysinfo: Optional[SystemInfo],
        pool: Optional[Pool],
        rel_kind: RelationKind,
    ) -> list[RelationCheckResult]: ...
    def clear_keywords(self, locale: Optional[str] = None) -> None: ...
    ...
    def load_releases(self, allow_net: bool) -> Optional[ReleaseList]: ...
    @classmethod
    ...
    def set_keywords(
        self, new_keywords: Sequence[str], locale: Optional[str], deep_copy: bool
    ) -> None: ...
    ...
    def sort_screenshots(
        self, environment: Optional[str], style: Optional[str], prioritize_style: bool
    ) -> None: ...
...
class Metadata(GObject.Object):
    ...
    def get_release_list(self) -> Optional[ReleaseList]: ...
...
class Reference(GObject.Object):
    ...
    def get_registry_name(self) -> Optional[str]: ...
    def get_value(self) -> str: ...
    @classmethod
...
class ReleaseList(GObject.Object):
    ...
    def is_empty(self) -> bool: ...
    def load_from_bytes(
        self, context: Optional[Context], bytes: GLib.Bytes
    ) -> bool: ...
    @classmethod
...
class Screenshot(GObject.Object):
    ...
    def get_image(self, width: int, height: int, scale: int) -> Optional[Image]: ...
    ...
    def set_context(self, context: Context) -> None: ...
    def set_environment(self, env_id: Optional[str] = None) -> None: ...

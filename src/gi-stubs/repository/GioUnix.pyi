...
def mount_at(mount_path: str) -> typing.Tuple[MountEntry | None, int]: ...
...
def mount_entries_get_from_file(
    table_path: str,
) -> typing.Tuple[list[MountEntry] | None, int]: ...
def mount_entry_at(
    mount_path: str,
) -> typing.Tuple[MountEntry | None, int]: ...
def mount_entry_for(
    file_path: str,
) -> typing.Tuple[MountEntry | None, int]: ...
def mount_for(file_path: str) -> typing.Tuple[MountEntry | None, int]: ...
...
def mount_point_at(
    mount_path: str,
) -> typing.Tuple[MountPoint | None, int]: ...
...
def mount_points_get_from_file(
    table_path: str,
) -> typing.Tuple[list[MountPoint] | None, int]: ...
...
class MountEntry(GObject.GBoxed):
    @staticmethod
    def at(mount_path: str) -> typing.Tuple[MountEntry | None, int]: ...
    def compare(self, mount2: MountEntry) -> int: ...
    def copy(self) -> MountEntry: ...
    @staticmethod
    def for_(file_path: str) -> typing.Tuple[MountEntry | None, int]: ...
    def free(self) -> None: ...
...
class MountPoint(GObject.GBoxed):
    @staticmethod
    def at(mount_path: str) -> typing.Tuple[MountPoint | None, int]: ...

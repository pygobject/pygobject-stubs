...
def value_dup_render_node(value: typing.Any) -> RenderNode | None: ...
def value_get_render_node(value: typing.Any) -> RenderNode | None: ...
def value_set_render_node(value: typing.Any, node: RenderNode) -> None: ...
def value_take_render_node(
    value: typing.Any, node: RenderNode | None = None
) -> None: ...
...
class GLShaderNode(RenderNode):
    ...
    def new(
        ...
        bounds: Graphene.Rect,
        args: GLib.Bytes,
        children: typing.Sequence[RenderNode] | None = None,
    ) -> GLShaderNode: ...
...
class RenderNode(_gi.Fundamental):
    ...
    def deserialize(
        bytes: GLib.Bytes,
        error_func: typing.Callable[..., None] | None = None,
        *user_data: typing.Any,
    ) -> RenderNode | None: ...
...
class Stroke(GObject.GBoxed):
    ...
    def set_dash(self, dash: typing.Sequence[float] | None = None) -> None: ...

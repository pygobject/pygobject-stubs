...
) -> typing.Tuple[dict[str, str] | None, str, str, GLib.Bytes]: ...
...
def uri_decode_data_uri(
    uri: str,
) -> typing.Tuple[GLib.Bytes | None, str | None]: ...
...
def websocket_client_prepare_handshake(
    ...
    supported_extensions: typing.Sequence[GObject.TypeClass] | None = None,
) -> None: ...
...
class AuthDomainDigest(AuthDomain):
    ...
    # override
    class Props:
        auth_callback: typing.Callable[..., str | None]
        auth_data: None
        filter: typing.Callable[..., bool]
        filter_data: None
        generic_auth_callback: typing.Callable[..., bool]
...
class MessageHeaders(GObject.GBoxed):
    ...
    def get_content_type(
        self,
    ) -> typing.Tuple[str | None, dict[str, str]]: ...
...
class Server(GObject.Object):
    ...
    def add_websocket_handler(
        ...
        path: str | None,
        origin: str | None,
        protocols: typing.Sequence[str] | None,
        callback: typing.Callable[..., None],
        *user_data: typing.Any,
    ) -> None: ...
...
class ServerMessage(GObject.Object):
    ...
    def set_response(
        ...
        content_type: str | None,
        resp_use: MemoryUse,
        resp_body: typing.Sequence[int] | None = None,
    ) -> None: ...
    def set_status(
...
class WebsocketConnection(GObject.Object):
    ...
    def send_binary(self, data: typing.Sequence[int] | None = None) -> None: ...
...
class WebsocketExtensionClass(GObject.GPointer):
    ...
    get_request_params: typing.Callable[[WebsocketExtension], str | None] = ...
    get_response_params: typing.Callable[[WebsocketExtension], str | None] = ...

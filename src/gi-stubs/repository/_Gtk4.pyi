...
def accelerator_parse_with_keycode(
    accelerator: str, display: Optional[Gdk.Display]
...
def distribute_natural_allocation(
    extra_space: int, n_requested_sizes: int, sizes: list[RequestedSize]
) -> int: ...
...
def enumerate_printers(func: Callable[..., bool], wait: bool, *args: Any) -> None: ...
...
def paper_size_get_paper_sizes(include_custom: bool) -> list: ...
...
def value_take_expression(value: Any, expression: Optional[Expression]) -> None: ...
...
class AboutDialog(
    ...
    def set_logo(self, logo: Optional[Gdk.Paintable]) -> None: ...
    def set_logo_icon_name(self, icon_name: Optional[str]) -> None: ...
    def set_program_name(self, name: Optional[str]) -> None: ...
    def set_system_information(self, system_information: Optional[str]) -> None: ...
...
class Accessible:
    ...
    def update_property(
        self, n_properties: int, properties: list[AccessibleProperty], values: list[Any]
    ) -> None: ...
    def update_relation(
        self, n_relations: int, relations: list[AccessibleRelation], values: list[Any]
    ) -> None: ...
    def update_state(
        self, n_states: int, states: list[AccessibleState], values: list[Any]
    ) -> None: ...
...
class Actionable:
    ...
    def set_action_name(self, action_name: Optional[str]) -> None: ...
...
class AspectFrame(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_child(self, child: Optional[Widget]) -> None: ...
...
class Assistant(
    ...
    def set_forward_page_func(
        self, page_func: Optional[Callable[..., int]], *args: Any
    ) -> None: ...
...
class BookmarkList(GObject.Object, Gio.ListModel):
    ...
    @classmethod
    def new(
        cls, filename: Optional[str], attributes: Optional[str]
    ) -> BookmarkList: ...
    def set_attributes(self, attributes: Optional[str]) -> None: ...
...
class BoolFilter(Filter):
    ...
    @classmethod
    def new(cls, expression: Optional[Expression]) -> BoolFilter: ...
    def set_expression(self, expression: Optional[Expression]) -> None: ...
...
class Box(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    def insert_child_after(self, child: Widget, sibling: Optional[Widget]) -> None: ...
    @classmethod
...
class Builder(GObject.Object):
    ...
    def add_objects_from_file(self, filename: str, object_ids: list[str]) -> bool: ...
    def add_objects_from_resource(
        self, resource_path: str, object_ids: list[str]
    ) -> bool: ...
    ...
    def set_current_object(self, current_object: Optional[GObject.Object]) -> None: ...
    def set_scope(self, scope: Optional[BuilderScope]) -> None: ...
    ...
    class BuilderScope:
        ...
        def getv(
            self, n_properties: int, names: list[str], values: list[Any]
        ) -> None: ...
...
class Button(Widget, Accessible, Actionable, Buildable, ConstraintTarget):
    ...
    def new(cls) -> Button: ...
    @classmethod
    def new_from_icon_name(cls, icon_name: Optional[str]) -> Button: ...
    @classmethod
...
class CallbackAction(ShortcutAction):
    @classmethod
    def new(
        cls, callback: Optional[Callable[..., bool]], *args: Any
    ) -> CallbackAction: ...
...
class CellArea(GObject.InitiallyUnowned, Buildable, CellLayout):
    ...
    def do_foreach(self, callback: Callable[..., bool], *args: Any) -> None: ...
    ...
    def foreach(self, callback: Callable[..., bool], *args: Any) -> None: ...
    def foreach_alloc(
        self,
        context: CellAreaContext,
        widget: Widget,
    ...
    def set_focus_cell(self, renderer: Optional[CellRenderer]) -> None: ...
    def snapshot(
        self,
        context: CellAreaContext,
        widget: Widget,
...
class CellEditable:
    ...
    def start_editing(self, event: Optional[Gdk.Event]) -> None: ...
...
class CellLayout:
    ...
    def set_cell_data_func(
        self, cell: CellRenderer, func: Optional[Callable[..., None]], *args: Any
    ) -> None: ...
...
class CellLayoutIface(GObject.GPointer):
    ...
    get_cells: Callable[[CellLayout], list] = ...
...
class CellView(Widget, Accessible, Buildable, CellLayout, ConstraintTarget, Orientable):
    ...
    def set_displayed_row(self, path: Optional[TreePath]) -> None: ...
...
class CenterBox(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    def set_baseline_position(self, position: BaselinePosition) -> None: ...
    def set_center_widget(self, child: Optional[Widget]) -> None: ...
    def set_end_widget(self, child: Optional[Widget]) -> None: ...
    def set_start_widget(self, child: Optional[Widget]) -> None: ...
...
class CenterLayout(LayoutManager):
    ...
    def set_end_widget(self, widget: Optional[Widget]) -> None: ...
    def set_orientation(self, orientation: Orientation) -> None: ...
    def set_start_widget(self, widget: Optional[Widget]) -> None: ...
...
class CheckButton(Widget, Accessible, Actionable, Buildable, ConstraintTarget):
    ...
    @classmethod
    def new_with_label(cls, label: Optional[str]) -> CheckButton: ...
    @classmethod
    def new_with_mnemonic(cls, label: Optional[str]) -> CheckButton: ...
    def set_active(self, setting: bool) -> None: ...
    def set_child(self, child: Optional[Widget]) -> None: ...
    def set_group(self, group: Optional[CheckButton]) -> None: ...
...
class ClosureExpression(Expression):
    ...
    def new(
        ...
        n_params: int,
        params: Optional[list[Expression]],
    ) -> ClosureExpression: ...
...
class ColorChooserDialog(
    ...
    @classmethod
    def new(
        cls, title: Optional[str], parent: Optional[Window]
    ) -> ColorChooserDialog: ...
...
class ColorChooserInterface(GObject.GPointer):
    ...
    add_palette: Callable[
        [ColorChooser, Orientation, int, int, Optional[list[Gdk.RGBA]]], None
    ] = ...
...
class ColumnViewColumn(GObject.Object):
    ...
    @classmethod
    def new(
        cls, title: Optional[str], factory: Optional[ListItemFactory]
    ) -> ColumnViewColumn: ...
    def set_expand(self, expand: bool) -> None: ...
    def set_factory(self, factory: Optional[ListItemFactory]) -> None: ...
    def set_fixed_width(self, fixed_width: int) -> None: ...
    def set_header_menu(self, menu: Optional[Gio.MenuModel]) -> None: ...
    def set_resizable(self, resizable: bool) -> None: ...
    def set_sorter(self, sorter: Optional[Sorter]) -> None: ...
...
class ComboBox(
    ...
    def set_active_iter(self, iter: Optional[TreeIter]) -> None: ...
    ...
    def set_row_separator_func(
        self, func: Optional[Callable[..., bool]], *args: Any
    ) -> None: ...
...
class ConstraintLayout(LayoutManager, Buildable):
    ...
    def add_constraints_from_description(
        self, lines: list[str], hspacing: int, vspacing: int, views: str
    ) -> list: ...
...
class CustomFilter(Filter):
    @classmethod
    def new(
        cls, match_func: Optional[Callable[..., bool]], *args: Any
    ) -> CustomFilter: ...
    def set_filter_func(
        self, match_func: Optional[Callable[..., bool]], *args: Any
    ) -> None: ...
...
class DirectoryList(GObject.Object, Gio.ListModel):
    ...
    @classmethod
    def new(
        cls, attributes: Optional[str], file: Optional[Gio.File]
    ) -> DirectoryList: ...
    def set_attributes(self, attributes: Optional[str]) -> None: ...
...
class DragSource(GestureSingle):
    ...
    def set_content(self, content: Optional[Gdk.ContentProvider]) -> None: ...
    def set_icon(
...
class DrawingArea(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_draw_func(
        self, draw_func: Optional[Callable[..., None]], *args: Any
    ) -> None: ...
...
class DropDown(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    @classmethod
    def new(
        cls, model: Optional[Gio.ListModel], expression: Optional[Expression]
    ) -> DropDown: ...
    @classmethod
    def new_from_strings(cls, strings: list[str]) -> DropDown: ...
    def set_enable_search(self, enable_search: bool) -> None: ...
    def set_expression(self, expression: Optional[Expression]) -> None: ...
    def set_factory(self, factory: Optional[ListItemFactory]) -> None: ...
    def set_list_factory(self, factory: Optional[ListItemFactory]) -> None: ...
    def set_model(self, model: Optional[Gio.ListModel]) -> None: ...
...
class DropTarget(EventController):
    ...
    def set_actions(self, actions: Gdk.DragAction) -> None: ...
    def set_gtypes(self, types: Optional[list[Type]]) -> None: ...
...
class DropTargetAsync(EventController):
    ...
    def set_actions(self, actions: Gdk.DragAction) -> None: ...
    def set_formats(self, formats: Optional[Gdk.ContentFormats]) -> None: ...
...
class Entry(Widget, Accessible, Buildable, CellEditable, ConstraintTarget, Editable):
    ...
    def set_extra_menu(self, model: Optional[Gio.MenuModel]) -> None: ...
    ...
    def set_icon_from_gicon(
        self, icon_pos: EntryIconPosition, icon: Optional[Gio.Icon]
    ) -> None: ...
    def set_icon_from_icon_name(
        self, icon_pos: EntryIconPosition, icon_name: Optional[str]
    ) -> None: ...
    def set_icon_from_paintable(
        self, icon_pos: EntryIconPosition, paintable: Optional[Gdk.Paintable]
    ) -> None: ...
    ...
    def set_tabs(self, tabs: Optional[Pango.TabArray]) -> None: ...
...
class EntryCompletion(GObject.Object, Buildable, CellLayout):
    ...
    def set_match_func(self, func: Callable[..., bool], *args: Any) -> None: ...
...
class EventController(GObject.Object):
    ...
    def set_static_name(self, name: Optional[str]) -> None: ...
...
class EventControllerKey(EventController):
    ...
    def set_im_context(self, im_context: Optional[IMContext]) -> None: ...
...
class Expander(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def get_use_underline(self) -> bool: ...
    @classmethod
    def new(cls, label: Optional[str]) -> Expander: ...
    @classmethod
    def new_with_mnemonic(cls, label: Optional[str]) -> Expander: ...
    def set_child(self, child: Optional[Widget]) -> None: ...
    def set_expanded(self, expanded: bool) -> None: ...
    def set_label(self, label: Optional[str]) -> None: ...
    def set_label_widget(self, label_widget: Optional[Widget]) -> None: ...
...
class Expression:
    def bind(
        self, target: GObject.Object, property: str, this_: Optional[GObject.Object]
    ) -> ExpressionWatch: ...
    ...
    def unref(self) -> None: ...
    def watch(
        self, this_: Optional[GObject.Object], notify: Callable[..., None], *args: Any
    ) -> ExpressionWatch: ...
...
class FileChooser:
    ...
    def set_current_folder(self, file: Optional[Gio.File]) -> bool: ...
...
class FileChooserNative(NativeDialog, FileChooser):
    ...
    def set_accept_label(self, accept_label: Optional[str]) -> None: ...
    def set_cancel_label(self, cancel_label: Optional[str]) -> None: ...
...
class Filter(GObject.Object):
    ...
    def do_match(self, item: Optional[GObject.Object]) -> bool: ...
...
class FilterListModel(GObject.Object, Gio.ListModel):
    ...
    @classmethod
    def new(
        cls, model: Optional[Gio.ListModel], filter: Optional[Filter]
    ) -> FilterListModel: ...
    def set_filter(self, filter: Optional[Filter]) -> None: ...
...
class Fixed(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_child_transform(
        self, widget: Widget, transform: Optional[Gsk.Transform]
    ) -> None: ...
...
class FlattenListModel(GObject.Object, Gio.ListModel):
    ...
    @classmethod
    def new(cls, model: Optional[Gio.ListModel]) -> FlattenListModel: ...
    def set_model(self, model: Optional[Gio.ListModel]) -> None: ...
...
class FlowBox(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    def selected_foreach(self, func: Callable[..., None], *args: Any) -> None: ...
    def set_activate_on_single_click(self, single: bool) -> None: ...
    def set_column_spacing(self, spacing: int) -> None: ...
    def set_filter_func(
        self, filter_func: Optional[Callable[..., bool]], *args: Any
    ) -> None: ...
    ...
    def set_sort_func(
        self, sort_func: Optional[Callable[..., int]], *args: Any
    ) -> None: ...
...
class FontChooser:
    ...
    def set_filter_func(
        self, filter: Optional[Callable[..., bool]], *args: Any
    ) -> None: ...
    def set_font(self, fontname: str) -> None: ...
    def set_font_desc(self, font_desc: Pango.FontDescription) -> None: ...
    def set_font_map(self, fontmap: Optional[Pango.FontMap]) -> None: ...
...
class Frame(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def get_label_widget(self) -> Optional[Widget]: ...
    @classmethod
    def new(cls, label: Optional[str]) -> Frame: ...
    def set_child(self, child: Optional[Widget]) -> None: ...
    def set_label(self, label: Optional[str]) -> None: ...
...
class GLArea(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_error(self, error: Optional[GLib.Error]) -> None: ...
...
class Gesture(EventController):
    ...
    def get_last_event(
        self, sequence: Optional[Gdk.EventSequence]
    ) -> Optional[Gdk.Event]: ...
    ...
    def handles_sequence(self, sequence: Optional[Gdk.EventSequence]) -> bool: ...
...
class GestureStylus(GestureSingle):
    ...
    def get_axes(self, axes: list[Gdk.AxisUse]) -> Tuple[bool, list[float]]: ...
...
class GridView(
    ...
    @classmethod
    def new(
        cls, model: Optional[SelectionModel], factory: Optional[ListItemFactory]
    ) -> GridView: ...
    def set_enable_rubberband(self, enable_rubberband: bool) -> None: ...
    def set_factory(self, factory: Optional[ListItemFactory]) -> None: ...
...
class HeaderBar(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def pack_start(self, child: Widget) -> None: ...
    def remove(self, child: Widget) -> None: ...
    def set_decoration_layout(self, layout: Optional[str]) -> None: ...
    def set_show_title_buttons(self, setting: bool) -> None: ...
    def set_title_widget(self, title_widget: Optional[Widget]) -> None: ...
...
class IMContext(GObject.Object):
    ...
    def do_set_client_widget(self, widget: Optional[Widget]) -> None: ...
    ...
    def reset(self) -> None: ...
    def set_client_widget(self, widget: Optional[Widget]) -> None: ...
...
class IconTheme(GObject.Object):
    ...
    def set_resource_path(self, path: Optional[list[str]]) -> None: ...
    def set_search_path(self, path: Optional[list[str]]) -> None: ...
    def set_theme_name(self, theme_name: Optional[str]) -> None: ...
...
class IconView(Widget, Accessible, Buildable, CellLayout, ConstraintTarget, Scrollable):
    ...
    def get_activate_on_single_click(self) -> bool: ...
    def get_cell_rect(
        self, path: TreePath, cell: Optional[CellRenderer]
    ...
    def set_tooltip_cell(
        self, tooltip: Tooltip, path: TreePath, cell: Optional[CellRenderer]
    ) -> None: ...
...
class Image(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    @classmethod
    def new_from_icon_name(cls, icon_name: Optional[str]) -> Image: ...
    @classmethod
    def new_from_paintable(cls, paintable: Optional[Gdk.Paintable]) -> Image: ...
    @classmethod
    def new_from_pixbuf(cls, pixbuf: Optional[GdkPixbuf.Pixbuf]) -> Image: ...
    @classmethod
    ...
    def set_from_icon_name(self, icon_name: Optional[str]) -> None: ...
    def set_from_paintable(self, paintable: Optional[Gdk.Paintable]) -> None: ...
    def set_from_pixbuf(self, pixbuf: Optional[GdkPixbuf.Pixbuf]) -> None: ...
    def set_from_resource(self, resource_path: Optional[str]) -> None: ...
...
class Inscription(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def get_yalign(self) -> float: ...
    @classmethod
    def new(cls, text: Optional[str]) -> Inscription: ...
    def set_attributes(self, attrs: Optional[Pango.AttrList]) -> None: ...
    def set_markup(self, markup: Optional[str]) -> None: ...
...
class Label(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def get_yalign(self) -> float: ...
    @classmethod
    def new(cls, str: Optional[str]) -> Label: ...
    @classmethod
    def new_with_mnemonic(cls, str: Optional[str]) -> Label: ...
...
class LevelBar(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    def get_offset_value(self, name: Optional[str]) -> Tuple[bool, float]: ...
    def get_value(self) -> float: ...
    @classmethod
    def new(cls) -> LevelBar: ...
    @classmethod
    def new_for_interval(cls, min_value: float, max_value: float) -> LevelBar: ...
    def remove_offset_value(self, name: Optional[str]) -> None: ...
...
class LinkButton(Button, Accessible, Actionable, Buildable, ConstraintTarget):
    ...
    @classmethod
    def new_with_label(cls, uri: str, label: Optional[str]) -> LinkButton: ...
...
class ListBox(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def bind_model(
        self,
        model: Optional[Gio.ListModel],
        create_widget_func: Optional[Callable[..., Widget]],
        *args: Any,
    ) -> None: ...
    ...
    def remove(self, child: Widget) -> None: ...
    def select_all(self) -> None: ...
    def select_row(self, row: Optional[ListBoxRow]) -> None: ...
    def selected_foreach(self, func: Callable[..., None], *args: Any) -> None: ...
    def set_activate_on_single_click(self, single: bool) -> None: ...
    ...
    def set_header_func(
        self, update_header: Optional[Callable[..., None]], *args: Any
    ) -> None: ...
...
class ListStore(
    ...
    def insert_with_values(
        self, position: int, columns: list[int], values: list[Any]
    ) -> TreeIter: ...
    def insert_with_valuesv(
        self, position: int, columns: list[int], values: list[Any]
    ) -> TreeIter: ...
    def iter_is_valid(self, iter: TreeIter) -> bool: ...
    def move_after(self, iter: TreeIter, position: Optional[TreeIter]) -> None: ...
    def move_before(self, iter: TreeIter, position: Optional[TreeIter]) -> None: ...
    @classmethod
    def new(cls, n_columns: int, types: list[Type]) -> ListStore: ...
    ...
    def set_column_types(self, n_columns: int, types: list[Type]) -> None: ...
...
class LockButton(Button, Accessible, Actionable, Buildable, ConstraintTarget):
    ...
    @classmethod
    def new(cls, permission: Optional[Gio.Permission]) -> LockButton: ...
    def set_permission(self, permission: Optional[Gio.Permission]) -> None: ...
...
class MapListModel(GObject.Object, Gio.ListModel):
    ...
    def new(
        cls,
        model: Optional[Gio.ListModel],
        map_func: Optional[Callable[..., GObject.Object]],
        *args: Any,
    ) -> MapListModel: ...
    def set_map_func(
        self, map_func: Optional[Callable[..., GObject.Object]], *args: Any
    ) -> None: ...
    def set_model(self, model: Optional[Gio.ListModel]) -> None: ...
...
class MediaControls(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    @classmethod
    def new(cls, stream: Optional[MediaStream]) -> MediaControls: ...
    def set_media_stream(self, stream: Optional[MediaStream]) -> None: ...
...
class MediaFile(MediaStream, Gdk.Paintable):
    ...
    def set_input_stream(self, stream: Optional[Gio.InputStream]) -> None: ...
    def set_resource(self, resource_path: Optional[str]) -> None: ...
...
class MenuButton(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_popover(self, popover: Optional[Widget]) -> None: ...
...
class MountOperation(Gio.MountOperation):
    ...
    @classmethod
    def new(cls, parent: Optional[Window]) -> MountOperation: ...
    def set_display(self, display: Gdk.Display) -> None: ...
    def set_parent(self, parent: Optional[Window]) -> None: ...
...
class MultiSelection(GObject.Object, Gio.ListModel, SelectionModel):
    ...
    def get_model(self) -> Optional[Gio.ListModel]: ...
    @classmethod
    def new(cls, model: Optional[Gio.ListModel]) -> MultiSelection: ...
    def set_model(self, model: Optional[Gio.ListModel]) -> None: ...
...
class NoSelection(GObject.Object, Gio.ListModel, SelectionModel):
    ...
    def get_model(self) -> Optional[Gio.ListModel]: ...
    @classmethod
    def new(cls, model: Optional[Gio.ListModel]) -> NoSelection: ...
    def set_model(self, model: Optional[Gio.ListModel]) -> None: ...
...
class Notebook(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def append_page(self, child: Widget, tab_label: Optional[Widget]) -> int: ...
    def append_page_menu(
        self, child: Widget, tab_label: Optional[Widget], menu_label: Optional[Widget]
    ) -> int: ...
    ...
    def prepend_page(self, child: Widget, tab_label: Optional[Widget]) -> int: ...
    ...
    def set_current_page(self, page_num: int) -> None: ...
    def set_group_name(self, group_name: Optional[str]) -> None: ...
    def set_menu_label(self, child: Widget, menu_label: Optional[Widget]) -> None: ...
    ...
    def set_tab_label(self, child: Widget, tab_label: Optional[Widget]) -> None: ...
...
class NumericSorter(Sorter):
    ...
    @classmethod
    def new(cls, expression: Optional[Expression]) -> NumericSorter: ...
    def set_expression(self, expression: Optional[Expression]) -> None: ...
...
class PadController(EventController):
    ...
    @classmethod
    def new(
        cls, group: Gio.ActionGroup, pad: Optional[Gdk.Device]
    ) -> PadController: ...
    def set_action(
...
class PageSetup(GObject.Object):
    ...
    def load_key_file(
        self, key_file: GLib.KeyFile, group_name: Optional[str]
    ) -> bool: ...
    @classmethod
    ...
    def new_from_key_file(
        cls, key_file: GLib.KeyFile, group_name: Optional[str]
    ) -> PageSetup: ...
...
class PageSetupUnixDialog(
    ...
    def set_print_settings(self, print_settings: Optional[PrintSettings]) -> None: ...
...
class Paned(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    def set_end_child(self, child: Optional[Widget]) -> None: ...
    def set_position(self, position: int) -> None: ...
    ...
    def set_start_child(self, child: Optional[Widget]) -> None: ...
...
class PaperSize(GObject.GBoxed):
    ...
    @classmethod
    def new(cls, name: Optional[str]) -> PaperSize: ...
    @classmethod
    def new_custom(
...
class Picture(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def new(cls) -> Picture: ...
    @classmethod
    def new_for_file(cls, file: Optional[Gio.File]) -> Picture: ...
    @classmethod
    def new_for_filename(cls, filename: Optional[str]) -> Picture: ...
    @classmethod
    def new_for_paintable(cls, paintable: Optional[Gdk.Paintable]) -> Picture: ...
    @classmethod
    def new_for_pixbuf(cls, pixbuf: Optional[GdkPixbuf.Pixbuf]) -> Picture: ...
    @classmethod
    def new_for_resource(cls, resource_path: Optional[str]) -> Picture: ...
    def set_alternative_text(self, alternative_text: Optional[str]) -> None: ...
    ...
    def set_paintable(self, paintable: Optional[Gdk.Paintable]) -> None: ...
...
class Popover(Widget, Accessible, Buildable, ConstraintTarget, Native, ShortcutManager):
    ...
    def set_pointing_to(self, rect: Optional[Gdk.Rectangle]) -> None: ...
...
class PopoverMenu(
    ...
    def get_menu_model(self) -> Optional[Gio.MenuModel]: ...
    @classmethod
    def new_from_model(cls, model: Optional[Gio.MenuModel]) -> PopoverMenu: ...
    @classmethod
    def new_from_model_full(
        cls, model: Gio.MenuModel, flags: PopoverMenuFlags
    ) -> PopoverMenu: ...
    def remove_child(self, child: Widget) -> bool: ...
    def set_menu_model(self, model: Optional[Gio.MenuModel]) -> None: ...
...
class PopoverMenuBar(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def get_menu_model(self) -> Optional[Gio.MenuModel]: ...
    @classmethod
    def new_from_model(cls, model: Optional[Gio.MenuModel]) -> PopoverMenuBar: ...
    def remove_child(self, child: Widget) -> bool: ...
    def set_menu_model(self, model: Optional[Gio.MenuModel]) -> None: ...
...
class PrintJob(GObject.Object):
    ...
    def send(self, callback: Callable[..., None], *args: Any) -> None: ...
...
class PrintOperation(GObject.Object, PrintOperationPreview):
    ...
    def run(
        self, action: PrintOperationAction, parent: Optional[Window]
    ) -> PrintOperationResult: ...
    def set_allow_async(self, allow_async: bool) -> None: ...
    def set_current_page(self, current_page: int) -> None: ...
    def set_custom_tab_label(self, label: Optional[str]) -> None: ...
    def set_default_page_setup(
        self, default_page_setup: Optional[PageSetup]
    ) -> None: ...
...
class PrintSettings(GObject.Object):
    ...
    def foreach(self, func: Callable[..., None], *args: Any) -> None: ...
...
class PrintUnixDialog(
    ...
    def get_support_selection(self) -> bool: ...
    @classmethod
    def new(cls, title: Optional[str], parent: Optional[Window]) -> PrintUnixDialog: ...
    def set_current_page(self, current_page: int) -> None: ...
    def set_embed_page_setup(self, embed: bool) -> None: ...
    def set_has_selection(self, has_selection: bool) -> None: ...
    def set_manual_capabilities(self, capabilities: PrintCapabilities) -> None: ...
    def set_page_setup(self, page_setup: PageSetup) -> None: ...
    def set_settings(self, settings: Optional[PrintSettings]) -> None: ...
    def set_support_selection(self, support_selection: bool) -> None: ...
...
class RecentInfo(GObject.GBoxed):
    def create_app_info(self, app_name: Optional[str]) -> Optional[Gio.AppInfo]: ...
...
class RecentManager(GObject.Object):
    ...
    def move_item(self, uri: str, new_uri: Optional[str]) -> bool: ...
    @classmethod
...
class Scale(Range, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    @classmethod
    def new(
        cls, orientation: Orientation, adjustment: Optional[Adjustment]
    ) -> Scale: ...
    @classmethod
    def new_with_range(
    ...
    def set_format_value_func(
        self, func: Optional[Callable[..., str]], *args: Any
    ) -> None: ...
...
class ScaleButton(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    @classmethod
    def new(
        cls, min: float, max: float, step: float, icons: Optional[list[str]]
    ) -> ScaleButton: ...
    def set_adjustment(self, adjustment: Adjustment) -> None: ...
...
class Scrollable:
    ...
    def set_hadjustment(self, hadjustment: Optional[Adjustment]) -> None: ...
    def set_hscroll_policy(self, policy: ScrollablePolicy) -> None: ...
    def set_vadjustment(self, vadjustment: Optional[Adjustment]) -> None: ...
...
class SearchBar(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_child(self, child: Optional[Widget]) -> None: ...
    def set_key_capture_widget(self, widget: Optional[Widget]) -> None: ...
...
class SelectionFilterModel(GObject.Object, Gio.ListModel):
    ...
    def get_model(self) -> Optional[SelectionModel]: ...
    @classmethod
    def new(cls, model: Optional[SelectionModel]) -> SelectionFilterModel: ...
    def set_model(self, model: Optional[SelectionModel]) -> None: ...
...
class Shortcut(GObject.Object):
    ...
    @classmethod
    def new(
        cls, trigger: Optional[ShortcutTrigger], action: Optional[ShortcutAction]
    ) -> Shortcut: ...
    def set_action(self, action: Optional[ShortcutAction]) -> None: ...
    def set_arguments(self, args: Optional[GLib.Variant]) -> None: ...
    def set_trigger(self, trigger: Optional[ShortcutTrigger]) -> None: ...

class ShortcutAction(GObject.Object):
    def activate(
        self, flags: ShortcutActionFlags, widget: Widget, args: Optional[GLib.Variant]
    ) -> bool: ...
    @classmethod
...
class SingleSelection(GObject.Object, Gio.ListModel, SelectionModel):
    ...
    def get_selected_item(self) -> Optional[GObject.Object]: ...
    @classmethod
    def new(cls, model: Optional[Gio.ListModel]) -> SingleSelection: ...
...
class Snapshot(Gdk.Snapshot):
    ...
    def push_repeat(
        self, bounds: Graphene.Rect, child_bounds: Optional[Graphene.Rect]
    ) -> None: ...
    ...
    def to_paintable(
        self, size: Optional[Graphene.Size]
    ) -> Optional[Gdk.Paintable]: ...
    def transform(self, transform: Optional[Gsk.Transform]) -> None: ...
...
class SortListModel(GObject.Object, Gio.ListModel):
    ...
    @classmethod
    def new(
        cls, model: Optional[Gio.ListModel], sorter: Optional[Sorter]
    ) -> SortListModel: ...
    def set_incremental(self, incremental: bool) -> None: ...
    def set_model(self, model: Optional[Gio.ListModel]) -> None: ...
    def set_sorter(self, sorter: Optional[Sorter]) -> None: ...
...
class Sorter(GObject.Object):
    ...
    def do_compare(
        self, item1: Optional[GObject.Object], item2: Optional[GObject.Object]
    ) -> Ordering: ...
...
class Stack(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def add_named(self, child: Widget, name: Optional[str]) -> StackPage: ...
    def add_titled(
...
class StackSwitcher(Widget, Accessible, Buildable, ConstraintTarget, Orientable):
    ...
    def set_stack(self, stack: Optional[Stack]) -> None: ...
...
class StringFilter(Filter):
    ...
    @classmethod
    def new(cls, expression: Optional[Expression]) -> StringFilter: ...
    def set_expression(self, expression: Optional[Expression]) -> None: ...
...
class StringList(GObject.Object, Gio.ListModel, Buildable):
    ...
    @classmethod
    def new(cls, strings: Optional[list[str]]) -> StringList: ...
    def remove(self, position: int) -> None: ...
    def splice(
        self, position: int, n_removals: int, additions: Optional[list[str]]
    ) -> None: ...
...
class StringSorter(Sorter):
    ...
    def get_ignore_case(self) -> bool: ...
    @classmethod
    def new(cls, expression: Optional[Expression]) -> StringSorter: ...
    def set_expression(self, expression: Optional[Expression]) -> None: ...
    def set_ignore_case(self, ignore_case: bool) -> None: ...
...
class SymbolicPaintable:
    def snapshot_symbolic(
        ...
        width: float,
        height: float,
        colors: list[Gdk.RGBA],
    ) -> None: ...

class SymbolicPaintableInterface(GObject.GPointer):
    g_iface: GObject.TypeInterface = ...
    snapshot_symbolic: Callable[
        [SymbolicPaintable, Gdk.Snapshot, float, float, list[Gdk.RGBA]], None
    ] = ...
...
class TextBuffer(GObject.Object):
    ...
    @classmethod
    def new(cls, table: Optional[TextTagTable]) -> TextBuffer: ...
    def paste_clipboard(
        self,
...
class TextIter(GObject.GBoxed):
    ...
    def backward_find_char(
        self, pred: Callable[..., bool], limit: Optional[TextIter], *args: Any
    ) -> bool: ...
    ...
    def backward_to_tag_toggle(self, tag: Optional[TextTag]) -> bool: ...
    ...
    def forward_to_tag_toggle(self, tag: Optional[TextTag]) -> bool: ...
    ...
    def toggles_tag(self, tag: Optional[TextTag]) -> bool: ...
...
class TextTag(GObject.Object):
    ...
    @classmethod
    def new(cls, name: Optional[str]) -> TextTag: ...
...
class TextView(Widget, Accessible, Buildable, ConstraintTarget, Scrollable):
    ...
    def set_buffer(self, buffer: Optional[TextBuffer]) -> None: ...
    def set_cursor_visible(self, setting: bool) -> None: ...
    def set_editable(self, setting: bool) -> None: ...
    def set_extra_menu(self, model: Optional[Gio.MenuModel]) -> None: ...
    def set_gutter(self, win: TextWindowType, widget: Optional[Widget]) -> None: ...
...
class ToggleButton(Button, Accessible, Actionable, Buildable, ConstraintTarget):
    ...
    def set_active(self, is_active: bool) -> None: ...
    def set_group(self, group: Optional[ToggleButton]) -> None: ...
...
class Tooltip(GObject.Object):
    ...
    def set_icon(self, paintable: Optional[Gdk.Paintable]) -> None: ...
    def set_icon_from_gicon(self, gicon: Optional[Gio.Icon]) -> None: ...
    def set_icon_from_icon_name(self, icon_name: Optional[str]) -> None: ...
    def set_markup(self, markup: Optional[str]) -> None: ...
    def set_text(self, text: Optional[str]) -> None: ...
...
class TreeExpander(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def set_list_row(self, list_row: Optional[TreeListRow]) -> None: ...
...
class TreeListRowSorter(Sorter):
    ...
    def get_sorter(self) -> Optional[Sorter]: ...
    @classmethod
    def new(cls, sorter: Optional[Sorter]) -> TreeListRowSorter: ...
    def set_sorter(self, sorter: Optional[Sorter]) -> None: ...
...
class TreeModel:
    def filter_new(self, root: Optional[TreePath]) -> TreeModel: ...
    def foreach(self, func: Callable[..., bool], *args: Any) -> None: ...
...
class TreeModelFilter(GObject.Object, TreeDragSource, TreeModel):
    ...
    def set_modify_func(
        self, n_columns: int, types: list[Type], func: Callable[..., Any], *args: Any
    ) -> None: ...
    def set_value(self, *args, **kwargs): ...  # FIXME Method
...
class TreePath(GObject.GBoxed):
    ...
    @classmethod
    def new_from_indices(cls, indices: list[int]) -> TreePath: ...
    @classmethod
...
class TreeStore(
    ...
    def move_before(self, iter: TreeIter, position: Optional[TreeIter]) -> None: ...
    @classmethod
    def new(cls, n_columns: int, types: list[Type]) -> TreeStore: ...
    def prepend(self, *args, **kwargs): ...  # FIXME Method
    def remove(self, iter: TreeIter) -> bool: ...
    def set(self, *args, **kwargs): ...  # FIXME Method
    def set_column_types(self, n_columns: int, types: list[Type]) -> None: ...
...
class TreeView(Widget, Accessible, Buildable, ConstraintTarget, Scrollable):
    ...
    def do_row_activated(
        self, path: TreePath, column: Optional[TreeViewColumn]
    ) -> None: ...
    ...
    def map_expanded_rows(self, func: Callable[..., None], *args: Any) -> None: ...
    def move_column_after(
        self, column: TreeViewColumn, base_column: Optional[TreeViewColumn]
    ) -> None: ...
    @classmethod
    ...
    def set_expander_column(self, column: Optional[TreeViewColumn]) -> None: ...
    ...
    def set_search_entry(self, entry: Optional[Editable]) -> None: ...
    def set_search_equal_func(
        self, search_equal_func: Callable[..., bool], *args: Any
    ) -> None: ...
...
class TreeViewColumn(GObject.InitiallyUnowned, Buildable, CellLayout):
    ...
    def set_title(self, title: str) -> None: ...
    def set_visible(self, visible: bool) -> None: ...
    def set_widget(self, widget: Optional[Widget]) -> None: ...
...
class Video(Widget, Accessible, Buildable, ConstraintTarget):
    ...
    def new(cls) -> Video: ...
    @classmethod
    def new_for_file(cls, file: Optional[Gio.File]) -> Video: ...
    @classmethod
    def new_for_filename(cls, filename: Optional[str]) -> Video: ...
    @classmethod
    def new_for_media_stream(cls, stream: Optional[MediaStream]) -> Video: ...
    @classmethod
    def new_for_resource(cls, resource_path: Optional[str]) -> Video: ...
...
class Viewport(Widget, Accessible, Buildable, ConstraintTarget, Scrollable):
    ...
    @classmethod
    def new(
        cls, hadjustment: Optional[Adjustment], vadjustment: Optional[Adjustment]
    ) -> Viewport: ...
    def set_child(self, child: Optional[Widget]) -> None: ...
...
class Widget(GObject.InitiallyUnowned, Accessible, Buildable, ConstraintTarget):
    ...
    def activate_action(self, name: str, args: Optional[GLib.Variant]) -> bool: ...
    ...
    def add_shortcut(self, shortcut: Shortcut) -> None: ...
    def add_tick_callback(self, callback: Callable[..., bool], *args: Any) -> int: ...
    def allocate(
        self, width: int, height: int, baseline: int, transform: Optional[Gsk.Transform]
    ) -> None: ...
    ...
    def create_pango_context(self) -> Pango.Context: ...
    def create_pango_layout(self, text: Optional[str]) -> Pango.Layout: ...
    ...
    def do_root(self) -> None: ...
    def do_set_focus_child(self, child: Optional[Widget]) -> None: ...
    def do_show(self) -> None: ...
    ...
    def insert_after(
        self, parent: Widget, previous_sibling: Optional[Widget]
    ) -> None: ...
    def insert_before(self, parent: Widget, next_sibling: Optional[Widget]) -> None: ...
    def install_action(
        self,
        action_name: str,
    ...
    def set_focus_child(self, child: Optional[Widget]) -> None: ...
    def set_focus_on_click(self, focus_on_click: bool) -> None: ...
    def set_focusable(self, focusable: bool) -> None: ...
    def set_font_map(self, font_map: Optional[Pango.FontMap]) -> None: ...
    ...
    def set_layout_manager(self, layout_manager: Optional[LayoutManager]) -> None: ...
...
class WidgetPaintable(GObject.Object, Gdk.Paintable):
    ...
    def get_widget(self) -> Optional[Widget]: ...
    @classmethod
    def new(cls, widget: Optional[Widget]) -> WidgetPaintable: ...
    def set_widget(self, widget: Optional[Widget]) -> None: ...
...
class Window(
    ...
    def set_default_widget(self, default_widget: Optional[Widget]) -> None: ...

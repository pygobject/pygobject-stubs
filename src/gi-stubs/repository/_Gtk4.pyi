...
class ApplicationWindow(Window, Gio.ActionGroup, Gio.ActionMap):
    def __init__(self, title: str = ..., application: Application = ...) -> None: ...
...
class StringList(Buildable, Gio.ListModel, GObject.Object):
...
class TextView(Widget, Scrollable):
...
class Widget(GObject.InitiallyUnowned, Buildable, GObject.Object):
    parent_instance = ...
    priv = ...

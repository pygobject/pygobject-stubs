...
class WebRTCICEClass(GObject.GPointer):
    ...
    add_stream: typing.Callable[[WebRTCICE, int], WebRTCICEStream | None] = ...
    ...
    set_stun_server: typing.Callable[[WebRTCICE, str | None], None] = ...
    get_stun_server: typing.Callable[[WebRTCICE], str | None] = ...
    set_turn_server: typing.Callable[[WebRTCICE, str | None], None] = ...
    get_turn_server: typing.Callable[[WebRTCICE], str | None] = ...

...
class WebRTCDataChannel(GObject.Object):
    ...
    def send_data_full(self, data: Optional[GLib.Bytes] = None) -> bool: ...
    def send_string(self, str: Optional[str] = None) -> None: ...
    def send_string_full(self, str: Optional[str] = None) -> bool: ...
...
class WebRTCICE(Gst.Object):
    ...
    def add_candidate(self, stream: WebRTCICEStream, candidate: str) -> None: ...
    def add_stream(self, session_id: int) -> Optional[WebRTCICEStream]: ...
    def add_turn_server(self, uri: str) -> bool: ...
    def do_add_candidate(self, stream: WebRTCICEStream, candidate: str) -> None: ...
    def do_add_stream(self, session_id: int) -> Optional[WebRTCICEStream]: ...
    def do_add_turn_server(self, uri: str) -> bool: ...
    def do_find_transport(
        self, stream: WebRTCICEStream, component: WebRTCICEComponent
    ) -> Optional[WebRTCICETransport]: ...
    ...
    def do_get_stun_server(self) -> Optional[str]: ...
    def do_get_turn_server(self) -> Optional[str]: ...
    ...
    def do_set_stun_server(self, uri: Optional[str] = None) -> None: ...
    def do_set_tos(self, stream: WebRTCICEStream, tos: int) -> None: ...
    def do_set_turn_server(self, uri: Optional[str] = None) -> None: ...
    def find_transport(
        self, stream: WebRTCICEStream, component: WebRTCICEComponent
    ) -> Optional[WebRTCICETransport]: ...
    ...
    def get_stun_server(self) -> Optional[str]: ...
    def get_turn_server(self) -> Optional[str]: ...
    ...
    def set_stun_server(self, uri: Optional[str] = None) -> None: ...
    def set_tos(self, stream: WebRTCICEStream, tos: int) -> None: ...
    def set_turn_server(self, uri: Optional[str] = None) -> None: ...
...
class WebRTCICEClass(GObject.GPointer):
    ...
    add_stream: Callable[[WebRTCICE, int], Optional[WebRTCICEStream]] = ...
    find_transport: Callable[
        [WebRTCICE, WebRTCICEStream, WebRTCICEComponent], Optional[WebRTCICETransport]
    ] = ...
    gather_candidates: Callable[[WebRTCICE, WebRTCICEStream], bool] = ...
    add_candidate: Callable[[WebRTCICE, WebRTCICEStream, str], None] = ...
    ...
    set_stun_server: Callable[[WebRTCICE, Optional[str]], None] = ...
    get_stun_server: Callable[[WebRTCICE], Optional[str]] = ...
    set_turn_server: Callable[[WebRTCICE, Optional[str]], None] = ...
    get_turn_server: Callable[[WebRTCICE], Optional[str]] = ...
...
class WebRTCICEStream(Gst.Object):
    ...
    stream_id: int = ...
    def __init__(
        self, stream_id: int = ..., name: Optional[str] = ..., parent: Gst.Object = ...
    ): ...
    def do_find_transport(
...
class WebRTCICEStreamClass(GObject.GPointer):
    ...
    parent_class: Gst.ObjectClass = ...
    find_transport: Callable[
        [WebRTCICEStream, WebRTCICEComponent], Optional[WebRTCICETransport]
    ] = ...

...
class MIKEYMessage(GObject.GBoxed):
    ...
    ) -> Optional[MIKEYPayload]: ...
    def get_cs_srtp(self, idx: int) -> Optional[MIKEYMapSRTP]: ...
    def get_n_cs(self) -> int: ...
    def get_n_payloads(self) -> int: ...
    def get_payload(self, idx: int) -> Optional[MIKEYPayload]: ...
    ...
    @classmethod
    def new_from_caps(cls, caps: Gst.Caps) -> Optional[MIKEYMessage]: ...
    @classmethod
    def new_from_data(
...
class MIKEYPayload(GObject.GBoxed):
    ...
    def kemac_get_sub(self, idx: int) -> Optional[MIKEYPayload]: ...
    ...
    def sp_get_param(self, idx: int) -> Optional[MIKEYPayloadSPParam]: ...
...
class SDPMedia(GObject.GPointer):
    ...
    def get_attribute_val(self, key: str) -> Optional[str]: ...
    def get_attribute_val_n(self, key: str, nth: int) -> Optional[str]: ...
    def get_bandwidth(self, idx: int) -> SDPBandwidth: ...
    def get_caps_from_media(self, pt: int) -> Optional[Gst.Caps]: ...

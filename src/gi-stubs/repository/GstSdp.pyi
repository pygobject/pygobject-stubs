...
def sdp_media_init() -> typing.Tuple[SDPResult, SDPMedia]: ...
def sdp_media_new() -> typing.Tuple[SDPResult, SDPMedia]: ...
def sdp_media_set_media_from_caps(
    caps: Gst.Caps,
) -> typing.Tuple[SDPResult, SDPMedia]: ...
def sdp_message_as_uri(scheme: str, msg: SDPMessage) -> str: ...
def sdp_message_init() -> typing.Tuple[SDPResult, SDPMessage]: ...
def sdp_message_new() -> typing.Tuple[SDPResult, SDPMessage]: ...
def sdp_message_new_from_text(text: str) -> typing.Tuple[SDPResult, SDPMessage]: ...
def sdp_message_parse_buffer(
    data: typing.Sequence[int], msg: SDPMessage
) -> SDPResult: ...
...
class MIKEYMessage(GObject.GBoxed):
    ...
    def add_pke(self, C: MIKEYCacheType, data: typing.Sequence[int]) -> bool: ...
    def add_rand(self, rand: typing.Sequence[int]) -> bool: ...
    def add_rand_len(self, len: int) -> bool: ...
    def add_t(self, type: MIKEYTSType, ts_value: typing.Sequence[int]) -> bool: ...
    def add_t_now_ntp_utc(self) -> bool: ...
    def base64_encode(self) -> str: ...
    def find_payload(
        self, type: MIKEYPayloadType, nth: int
    ) -> typing.Optional[MIKEYPayload]: ...
    def get_cs_srtp(self, idx: int) -> typing.Optional[MIKEYMapSRTP]: ...
    def get_n_cs(self) -> int: ...
    def get_n_payloads(self) -> int: ...
    def get_payload(self, idx: int) -> typing.Optional[MIKEYPayload]: ...
    ...
    @classmethod
    def new_from_caps(cls, caps: Gst.Caps) -> typing.Optional[MIKEYMessage]: ...
    @classmethod
    def new_from_data(
        cls, data: typing.Sequence[int], info: MIKEYDecryptInfo
    ) -> MIKEYMessage: ...
...
class MIKEYPayload(GObject.GBoxed):
    ...
    def kemac_get_sub(self, idx: int) -> typing.Optional[MIKEYPayload]: ...
    ...
    def key_data_set_interval(
        self, vf_data: typing.Sequence[int], vt_data: typing.Sequence[int]
    ) -> bool: ...
    def key_data_set_key(
        self, key_type: MIKEYKeyDataType, key_data: typing.Sequence[int]
    ) -> bool: ...
    def key_data_set_salt(
        self, salt_data: typing.Optional[typing.Sequence[int]] = None
    ) -> bool: ...
    def key_data_set_spi(self, spi_data: typing.Sequence[int]) -> bool: ...
    @classmethod
    def new(cls, type: MIKEYPayloadType) -> typing.Optional[MIKEYPayload]: ...
    def pke_set(self, C: MIKEYCacheType, data: typing.Sequence[int]) -> bool: ...
    def rand_set(self, rand: typing.Sequence[int]) -> bool: ...
    def sp_add_param(self, type: int, val: typing.Sequence[int]) -> bool: ...
    def sp_get_n_params(self) -> int: ...
    def sp_get_param(self, idx: int) -> typing.Optional[MIKEYPayloadSPParam]: ...
    def sp_remove_param(self, idx: int) -> bool: ...
    def sp_set(self, policy: int, proto: MIKEYSecProto) -> bool: ...
    def t_set(self, type: MIKEYTSType, ts_value: typing.Sequence[int]) -> bool: ...
...
class SDPAttribute(GObject.GPointer):
    ...
    def set(self, key: str, value: typing.Optional[str] = None) -> SDPResult: ...
...
class SDPMedia(GObject.GPointer):
    ...
    def add_attribute(
        self, key: str, value: typing.Optional[str] = None
    ) -> SDPResult: ...
    ...
    def copy(self) -> typing.Tuple[SDPResult, SDPMedia]: ...
    def formats_len(self) -> int: ...
    def free(self) -> SDPResult: ...
    def get_attribute(self, idx: int) -> SDPAttribute: ...
    def get_attribute_val(self, key: str) -> typing.Optional[str]: ...
    def get_attribute_val_n(self, key: str, nth: int) -> typing.Optional[str]: ...
    def get_bandwidth(self, idx: int) -> SDPBandwidth: ...
    def get_caps_from_media(self, pt: int) -> typing.Optional[Gst.Caps]: ...
    ...
    @staticmethod
    def init() -> typing.Tuple[SDPResult, SDPMedia]: ...
    ...
    @staticmethod
    def new() -> typing.Tuple[SDPResult, SDPMedia]: ...
    def parse_keymgmt(self) -> typing.Tuple[SDPResult, MIKEYMessage]: ...
    ...
    @staticmethod
    def set_media_from_caps(caps: Gst.Caps) -> typing.Tuple[SDPResult, SDPMedia]: ...
...
class SDPMessage(GObject.GBoxed):
    ...
    def add_time(
        self, start: str, stop: str, repeat: typing.Sequence[str]
    ) -> SDPResult: ...
    ...
    def attributes_to_caps(self, caps: Gst.Caps) -> SDPResult: ...
    def bandwidths_len(self) -> int: ...
    def copy(self) -> typing.Tuple[SDPResult, SDPMessage]: ...
    ...
    @staticmethod
    def init() -> typing.Tuple[SDPResult, SDPMessage]: ...
    def insert_attribute(self, idx: int, attr: SDPAttribute) -> SDPResult: ...
    def insert_bandwidth(self, idx: int, bw: SDPBandwidth) -> SDPResult: ...
    ...
    @staticmethod
    def new() -> typing.Tuple[SDPResult, SDPMessage]: ...
    @staticmethod
    def new_from_text(text: str) -> typing.Tuple[SDPResult, SDPMessage]: ...
    @staticmethod
    def parse_buffer(data: typing.Sequence[int], msg: SDPMessage) -> SDPResult: ...
    def parse_keymgmt(self) -> typing.Tuple[SDPResult, MIKEYMessage]: ...
    @staticmethod
...
class SDPTime(GObject.GPointer):
    ...
    repeat: list[None] = ...
    def clear(self) -> SDPResult: ...
    def set(self, start: str, stop: str, repeat: typing.Sequence[str]) -> SDPResult: ...

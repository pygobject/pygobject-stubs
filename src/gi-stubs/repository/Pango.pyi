...
def attr_shape_new_with_data(
    ...
    data: None,
    copy_func: typing.Callable[..., None] | None = None,
    destroy_func: typing.Callable[[None], None] | None = None,
) -> Attribute: ...
...
def parse_enum(
    type: typing.Type[typing.Any], str: str | None, warn: bool
...
class Coverage(GObject.Object):
    ...
    @staticmethod
    def from_bytes(bytes: typing.Sequence[int]) -> Coverage | None: ...
...
class Font(GObject.Object):
    ...
    def descriptions_free(
        descs: typing.Sequence[FontDescription] | None = None,
    ) -> None: ...
    @staticmethod
...
class FontClass(GObject.GPointer):
    ...
    get_glyph_extents: typing.Callable[
        [Font | None, int], typing.Tuple[Rectangle, Rectangle]
    ] = ...
    get_metrics: typing.Callable[[Font | None, Language | None], FontMetrics] = ...
    get_font_map: typing.Callable[[Font | None], FontMap | None] = ...
...
class FontFamilyClass(GObject.GPointer):
    ...
    get_face: typing.Callable[[FontFamily, str | None], FontFace | None] = ...
...
class FontMapClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    load_font: typing.Callable[[FontMap, Context, FontDescription], Font | None] = ...
...
class RendererClass(GObject.GPointer):
    ...
    draw_glyph_item: typing.Callable[
        [Renderer, str | None, GlyphItem, int, int], None
    ] = ...

...
SCALE: int = 1024
VERSION_MAJOR: int = 1
VERSION_MICRO: int = 14
VERSION_MINOR: int = 50
VERSION_STRING: str = "1.50.14"
...
def attr_shape_new_with_data(
    ...
    copy_func: Optional[Callable[Concatenate[_VarArgs], None]] = None,
) -> Attribute: ...
...
def read_line(stream: Optional[Any], str: GLib.String) -> int: ...
...
class AttrList(GObject.GBoxed):
    ...
    def filter(
        self, func: Callable[Concatenate[Attribute, _VarArgs], bool], *data: Any
    ) -> Optional[AttrList]: ...
    @staticmethod
...
class AttrShape(GObject.GPointer):
    ...
    logical_rect: Rectangle = ...
    data: Any = ...
    copy_func: Callable[Concatenate[_VarArgs], None] = ...
    destroy_func: Callable[[Optional[Any]], None] = ...
    @staticmethod
...
class FontFaceClass(GObject.GPointer):
    ...
    _pango_reserved3: Any = ...
    _pango_reserved4: Any = ...
...
class Fontset(GObject.Object):
    ...
    parent_instance: GObject.Object = ...
    def do_foreach(
        self, func: Callable[Concatenate[Fontset, Font, _VarArgs], bool], *data: Any
    ) -> None: ...
...
class FontsetClass(GObject.GPointer):
    ...
    foreach: Callable[
        Concatenate[
            Fontset, Callable[Concatenate[Fontset, Font, _VarArgs], bool], _VarArgs
        ],
        None,
    ] = ...
    _pango_reserved1: Any = ...
    _pango_reserved2: Any = ...
    _pango_reserved3: Any = ...
    _pango_reserved4: Any = ...

...
def signal_handler_find(
    ...
    signal_id: int,
    detail: int,
    _closure: typing.Callable[..., typing.Any] | None,
    func: None,
    data: None,
    *closure: typing.Any,
) -> int: ...
...
def type_class_peek(type: typing.Type[typing.Any]) -> TypeClass | None: ...
...
def type_name(type: typing.Type[typing.Any]) -> str | None: ...
...
class Signal(str):
    ...
    def __init__(
        ...
        return_type: typing.Type[typing.Any] | None = None,
        arg_types: typing.Sequence[typing.Type[typing.Any]] | None = None,
        doc: str = "",
        accumulator: typing.Callable | None = None,
...
class TypeClass(GPointer):
    ...
    @staticmethod
    def peek(type: typing.Type[typing.Any]) -> TypeClass | None: ...
    def peek_parent(self) -> TypeClass: ...
    @staticmethod
    def peek_static(type: typing.Type[typing.Any]) -> TypeClass | None: ...
    @staticmethod
...
class TypeValueTable(GPointer):
    ...
    collect_value: typing.Callable[
        [typing.Any, typing.Sequence[TypeCValue], int], str | None
    ] = ...
    lcopy_format: str = ...
...
class ValueArray(GBoxed):
    ...
    values: typing.Any = ...
    n_prealloced: int = ...
    def append(self, value: typing.Any | None = None) -> ValueArray: ...
    def copy(self) -> ValueArray: ...
    def get_nth(self, index_: int) -> typing.Any: ...
    def insert(self, index_: int, value: typing.Any | None = None) -> ValueArray: ...
    @classmethod
    def new(cls, n_prealloced: int) -> ValueArray: ...
    def prepend(self, value: typing.Any | None = None) -> ValueArray: ...

...
def clear__handler(handler_id_ptr: int, instance: Object) -> None: ...
...
def remove_emission_hook(obj, detailed_, hook_id): ...  # FIXME Function
def set_application_name(application_name: str) -> None: ...
def set_prgname(prgname: str) -> None: ...
def _accumulator_first_wins(
    ihint, return_accu, handler_return, user_data=None
): ...  # FIXME Function
def _accumulator_true_handled(
    ihint, return_accu, handler_return, user_data=None
): ...  # FIXME Function
def _add_emission_hook(
    _id: int, detail: int, hook_func: Callable[..., bool], *hook_data: Any
) -> int: ...

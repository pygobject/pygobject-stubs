...
def enum_complete_type_info(
    g_enum_type: Type[Any], const_values: EnumValue
) -> TypeInfo: ...
...
def flags_complete_type_info(
    g_flags_type: Type[Any], const_values: FlagsValue
) -> TypeInfo: ...
...
def type_class_peek(type: Type[Any]) -> Optional[TypeClass]: ...
def type_class_peek_static(type: Type[Any]) -> Optional[TypeClass]: ...
...
def type_name(type: Type[Any]) -> Optional[str]: ...
...
class GInterface(Protocol):
    ...
    def freeze_notify(self) -> ContextManager[None]: ...
...
class SignalGroup(Object):
    ...
    props: Props = ...
    def __init__(
        self, target: Optional[Object] = ..., target_type: Type[Any] = ...
    ) -> None: ...
    def block(self) -> None: ...
    def connect_closure(
...
class TypeClass(GPointer):
    ...
    @staticmethod
    def peek(type: Type[Any]) -> Optional[TypeClass]: ...
    def peek_parent(self) -> TypeClass: ...
    @staticmethod
    def peek_static(type: Type[Any]) -> Optional[TypeClass]: ...
    @staticmethod
...
class TypeInterface(GPointer):
    ...
    def peek_parent(self) -> Optional[TypeInterface]: ...
    @staticmethod
...
class GFlags(int, Flag):
    ...
    def __new__(cls: Type[T], value: int | T) -> T: ...

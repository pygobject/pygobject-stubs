...
def binding_bind_property_full(
    ...
    target_property: str,
    flags: GObject.BindingFlags,
    transform_to: typing.Callable[..., typing.Any] | None = None,
    transform_from: typing.Callable[..., typing.Any] | None = None,
) -> GObject.Binding: ...
...
def webdav_discover_sources_full(
    ...
    only_supports: int,
    credentials: NamedParameters | None = None,
    ref_source_func: typing.Callable[..., Source | None] | None = None,
    cancellable: Gio.Cancellable | None = None,
    callback: typing.Callable[..., None] | None = None,
    *user_data: typing.Any,
) -> None: ...
...
class ClientClass(GObject.GPointer):
    ...
    retrieve_capabilities_sync: typing.Callable[
        [Client, Gio.Cancellable | None], typing.Tuple[bool, str]
    ] = ...
    ...
    get_backend_property_sync: typing.Callable[
        [Client, str, Gio.Cancellable | None], typing.Tuple[bool, str]
    ] = ...
    ...
    open_sync: typing.Callable[[Client, bool, Gio.Cancellable | None], bool] = ...
    remove: typing.Callable[..., None] = ...
    remove_finish: typing.Callable[[Client, Gio.AsyncResult], bool] = ...
    remove_sync: typing.Callable[[Client, Gio.Cancellable | None], bool] = ...
    refresh: typing.Callable[..., None] = ...
    refresh_finish: typing.Callable[[Client, Gio.AsyncResult], bool] = ...
    refresh_sync: typing.Callable[[Client, Gio.Cancellable | None], bool] = ...
    retrieve_properties_sync: typing.Callable[
        [Client, Gio.Cancellable | None], bool
    ] = ...
...
class GDataSession(SoupSession):
    ...
    def tasklists_list_sync(
        ...
        cb: typing.Callable[..., bool] | None = None,
        cancellable: Gio.Cancellable | None = None,
        *user_data: typing.Any,
    ) -> bool: ...
...
class OAuth2Service(GObject.GInterface):
    ...
    def get_access_token_sync(
        self,
        source: Source,
        ref_source: typing.Callable[..., Source | None],
        cancellable: Gio.Cancellable | None = None,
...
class OAuth2ServiceInterface(GObject.GPointer):
    ...
    guess_can_process: typing.Callable[
        [OAuth2Service, str | None, str | None], bool
    ] = ...
    ...
    get_client_secret: typing.Callable[[OAuth2Service, Source], str | None] = ...
    get_authentication_uri: typing.Callable[[OAuth2Service, Source], str] = ...
    get_refresh_uri: typing.Callable[[OAuth2Service, Source], str] = ...
    get_redirect_uri: typing.Callable[[OAuth2Service, Source], str | None] = ...
    ...
    extract_authorization_code: typing.Callable[
        [OAuth2Service, Source, str, str, str | None], typing.Tuple[bool, str]
    ] = ...
...
class SoupSession(Soup.Session):
    ...
    def util_ref_message_request_body(
        message: Soup.Message,
    ) -> typing.Tuple[Gio.InputStream | None, int]: ...
    @staticmethod
    ...
    def util_set_message_request_body_from_data(
        ...
        data: None,
        length: int,
        free_func: typing.Callable[[None], None] | None = None,
    ) -> None: ...
    @staticmethod
...
class SourceClass(GObject.GPointer):
    ...
    get_oauth2_access_token_sync: typing.Callable[
        [Source, Gio.Cancellable | None], typing.Tuple[bool, str, int]
    ] = ...
...
class SourceCredentialsProviderClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    ref_source: typing.Callable[[SourceCredentialsProvider, str], Source | None] = ...
...
class WebDAVSession(SoupSession):
    ...
    def replace_with_detailed_error(
        self,
        message: Soup.Message,
        response_data: typing.Sequence[int] | None,
    ...
    def report_sync(
        ...
        out_content: typing.Sequence[int] | None = None,
        cancellable: Gio.Cancellable | None = None,
        *func_user_data: typing.Any,
    ) -> bool: ...
    def set_acl_sync(

...
class ContentFormats(GObject.GBoxed):
    ...
    def get_gtypes(self) -> list[typing.Type[typing.Any]] | None: ...
    ...
    @classmethod
    def new(cls, mime_types: typing.Sequence[str] | None = None) -> ContentFormats: ...
    # override
    @classmethod
...
class ContentProvider(GObject.Object):
    ...
    @classmethod
    def new_union(
        cls, providers: typing.Sequence[ContentProvider] | None = None
    ) -> ContentProvider: ...
...
class Cursor(GObject.Object):
    ...
    def new_from_callback(
        ...
        callback: typing.Callable[
            ..., typing.Tuple[Texture | None, int, int, int, int]
        ],
...
class Device(GObject.Object):
    ...
    def get_surface_at_position(
        self,
    ) -> typing.Tuple[Surface | None, float, float]: ...
...
class DmabufTextureBuilder(GObject.Object):
    ...
    def build(
        self, destroy: typing.Callable[[None], None] | None, data: None
    ) -> Texture | None: ...

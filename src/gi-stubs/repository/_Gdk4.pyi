...
@deprecated("Use [class@Gdk.Texture] and subclasses instead cairo surfaces and pixbufs")
...
class ContentFormats(GObject.GBoxed):
    ...
    @classmethod
    def new_for_gtype(cls, type: Type) -> ContentFormats: ...
    @staticmethod
...
class GLTexture(Texture, Paintable, Gio.Icon, Gio.LoadableIcon):
    ...
    @deprecated(
        "[class@Gdk.GLTextureBuilder] supercedes this function and provides extended functionality for creating GL textures."
    )
    @classmethod
    def new(
        cls,

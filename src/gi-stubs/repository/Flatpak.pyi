...
def get_system_installations(cancellable: Optional[Gio.Cancellable] = None) -> list[Installation]: ...
...
class Installation(GObject.Object):
    ...
    def add_remote(self, remote: Remote, if_needed: bool, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def cleanup_local_refs_sync(self, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def create_monitor(self, cancellable: Optional[Gio.Cancellable] = None) -> Gio.FileMonitor: ...
    def drop_caches(self, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def fetch_remote_metadata_sync(self, remote_name: str, ref: Ref, cancellable: Optional[Gio.Cancellable] = None) -> GLib.Bytes: ...
    def fetch_remote_ref_sync(self, remote_name: str, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None) -> RemoteRef: ...
    def fetch_remote_ref_sync_full(self, remote_name: str, kind: RefKind, name: str, arch: Optional[str], branch: Optional[str], flags: QueryFlags, cancellable: Optional[Gio.Cancellable] = None) -> RemoteRef: ...
    def fetch_remote_size_sync(self, remote_name: str, ref: Ref, cancellable: Optional[Gio.Cancellable] = None) -> Tuple[bool, int, int]: ...
    def get_config(self, key: str, cancellable: Optional[Gio.Cancellable] = None) -> str: ...
    def get_current_installed_app(self, name: str, cancellable: Optional[Gio.Cancellable] = None) -> InstalledRef: ...
    def get_default_languages(self) -> list[str]: ...
    def get_default_locales(self) -> list[str]: ...
    def get_display_name(self) -> str: ...
    def get_id(self) -> str: ...
    def get_installed_ref(self, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None) -> InstalledRef: ...
    ...
    def get_remote_by_name(self, name: str, cancellable: Optional[Gio.Cancellable] = None) -> Remote: ...
    def get_storage_type(self) -> StorageType: ...
    def install(self, remote_name: str, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> InstalledRef: ...
    def install_bundle(self, file: Gio.File, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> InstalledRef: ...
    def install_full(self, flags: InstallFlags, remote_name: str, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, subpaths: Optional[Sequence[str]] = None, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> InstalledRef: ...
    def install_ref_file(self, ref_file_data: GLib.Bytes, cancellable: Optional[Gio.Cancellable] = None) -> RemoteRef: ...
    def launch(self, name: str, arch: Optional[str] = None, branch: Optional[str] = None, commit: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def launch_full(self, flags: LaunchFlags, name: str, arch: Optional[str] = None, branch: Optional[str] = None, commit: Optional[str] = None, instance_out: Optional[Instance] = None, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def list_installed_refs(self, cancellable: Optional[Gio.Cancellable] = None) -> list[InstalledRef]: ...
    def list_installed_refs_by_kind(self, kind: RefKind, cancellable: Optional[Gio.Cancellable] = None) -> list[InstalledRef]: ...
    def list_installed_refs_for_update(self, cancellable: Optional[Gio.Cancellable] = None) -> list[InstalledRef]: ...
    def list_installed_related_refs_sync(self, remote_name: str, ref: str, cancellable: Optional[Gio.Cancellable] = None) -> list[RelatedRef]: ...
    def list_pinned_refs(self, arch: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None) -> list[InstalledRef]: ...
    def list_remote_refs_sync(self, remote_or_uri: str, cancellable: Optional[Gio.Cancellable] = None) -> list[RemoteRef]: ...
    def list_remote_refs_sync_full(self, remote_or_uri: str, flags: QueryFlags, cancellable: Optional[Gio.Cancellable] = None) -> list[RemoteRef]: ...
    def list_remote_related_refs_for_installed_sync(self, remote_name: str, ref: str, cancellable: Optional[Gio.Cancellable] = None) -> list[RelatedRef]: ...
    def list_remote_related_refs_sync(self, remote_name: str, ref: str, cancellable: Optional[Gio.Cancellable] = None) -> list[RelatedRef]: ...
    def list_remotes(self, cancellable: Optional[Gio.Cancellable] = None) -> list[Remote]: ...
    def list_remotes_by_type(self, types: Sequence[RemoteType], cancellable: Optional[Gio.Cancellable] = None) -> list[Remote]: ...
    def list_unused_refs(self, arch: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None) -> list[InstalledRef]: ...
    def list_unused_refs_with_options(self, arch: Optional[str] = None, metadata_injection: Optional[dict[None, None]] = None, options: Optional[GLib.Variant] = None, cancellable: Optional[Gio.Cancellable] = None) -> list[InstalledRef]: ...
    def load_app_overrides(self, app_id: str, cancellable: Optional[Gio.Cancellable] = None) -> str: ...
    def modify_remote(self, remote: Remote, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    @classmethod
    def new_for_path(cls, path: Gio.File, user: bool, cancellable: Optional[Gio.Cancellable] = None) -> Installation: ...
    @classmethod
    def new_system(cls, cancellable: Optional[Gio.Cancellable] = None) -> Installation: ...
    @classmethod
    def new_system_with_id(cls, id: Optional[str] = None, cancellable: Optional[Gio.Cancellable] = None) -> Installation: ...
    @classmethod
    def new_user(cls, cancellable: Optional[Gio.Cancellable] = None) -> Installation: ...
    def prune_local_repo(self, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def remove_local_ref_sync(self, remote_name: str, ref: str, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def remove_remote(self, name: str, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def run_triggers(self, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def set_config_sync(self, key: str, value: str, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def set_no_interaction(self, no_interaction: bool) -> None: ...
    def uninstall(self, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> bool: ...
    def uninstall_full(self, flags: UninstallFlags, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> bool: ...
    def update(self, flags: UpdateFlags, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> InstalledRef: ...
    def update_appstream_full_sync(self, remote_name: str, arch: Optional[str] = None, progress: Optional[Callable[..., None]] = None, out_changed: Optional[bool] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> bool: ...
    def update_appstream_sync(self, remote_name: str, arch: Optional[str] = None, out_changed: Optional[bool] = None, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
    def update_full(self, flags: UpdateFlags, kind: RefKind, name: str, arch: Optional[str] = None, branch: Optional[str] = None, subpaths: Optional[Sequence[str]] = None, progress: Optional[Callable[..., None]] = None, cancellable: Optional[Gio.Cancellable] = None, *progress_data: Any) -> InstalledRef: ...
    def update_remote_sync(self, name: str, cancellable: Optional[Gio.Cancellable] = None) -> bool: ...
...
class InstalledRef(Ref):
    ...
    props: Props = ...
    parent: Ref = ...
    def __init__(self, appdata_content_rating: dict[None, None] = ...,
    ...
    def load_appdata(self, cancellable: Optional[Gio.Cancellable] = None) -> GLib.Bytes: ...
    def load_metadata(self, cancellable: Optional[Gio.Cancellable] = None) -> GLib.Bytes: ...
...
class RelatedRef(Ref):
    ...
    props: Props = ...
    parent: Ref = ...
    def __init__(self, should_autoprune: bool = ...,
                 should_delete: bool = ...,
                 should_download: bool = ...,
                 subpaths: Sequence[str] = ...,
                 arch: str = ...,
...
class RemoteRef(Ref):
    ...
    props: Props = ...
    parent: Ref = ...
    def __init__(self, download_size: int = ...,
                 end_of_life: str = ...,
                 end_of_life_rebase: str = ...,
                 installed_size: int = ...,
                 metadata: GLib.Bytes = ...,
...
class Transaction(GObject.Object, Gio.Initable):
    ...
    def add_install(self, remote: str, ref: str, subpaths: Optional[Sequence[str]] = None) -> bool: ...
    def add_install_bundle(self, file: Gio.File, gpg_data: Optional[GLib.Bytes] = None) -> bool: ...
    def add_install_flatpakref(self, flatpakref_data: GLib.Bytes) -> bool: ...
    def add_rebase(self, remote: str, ref: str, subpaths: Optional[str] = None, previous_ids: Optional[Sequence[str]] = None) -> bool: ...
    def add_sideload_repo(self, path: str) -> None: ...
    def add_uninstall(self, ref: str) -> bool: ...
    def add_update(self, ref: str, subpaths: Optional[Sequence[str]] = None, commit: Optional[str] = None) -> bool: ...
    def complete_basic_auth(self, id: int, user: str, password: str, options: GLib.Variant) -> None: ...
    def do_add_new_remote(self, reason: TransactionRemoteReason, from_id: str, remote_name: str, url: str) -> bool: ...
    def do_basic_auth_start(self, remote: str, realm: str, options: GLib.Variant, id: int) -> bool: ...
    def do_choose_remote_for_ref(self, for_ref: str, runtime_ref: str, remotes: str) -> int: ...
    def do_end_of_lifed(self, ref: str, reason: str, rebase: str) -> None: ...
    def do_end_of_lifed_with_rebase(self, remote: str, ref: str, reason: str, rebased_to_ref: str, previous_ids: str) -> bool: ...
    def do_install_authenticator(self, remote: str, authenticator_ref: str) -> None: ...
    def do_new_operation(self, operation: TransactionOperation, progress: TransactionProgress) -> None: ...
    def do_operation_done(self, operation: TransactionOperation, commit: str, details: TransactionResult) -> None: ...
    def do_operation_error(self, operation: TransactionOperation, error: GLib.Error, detail: TransactionErrorDetails) -> bool: ...
    ...
    def do_webflow_start(self, remote: str, url: str, options: GLib.Variant, id: int) -> bool: ...
    ...
    def get_operation_for_ref(self, remote: Optional[str], ref: str) -> TransactionOperation: ...
    def get_operations(self) -> list[TransactionOperation]: ...
    def get_parent_window(self) -> str: ...
    def is_empty(self) -> bool: ...
    @classmethod
    def new_for_installation(cls, installation: Installation, cancellable: Optional[Gio.Cancellable] = None) -> Transaction: ...
    ...
    def set_include_unused_uninstall_ops(self, include_unused_uninstall_ops: bool) -> None: ...
...
class TransactionClass(GObject.GPointer):
    ...
    """
    parent_class: GObject.ObjectClass = ...
    new_operation: Callable[[Transaction, TransactionOperation, TransactionProgress], None] = ...
    operation_done: Callable[[Transaction, TransactionOperation, str, TransactionResult], None] = ...
    operation_error: Callable[[Transaction, TransactionOperation, GLib.Error, TransactionErrorDetails], bool] = ...
    ...
    add_new_remote: Callable[[Transaction, TransactionRemoteReason, str, str, str], bool] = ...

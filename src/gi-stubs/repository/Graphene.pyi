...
class Sphere(GObject.GBoxed):
    ...
    def init_from_points(
        self, points: typing.Sequence[Point3D], center: Point3D | None = None
    ) -> Sphere: ...
    def init_from_vectors(
        self, vectors: typing.Sequence[Vec3], center: Point3D | None = None
    ) -> Sphere: ...
...
class Triangle(GObject.GBoxed):
    ...
    def free(self) -> None: ...
    def get_area(self) -> float: ...
    def get_barycoords(self, p: Point3D | None = None) -> typing.Tuple[bool, Vec2]: ...
    def get_bounding_box(self) -> Box: ...

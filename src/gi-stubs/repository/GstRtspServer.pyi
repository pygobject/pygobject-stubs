...
def rtsp_sdp_make_media(
    ...
    stream: RTSPStream,
    caps: Gst.Caps,
    profile: GstRtsp._RTSPProfileValueType,
) -> bool: ...
...
class RTSPAuth(GObject.Object):
    ...
    def do_accept_certificate(
        ...
        errors: Gio._TlsCertificateFlagsValueType,
        /,
    ) -> bool: ...
    ...
    def set_supported_methods(
        self, methods: GstRtsp._RTSPAuthMethodValueType
    ) -> None: ...
    def set_tls_authentication_mode(
        self, mode: Gio._TlsAuthenticationModeValueType
    ) -> None: ...
...
class RTSPClient(GObject.Object):
    ...
    def do_adjust_error_code(
        self, ctx: RTSPContext, code: GstRtsp._RTSPStatusCodeValueType, /
    ) -> GstRtsp.RTSPStatusCode: ...
    def do_adjust_play_mode(
        self,
        context: RTSPContext,
        range: GstRtsp.RTSPTimeRange,
        flags: Gst._SeekFlagsValueType,
        rate: float,
    ...
    def session_filter(
        self,
        func: Callable[[RTSPClient, RTSPSession, Unpack[_DataTs]], RTSPFilterResult]
        | None = None,
    ...
    def set_send_func(
        self,
        func: Callable[[RTSPClient, GstRtsp.RTSPMessage, bool, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class RTSPClientClass(_gi.Struct):
    ...
    def adjust_error_code(
        ...
        [RTSPClient, RTSPContext, GstRtsp._RTSPStatusCodeValueType],
        GstRtsp.RTSPStatusCode,
    ]: ...
...
class RTSPMedia(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        max_mcast_ttl: int
        @property
        def profiles(self) -> GstRtsp.RTSPProfile: ...
        @profiles.setter
        def profiles(self, value: GstRtsp._RTSPProfileValueType) -> None: ...
        @property
        def protocols(self) -> GstRtsp.RTSPLowerTrans: ...
        @protocols.setter
        def protocols(self, value: GstRtsp._RTSPLowerTransValueType) -> None: ...
        reusable: bool
        shared: bool
        stop_on_disconnect: bool
        @property
        def suspend_mode(self) -> RTSPSuspendMode: ...
        @suspend_mode.setter
        def suspend_mode(self, value: _RTSPSuspendModeValueType) -> None: ...
        time_provider: bool | None
        @property
        def transport_mode(self) -> RTSPTransportMode: ...
        @transport_mode.setter
        def transport_mode(self, value: _RTSPTransportModeValueType) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        latency: int = ...,
        max_mcast_ttl: int = ...,
        profiles: GstRtsp._RTSPProfileValueType = ...,
        protocols: GstRtsp._RTSPLowerTransValueType = ...,
        reusable: bool = ...,
        shared: bool = ...,
        stop_on_disconnect: bool = ...,
        suspend_mode: _RTSPSuspendModeValueType = ...,
        time_provider: bool | None = ...,
        transport_mode: _RTSPTransportModeValueType = ...,
    ) -> None: ...
    ...
    def do_convert_range(
        self, range: GstRtsp.RTSPTimeRange, unit: GstRtsp._RTSPRangeUnitValueType, /
    ) -> bool: ...
    def do_handle_message(self, message: Gst.Message, /) -> bool: ...
    def do_handle_sdp(self, sdp: GstSdp.SDPMessage, /) -> bool: ...
    def do_new_state(self, state: Gst._StateValueType, /) -> None: ...
    ...
    def do_target_state(self, state: Gst._StateValueType, /) -> None: ...
    ...
    def get_range_string(
        self, play: bool, unit: GstRtsp._RTSPRangeUnitValueType
    ) -> str | None: ...
    ...
    def seek_full(
        self, range: GstRtsp.RTSPTimeRange, flags: Gst._SeekFlagsValueType
    ) -> bool: ...
    def seek_trickmode(
        self,
        range: GstRtsp.RTSPTimeRange,
    ...
    def set_pipeline_state(self, state: Gst._StateValueType) -> None: ...
    def set_profiles(self, profiles: GstRtsp._RTSPProfileValueType) -> None: ...
    def set_protocols(self, protocols: GstRtsp._RTSPLowerTransValueType) -> None: ...
    def set_publish_clock_mode(self, mode: _RTSPPublishClockModeValueType) -> None: ...
    ...
    def set_state(
        self, state: Gst._StateValueType, transports: Sequence[RTSPStreamTransport]
    ) -> bool: ...
    def set_stop_on_disconnect(self, stop_on_disconnect: bool) -> None: ...
    def set_suspend_mode(self, mode: _RTSPSuspendModeValueType) -> None: ...
    def set_transport_mode(self, mode: _RTSPTransportModeValueType) -> None: ...
...
class RTSPMediaClass(_gi.Struct):
    ...
    def convert_range(
        ...
        [RTSPMedia, GstRtsp.RTSPTimeRange, GstRtsp._RTSPRangeUnitValueType], bool
    ]: ...
    @property
    ...
    @property
    def target_state(self) -> Callable[[RTSPMedia, Gst._StateValueType], None]: ...
    @property
    def new_state(self) -> Callable[[RTSPMedia, Gst._StateValueType], None]: ...
    @property
...
class RTSPMediaFactory(GObject.Object):
    ...
    class Props(GObject.Object.Props):
        ...
        @launch.setter
        def launch(self, value: str) -> None: ...
        max_mcast_ttl: int
        @property
        def profiles(self) -> GstRtsp.RTSPProfile: ...
        @profiles.setter
...
class RTSPServer(GObject.Object):
    ...
    def client_filter(
        self,
        func: Callable[[RTSPServer, RTSPClient, Unpack[_DataTs]], RTSPFilterResult]
        | None = None,
        *user_data: Unpack[_DataTs],
    ) -> list[RTSPClient]: ...
    def create_socket(
    ...
    @staticmethod
    def io_func(
        socket: Gio.Socket, condition: GLib._IOConditionValueType, server: RTSPServer
    ) -> bool: ...
    @classmethod
...
class RTSPSessionMedia(GObject.Object):
    ...
    def set_rtsp_state(self, state: GstRtsp._RTSPStateValueType) -> None: ...
    def set_state(self, state: Gst._StateValueType) -> bool: ...
    def set_transport(
...
class RTSPStream(GObject.Object):
    ...
    def add_multicast_client_address(
        ...
        rtp_port: int,
        rtcp_port: int,
        family: Gio._SocketFamilyValueType,
    ) -> bool: ...
    ...
    def get_multicast_address(
        self, family: Gio._SocketFamilyValueType
    ) -> RTSPAddress | None: ...
    ...
    def join_bin(
        self, bin: Gst.Bin, rtpbin: Gst.Element, state: Gst._StateValueType
    ) -> bool: ...
...
class RTSPStreamTransport(GObject.Object):
    ...
    def set_callbacks(
        self,
        send_rtp: Callable[[Gst.Buffer, int, Unpack[_DataTs]], bool],
        send_rtcp: Callable[[Gst.Buffer, int, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_keepalive(
        self, keep_alive: Callable[[Unpack[_DataTs]], None], *user_data: Unpack[_DataTs]
    ) -> None: ...
    def set_list_callbacks(
        self,
        send_rtp_list: Callable[[Gst.BufferList, int, Unpack[_DataTs]], bool],
        send_rtcp_list: Callable[[Gst.BufferList, int, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_message_sent(
        self,
        message_sent: Callable[[Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_message_sent_full(
        self,
        message_sent: Callable[[RTSPStreamTransport, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
_RTSPTransportModeLiteralType: TypeAlias = Literal[
    "GST_RTSP_TRANSPORT_MODE_PLAY", "GST_RTSP_TRANSPORT_MODE_RECORD", "play", "record"
]
_RTSPTransportModeValueType: TypeAlias = (
    RTSPTransportMode
    | _RTSPTransportModeLiteralType
...
_RTSPPublishClockModeLiteralType: TypeAlias = Literal[
...
_RTSPPublishClockModeValueType: TypeAlias = (
    RTSPPublishClockMode | _RTSPPublishClockModeLiteralType
)
...
_RTSPSuspendModeLiteralType: TypeAlias = Literal[
...
_RTSPSuspendModeValueType: TypeAlias = RTSPSuspendMode | _RTSPSuspendModeLiteralType

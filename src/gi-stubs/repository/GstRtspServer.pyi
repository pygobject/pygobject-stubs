...
class RTSPClient(GObject.Object):
    ...
    def session_filter(
        self,
        func: typing.Callable[..., RTSPFilterResult] | None = None,
...
class RTSPMediaClass(GObject.GPointer):
    ...
    prepare: typing.Callable[[RTSPMedia, RTSPThread | None], bool] = ...
...
class RTSPMediaFactoryClass(GObject.GPointer):
    ...
    construct: typing.Callable[
        [RTSPMediaFactory, GstRtsp.RTSPUrl], RTSPMedia | None
    ] = ...
...
class RTSPMountPointsClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    make_path: typing.Callable[[RTSPMountPoints, GstRtsp.RTSPUrl], str | None] = ...
...
class RTSPSession(GObject.Object):
    ...
    def dup_media(self, path: str) -> typing.Tuple[RTSPSessionMedia | None, int]: ...
    def filter(
        self,
        func: typing.Callable[..., RTSPFilterResult] | None = None,
        *user_data: typing.Any,
    ...
    def get_media(self, path: str) -> typing.Tuple[RTSPSessionMedia | None, int]: ...

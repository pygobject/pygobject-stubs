...
class Pixbuf(GObject.Object, Gio.Icon, Gio.LoadableIcon):
    ...
    def get_file_info(
        filename: str,
    ) -> typing.Tuple[PixbufFormat | None, int, int]: ...
    @staticmethod
    ...
    @classmethod
    def new_from_xpm_data(cls, data: typing.Sequence[str]) -> Pixbuf | None: ...
    def new_subpixbuf(
    ...
    def save_to_bufferv(
        self,
        type: str,
        option_keys: typing.Sequence[str] | None = None,
        option_values: typing.Sequence[str] | None = None,
...
class PixbufAnimationIterClass(GObject.GPointer):
    ...
    advance: typing.Callable[[PixbufAnimationIter, GLib.TimeVal | None], bool] = ...

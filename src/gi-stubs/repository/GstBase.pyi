...
) -> typing.Tuple[Gst.Caps | None, Gst.TypeFindProbability]: ...
...
def type_find_helper_for_data(
    obj: Gst.Object | None, data: typing.Sequence[int]
) -> typing.Tuple[Gst.Caps | None, Gst.TypeFindProbability]: ...
def type_find_helper_for_data_with_caps(
    obj: Gst.Object | None, data: typing.Sequence[int], caps: Gst.Caps
) -> typing.Tuple[Gst.Caps | None, Gst.TypeFindProbability]: ...
...
class AggregatorClass(GObject.GPointer):
    ...
    peek_next_sample: typing.Callable[
        [Aggregator, AggregatorPad], Gst.Sample | None
    ] = ...
...
class BaseSinkClass(GObject.GPointer):
    ...
    parent_class: Gst.ElementClass = ...
    get_caps: typing.Callable[[BaseSink, Gst.Caps | None], Gst.Caps] = ...
...
class BaseSrcClass(GObject.GPointer):
    ...
    parent_class: Gst.ElementClass = ...
    get_caps: typing.Callable[[BaseSrc, Gst.Caps | None], Gst.Caps] = ...
...
class PushSrc(BaseSrc):
    ...
    def do_alloc(self) -> typing.Tuple[Gst.FlowReturn, Gst.Buffer]: ...
    def do_create(self) -> typing.Tuple[Gst.FlowReturn, Gst.Buffer]: ...

...
class Adapter(GObject.Object):
    ...
    def get_list(self, nbytes: int) -> list[Gst.Buffer]: ...
    def map(self) -> bytes: ...
    ...
    def take_list(self, nbytes: int) -> list[Gst.Buffer]: ...
    def unmap(self) -> None: ...
...
class Aggregator(Gst.Element):
    ...
    class Props(Gst.Element.Props):
        ...
        start_time: int
        @property
        def start_time_selection(self) -> AggregatorStartTimeSelection: ...
        @start_time_selection.setter
        def start_time_selection(
            self, value: _AggregatorStartTimeSelectionValueType
        ) -> None: ...
    ...
    def __init__(
        ...
        *,
        ...
        min_upstream_latency: int = ...,
        start_time: int = ...,
        start_time_selection: _AggregatorStartTimeSelectionValueType = ...,
        name: str | None = ...,
        parent: Gst.Object = ...,
    ) -> None: ...
    ...
    def do_src_activate(self, mode: Gst._PadModeValueType, active: bool) -> bool: ...
...
class AggregatorClass(_gi.Struct):
    ...
    def src_activate(
        self,
    ) -> Callable[[Aggregator, Gst._PadModeValueType, bool], bool]: ...
    @property
...
class BaseParse(Gst.Element):
    ...
    def set_duration(
        self, fmt: Gst._FormatValueType, duration: int, interval: int
    ) -> None: ...
    def set_frame_rate(
...
class BaseParseClass(_gi.Struct):
    ...
    def convert(
        ...
        [BaseParse, Gst._FormatValueType, int, Gst._FormatValueType, int], bool
    ]: ...
    @property
...
class BaseSrc(Gst.Element):
    ...
    def set_format(self, format: Gst._FormatValueType) -> None: ...
    def set_live(self, live: bool) -> None: ...
    def start_complete(self, ret: Gst._FlowReturnValueType) -> None: ...
...
class BaseTransform(Gst.Element):
    ...
    def do_accept_caps(
        self, direction: Gst._PadDirectionValueType, caps: Gst.Caps
    ) -> bool: ...
    ...
    def do_fixate_caps(
        self, direction: Gst._PadDirectionValueType, caps: Gst.Caps, othercaps: Gst.Caps
    ) -> Gst.Caps: ...
    ...
    def do_query(
        self, direction: Gst._PadDirectionValueType, query: Gst.Query
    ) -> bool: ...
    ...
    def do_transform_caps(
        self, direction: Gst._PadDirectionValueType, caps: Gst.Caps, filter: Gst.Caps
    ) -> Gst.Caps: ...
...
class BaseTransformClass(_gi.Struct):
    ...
    def transform_caps(
        ...
        [BaseTransform, Gst._PadDirectionValueType, Gst.Caps, Gst.Caps], Gst.Caps
    ]: ...
    @property
    def fixate_caps(
        self,
    ...
    def accept_caps(
        self,
    ) -> Callable[[BaseTransform, Gst._PadDirectionValueType, Gst.Caps], bool]: ...
    @property
    def set_caps(self) -> Callable[[BaseTransform, Gst.Caps, Gst.Caps], bool]: ...
    @property
    def query(
        self,
    ) -> Callable[[BaseTransform, Gst._PadDirectionValueType, Gst.Query], bool]: ...
    @property
    ...
    def transform_size(
        ...
        [BaseTransform, Gst._PadDirectionValueType, Gst.Caps, int, Gst.Caps],
        tuple[bool, int],
    ]: ...
    @property
    def get_unit_size(
...
class CollectPads(Gst.Object):
    ...
    def clip_running_time(
        self, cdata: CollectData, buf: Gst.Buffer, user_data: int | Any | None = None
    ) -> tuple[Gst.FlowReturn, Gst.Buffer]: ...
    def event_default(
    ...
    def set_event_function(
        self,
        func: Callable[[CollectPads, CollectData, Gst.Event, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_flush_function(
        self,
        func: Callable[[CollectPads, Unpack[_DataTs]], None],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_flushing(self, flushing: bool) -> None: ...
    def set_function(
        self,
        func: Callable[[CollectPads, Unpack[_DataTs]], Gst.FlowReturn],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
    def set_query_function(
        self,
        func: Callable[[CollectPads, CollectData, Gst.Query, Unpack[_DataTs]], bool],
        *user_data: Unpack[_DataTs],
    ) -> None: ...
...
class FlowCombiner(GObject.GBoxed):
    ...
    def reset(self) -> None: ...
    def unref(self) -> None: ...
    def update_flow(self, fret: Gst._FlowReturnValueType) -> Gst.FlowReturn: ...
    def update_pad_flow(
        self, pad: Gst.Pad, fret: Gst._FlowReturnValueType
    ) -> Gst.FlowReturn: ...
...
_AggregatorStartTimeSelectionLiteralType: TypeAlias = Literal[
...
_AggregatorStartTimeSelectionValueType: TypeAlias = (
    AggregatorStartTimeSelection | _AggregatorStartTimeSelectionLiteralType
)

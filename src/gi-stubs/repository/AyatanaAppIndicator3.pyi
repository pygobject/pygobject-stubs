...
class IndicatorClass(GObject.GPointer):
    ...
    @property
    def new_icon(self) -> Callable[..., None]: ...
    @property
    def new_attention_icon(self) -> Callable[..., None]: ...
    @property
    def new_status(self) -> Callable[..., None]: ...
    @property
    def new_icon_theme_path(self) -> Callable[..., None]: ...
    @property
    def new_label(self) -> Callable[..., None]: ...
    @property
    def connection_changed(self) -> Callable[..., None]: ...
    @property
    def scroll_event(self) -> Callable[..., None]: ...
    @property
    def app_indicator_reserved_ats(self) -> Callable[[], None]: ...
    @property
    def fallback(self) -> None: ...
    @property
    def unfallback(self) -> Callable[[Indicator, _Gtk3.StatusIcon], None]: ...
    @property
    def app_indicator_reserved_1(self) -> Callable[[], None]: ...
    @property
    def app_indicator_reserved_2(self) -> Callable[[], None]: ...
    @property
    def app_indicator_reserved_3(self) -> Callable[[], None]: ...
    @property
    def app_indicator_reserved_4(self) -> Callable[[], None]: ...
    @property
    def app_indicator_reserved_5(self) -> Callable[[], None]: ...
    @property
    def app_indicator_reserved_6(self) -> Callable[[], None]: ...

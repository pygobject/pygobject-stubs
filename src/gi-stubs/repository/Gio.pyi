...
class InputStream:
    ...
    def close(self, cancellable: Optional[Cancellable]) -> bool: ...
    def close_async(
        self,
        io_priority: int,
        cancellable: Optional[Cancellable],
        callback: Optional[Union[AsyncReadyCallbackU, AsyncReadyCallback]],
        *user_data: Optional[Any],
    ) -> None: ...
    def close_finish(self, result: AsyncResult) -> bool: ...
    def has_pending(self) -> bool: ...
    def is_closed(self) -> bool: ...
    def read(self, cancellable: Optional[Cancellable]) -> Tuple[int, bytes]: ...
    def read_all(
        self, cancellable: Optional[Cancellable]
    ...
    def read_bytes(
        self, count: int, cancellable: Optional[Cancellable]
    ) -> GLib.Bytes: ...
    ...
    def skip(self, count: int, cancellable: Optional[Cancellable]) -> int: ...
    def skip_async(
        self,
        count: int,
        io_priority: int,
...
class OutputStream:
    ...
    def write_all(
        self, buffer: bytes, cancellable: Optional[Cancellable]
    ) -> Tuple[bool, int]: ...
    @overload
    def write_all_async(
        self,

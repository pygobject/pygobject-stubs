...
def bus_own_name(
    ...
    bus_acquired_closure: typing.Callable[..., typing.Any] | None = None,
    name_acquired_closure: typing.Callable[..., typing.Any] | None = None,
    name_lost_closure: typing.Callable[..., typing.Any] | None = None,
) -> int: ...
...
def bus_watch_name(
    ...
    name_appeared_closure: typing.Callable[..., typing.Any] | None = None,
    name_vanished_closure: typing.Callable[..., typing.Any] | None = None,
) -> int: ...
...
def content_type_set_mime_dirs(
    dirs: typing.Sequence[str] | None = None,
) -> None: ...
...
def dbus_annotation_info_lookup(
    annotations: typing.Sequence[DBusAnnotationInfo] | None, name: str
) -> str | None: ...
...
def unix_mount_at(
    mount_path: str,
) -> typing.Tuple[GioUnix.MountEntry | None, int]: ...
...
def unix_mount_entries_get_from_file(
    table_path: str,
) -> typing.Tuple[list[GioUnix.MountEntry] | None, int]: ...
...
def unix_mount_point_at(
    mount_path: str,
) -> typing.Tuple[GioUnix.MountPoint | None, int]: ...
...
def unix_mount_points_get_from_file(
    table_path: str,
) -> typing.Tuple[list[GioUnix.MountPoint] | None, int]: ...
...
class ActionGroupInterface(GObject.GPointer):
    ...
    get_action_state_hint: typing.Callable[
        [ActionGroup, str], GLib.Variant | None
    ] = ...
    get_action_state: typing.Callable[[ActionGroup, str], GLib.Variant | None] = ...
    change_action_state: typing.Callable[[ActionGroup, str, GLib.Variant], None] = ...
    activate_action: typing.Callable[
        [ActionGroup, str, GLib.Variant | None], None
    ] = ...
...
class ActionInterface(GObject.GPointer):
    ...
    get_parameter_type: typing.Callable[[Action], GLib.VariantType | None] = ...
    get_state_type: typing.Callable[[Action], GLib.VariantType | None] = ...
    get_state_hint: typing.Callable[[Action], GLib.Variant | None] = ...
    get_enabled: typing.Callable[[Action], bool] = ...
    get_state: typing.Callable[[Action], GLib.Variant | None] = ...
    change_state: typing.Callable[[Action, GLib.Variant], None] = ...
    activate: typing.Callable[[Action, GLib.Variant | None], None] = ...
...
class ActionMapInterface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    lookup_action: typing.Callable[[ActionMap, str], Action | None] = ...
...
class AppInfoIface(GObject.GPointer):
    ...
    get_id: typing.Callable[[AppInfo], str | None] = ...
    get_name: typing.Callable[[AppInfo], str] = ...
    get_description: typing.Callable[[AppInfo], str | None] = ...
    get_executable: typing.Callable[[AppInfo], str] = ...
    get_icon: typing.Callable[[AppInfo], Icon | None] = ...
    launch: typing.Callable[
        [AppInfo, list[File] | None, AppLaunchContext | None], bool
    ] = ...
    ...
    get_commandline: typing.Callable[[AppInfo], str | None] = ...
...
class AppLaunchContextClass(GObject.GPointer):
    ...
    get_display: typing.Callable[
        [AppLaunchContext, AppInfo, list[File]], str | None
    ] = ...
...
class ApplicationCommandLineClass(GObject.GPointer):
    ...
    get_stdin: typing.Callable[[ApplicationCommandLine], InputStream | None] = ...
...
class AsyncResultIface(GObject.GPointer):
    ...
    get_source_object: typing.Callable[[AsyncResult], GObject.Object | None] = ...
...
class BufferedInputStreamClass(GObject.GPointer):
    ...
    fill: typing.Callable[[BufferedInputStream, int, Cancellable | None], int] = ...
...
class CancellableClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    cancelled: typing.Callable[[Cancellable | None], None] = ...
...
class DBusConnection(GObject.Object, AsyncInitable, Initable):
    ...
    def add_filter(
        self,
        filter_function: typing.Callable[..., DBusMessage | None],
        *user_data: typing.Any,
    ) -> int: ...
    def call(
        self,
    ...
    def register_object_with_closures2(
        ...
        object_path: str,
        interface_info: DBusInterfaceInfo,
        method_call_closure: typing.Callable[..., typing.Any] | None = None,
        get_property_closure: typing.Callable[..., typing.Any] | None = None,
        set_property_closure: typing.Callable[..., typing.Any] | None = None,
    ) -> int: ...
...
class DBusInterfaceIface(GObject.GPointer):
    ...
    get_object: typing.Callable[[DBusInterface], DBusObject | None] = ...
    set_object: typing.Callable[[DBusInterface, DBusObject | None], None] = ...
    dup_object: typing.Callable[[DBusInterface], DBusObject | None] = ...
...
class DBusObjectIface(GObject.GPointer):
    ...
    get_interface: typing.Callable[[DBusObject, str], DBusInterface | None] = ...
...
class DBusObjectManagerClient(
    ...
    def new(
        ...
        name: str,
        object_path: str,
        get_proxy_type_func: typing.Callable[..., typing.Type[typing.Any]]
        | None = None,
        cancellable: Cancellable | None = None,
        callback: typing.Callable[..., None] | None = None,
        *user_data: typing.Any,
...
class DBusObjectManagerIface(GObject.GPointer):
    ...
    get_object: typing.Callable[[DBusObjectManager, str], DBusObject | None] = ...
    get_interface: typing.Callable[
        [DBusObjectManager, str, str], DBusInterface | None
    ] = ...
...
class DBusSubtreeVTable(GObject.GPointer):
    ...
    introspect: typing.Callable[..., list[DBusInterfaceInfo] | None] = ...
    dispatch: typing.Callable[..., DBusInterfaceVTable | None] = ...
    padding: list[None] = ...
...
class DesktopAppInfo(GObject.Object, AppInfo):
    ...
    def launch_uris_as_manager(
        ...
        user_setup: typing.Callable[..., None] | None = None,
        pid_callback: typing.Callable[..., None] | None = None,
    ...
    def launch_uris_as_manager_with_fds(
        ...
        launch_context: AppLaunchContext | None,
        spawn_flags: GLib.SpawnFlags,
        user_setup: typing.Callable[..., None] | None,
        pid_callback: typing.Callable[..., None] | None,
        stdin_fd: int,
        stdout_fd: int,
        stderr_fd: int,
        *pid_callback_data: typing.Any,
...
class DriveIface(GObject.GPointer):
    ...
    get_identifier: typing.Callable[[Drive, str], str | None] = ...
    ...
    get_sort_key: typing.Callable[[Drive], str | None] = ...
...
class DtlsConnection(GObject.GInterface):
    ...
    def set_advertised_protocols(
        self, protocols: typing.Sequence[str] | None = None
    ) -> None: ...
...
class DtlsConnectionInterface(GObject.GPointer):
    ...
    handshake: typing.Callable[[DtlsConnection, Cancellable | None], bool] = ...
    ...
    shutdown: typing.Callable[
        [DtlsConnection, bool, bool, Cancellable | None], bool
    ] = ...
    ...
    set_advertised_protocols: typing.Callable[
        [DtlsConnection, typing.Sequence[str] | None], None
    ] = ...
    get_negotiated_protocol: typing.Callable[[DtlsConnection], str | None] = ...
...
class File(GObject.GInterface):
    ...
    def copy_async(
        ...
        progress_callback_closure: typing.Callable[..., typing.Any] | None,
...
class FileEnumeratorClass(GObject.GPointer):
    ...
    next_file: typing.Callable[
        [FileEnumerator, Cancellable | None], FileInfo | None
    ] = ...
    close_fn: typing.Callable[[FileEnumerator, Cancellable | None], bool] = ...
...
class FileIOStreamClass(GObject.GPointer):
    ...
    seek: typing.Callable[
        [FileIOStream, int, GLib.SeekType, Cancellable | None], bool
    ] = ...
    can_truncate: typing.Callable[[FileIOStream], bool] = ...
    truncate_fn: typing.Callable[[FileIOStream, int, Cancellable | None], bool] = ...
    query_info: typing.Callable[[FileIOStream, str, Cancellable | None], FileInfo] = ...
    query_info_async: typing.Callable[..., None] = ...
    query_info_finish: typing.Callable[[FileIOStream, AsyncResult], FileInfo] = ...
    get_etag: typing.Callable[[FileIOStream], str | None] = ...
...
class FileIface(GObject.GPointer):
    ...
    get_uri_scheme: typing.Callable[[File], str | None] = ...
    get_basename: typing.Callable[[File], str | None] = ...
    get_path: typing.Callable[[File], str | None] = ...
    get_uri: typing.Callable[[File], str] = ...
    get_parse_name: typing.Callable[[File], str] = ...
    get_parent: typing.Callable[[File], File | None] = ...
    prefix_matches: typing.Callable[[File, File], bool] = ...
    get_relative_path: typing.Callable[[File, File], str | None] = ...
    ...
    read_fn: typing.Callable[[File, Cancellable | None], FileInputStream] = ...
    ...
    open_readwrite: typing.Callable[[File, Cancellable | None], FileIOStream] = ...
    ...
    query_exists: typing.Callable[[File, Cancellable | None], bool] = ...
...
class FileInputStreamClass(GObject.GPointer):
    ...
    query_info: typing.Callable[
        [FileInputStream, str, Cancellable | None], FileInfo
    ] = ...
    query_info_async: typing.Callable[..., None] = ...
...
class FileOutputStreamClass(GObject.GPointer):
    ...
    truncate_fn: typing.Callable[
        [FileOutputStream, int, Cancellable | None], bool
    ] = ...
    query_info: typing.Callable[
        [FileOutputStream, str, Cancellable | None], FileInfo
    ] = ...
    query_info_async: typing.Callable[..., None] = ...
    query_info_finish: typing.Callable[[FileOutputStream, AsyncResult], FileInfo] = ...
    get_etag: typing.Callable[[FileOutputStream], str | None] = ...
...
class IOStreamClass(GObject.GPointer):
    ...
    close_fn: typing.Callable[[IOStream, Cancellable | None], bool] = ...
    close_async: typing.Callable[..., None] = ...
...
class IconIface(GObject.GPointer):
    ...
    equal: typing.Callable[[Icon | None, Icon | None], bool] = ...
    to_tokens: typing.Callable[[Icon], typing.Tuple[bool, list[str], int]] = ...
    from_tokens: None = ...
    serialize: typing.Callable[[Icon], GLib.Variant | None] = ...
...
class InitableIface(GObject.GPointer):
    ...
    g_iface: GObject.TypeInterface = ...
    init: typing.Callable[[Initable, Cancellable | None], bool] = ...
...
class InputStreamClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    read_fn: typing.Callable[[InputStream, None, int, Cancellable | None], int] = ...
    skip: typing.Callable[[InputStream, int, Cancellable | None], int] = ...
    close_fn: typing.Callable[[InputStream, Cancellable | None], bool] = ...
...
class ListModelInterface(GObject.GPointer):
    ...
    get_item: typing.Callable[[ListModel, int], GObject.Object | None] = ...
...
class ListStore(
    ...
    def find_with_equal_func(
        ...
        equal_func: typing.Callable[
            [ObjectItemType | None, ObjectItemType | None], bool
        ],
        *user_data: typing.Any,
    ) -> typing.Tuple[bool, int]: ...
...
class MemoryInputStream(InputStream, PollableInputStream, Seekable):
    ...
    def add_data(
        ...
        destroy: typing.Callable[[None], None] | None = None,
    ) -> None: ...
    @classmethod
...
class MenuModelClass(GObject.GPointer):
    ...
    get_item_link: typing.Callable[[MenuModel, int, str], MenuModel | None] = ...
...
class MountIface(GObject.GPointer):
    ...
    get_uuid: typing.Callable[[Mount], str | None] = ...
    get_volume: typing.Callable[[Mount], Volume | None] = ...
    get_drive: typing.Callable[[Mount], Drive | None] = ...
    ...
    get_sort_key: typing.Callable[[Mount], str | None] = ...
...
class OutputStream(GObject.Object):
    ...
    def do_write_async(
        self,
        buffer: typing.Sequence[int] | None,
        io_priority: int,
        cancellable: Cancellable | None = None,
        callback: typing.Callable[..., None] | None = None,
        *user_data: typing.Any,
    ...
    def do_write_fn(
        self,
        buffer: typing.Sequence[int] | None = None,
        cancellable: Cancellable | None = None,
    ) -> int: ...
    def do_writev_async(
        self,
...
class OutputStreamClass(GObject.GPointer):
    ...
    flush: typing.Callable[[OutputStream, Cancellable | None], bool] = ...
    close_fn: typing.Callable[[OutputStream, Cancellable | None], bool] = ...
    ...
    writev_fn: typing.Callable[
        [OutputStream, typing.Sequence[OutputVector], Cancellable | None],
        typing.Tuple[bool, int],
    ] = ...
...
class PermissionClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    acquire: typing.Callable[[Permission, Cancellable | None], bool] = ...
    acquire_async: typing.Callable[..., None] = ...
    acquire_finish: typing.Callable[[Permission, AsyncResult], bool] = ...
    release: typing.Callable[[Permission, Cancellable | None], bool] = ...
...
class PollableOutputStreamInterface(GObject.GPointer):
    ...
    write_nonblocking: typing.Callable[
        [PollableOutputStream, typing.Sequence[int] | None], int
    ] = ...
...
class ProxyResolverInterface(GObject.GPointer):
    ...
    lookup: typing.Callable[[ProxyResolver, str, Cancellable | None], list[str]] = ...
...
class ResolverClass(GObject.GPointer):
    ...
    lookup_by_address: typing.Callable[
        [Resolver, InetAddress, Cancellable | None], str
    ] = ...
...
class SeekableIface(GObject.GPointer):
    ...
    seek: typing.Callable[
        [Seekable, int, GLib.SeekType, Cancellable | None], bool
    ] = ...
    can_truncate: typing.Callable[[Seekable], bool] = ...
    truncate_fn: typing.Callable[[Seekable, int, Cancellable | None], bool] = ...
...
class Settings(GObject.Object):
    ...
    def bind_with_mapping(
        ...
        get_mapping: typing.Callable[..., typing.Any] | None = None,
        set_mapping: typing.Callable[..., typing.Any] | None = None,
    ) -> None: ...
    def bind_writable(
    ...
    def set_strv(self, key: str, value: typing.Sequence[str] | None = None) -> bool: ...
...
class SimpleProxyResolver(GObject.Object, ProxyResolver):
    ...
    def new(
        ...
        ignore_hosts: typing.Sequence[str] | None = None,
    ) -> ProxyResolver: ...
...
class Socket(GObject.Object, DatagramBased, Initable):
    ...
    def send_message(
        ...
        vectors: typing.Sequence[OutputVector],
        messages: typing.Sequence[SocketControlMessage] | None,
        flags: int,
        cancellable: Cancellable | None = None,
    ) -> int: ...
...
class Task(GObject.Object, AsyncResult):
    ...
    def return_pointer(
        self,
        result: None,
        result_destroy: typing.Callable[[None], None] | None = None,
    ) -> None: ...
    def return_value(self, result: typing.Any | None = None) -> None: ...
    def run_in_thread(
        self,
        task_func: typing.Callable[
            [Task, GObject.Object, None, Cancellable | None], None
        ],
    ) -> None: ...
    ...
    def set_task_data(
        self,
        task_data: None,
        task_data_destroy: typing.Callable[[None], None] | None = None,
    ) -> None: ...
...
class TlsCertificate(GObject.Object):
    ...
    @classmethod
    def new_from_pkcs12(
        cls, data: typing.Sequence[int], password: str | None = None
    ) -> TlsCertificate: ...
    def verify(
        self,
        identity: SocketConnectable | None = None,
...
class TlsConnection(IOStream):
    ...
    def __init__(
        self,
        *,
        advertised_protocols: typing.Sequence[str] | None = ...,
        base_io_stream: IOStream = ...,
...
class TlsConnectionClass(GObject.GPointer):
    ...
    handshake: typing.Callable[[TlsConnection, Cancellable | None], bool] = ...
    handshake_async: typing.Callable[..., None] = ...
    ...
    get_negotiated_protocol: typing.Callable[[TlsConnection], str | None] = ...
    padding: list[None] = ...
...
class TlsDatabaseClass(GObject.GPointer):
    ...
    create_certificate_handle: typing.Callable[
        [TlsDatabase, TlsCertificate], str | None
    ] = ...
...
class Vfs(GObject.Object):
    ...
    def register_uri_scheme(
        self,
        scheme: str,
        uri_func: typing.Callable[..., File | None] | None = None,
        parse_name_func: typing.Callable[..., File | None] | None = None,
...
class VolumeIface(GObject.GPointer):
    ...
    get_uuid: typing.Callable[[Volume], str | None] = ...
    get_drive: typing.Callable[[Volume], Drive | None] = ...
    get_mount: typing.Callable[[Volume], Mount | None] = ...
...
class VolumeMonitorClass(GObject.GPointer):
    ...
    get_volume_for_uuid: typing.Callable[[VolumeMonitor, str], Volume | None] = ...
    get_mount_for_uuid: typing.Callable[[VolumeMonitor, str], Mount | None] = ...

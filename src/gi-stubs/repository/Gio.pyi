...
class ActionGroupInterface(GObject.GPointer):
    ...
    get_action_state_type: Callable[[ActionGroup, str], Optional[GLib.VariantType]] = (
        ...
    )
...
class DBusMessage(GObject.Object):
    ...
    def get_arg0_path(self) -> Optional[str]: ...
...
class DBusObjectManagerIface(GObject.GPointer):
    ...
    get_interface: Callable[[DBusObjectManager, str, str], Optional[DBusInterface]] = (
        ...
    )
    object_added: Callable[[DBusObjectManager, DBusObject], None] = ...
    object_removed: Callable[[DBusObjectManager, DBusObject], None] = ...
    interface_added: Callable[[DBusObjectManager, DBusObject, DBusInterface], None] = (
        ...
    )
...
class FileEnumeratorClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    next_file: Callable[[FileEnumerator, Optional[Cancellable]], Optional[FileInfo]] = (
        ...
    )
...
class FileIOStreamClass(GObject.GPointer):
    ...
    seek: Callable[[FileIOStream, int, GLib.SeekType, Optional[Cancellable]], bool] = (
        ...
    )
...
class MountOperationClass(GObject.GPointer):
    ...
    parent_class: GObject.ObjectClass = ...
    ask_password: Callable[[MountOperation, str, str, str, AskPasswordFlags], None] = (
        ...
    )
...
class ResolverClass(GObject.GPointer):
    ...
    lookup_by_address: Callable[[Resolver, InetAddress, Optional[Cancellable]], str] = (
        ...
    )
...
class Socket(GObject.Object, DatagramBased, Initable):
    ...
    def receive_bytes(
        self, size: int, timeout_us: int, cancellable: Optional[Cancellable] = None
    ) -> GLib.Bytes: ...
...
class SubprocessLauncher(GObject.Object):
    ...
    def set_stdin_file_path(self, path: Optional[str] = None) -> None: ...

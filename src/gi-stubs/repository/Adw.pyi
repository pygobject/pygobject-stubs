...
class AboutWindow(Window):
    def add_acknowledgement_section(self, name: Union[str, None], people: list[str]) -> None: ...
    def add_credit_section(self, name: Union[str, None], people: list[str]) -> None: ...
    def add_legal_section(self, title: str, copyright: Union[str, None], license_type: Gtk.License, license: Union[str, None]): ...
...
class Avatar(Gtk.Widget):
    ...
    @classmethod
    def new(cls, size: int, text: Union[str, None], show_initials: bool) -> Gtk.Widget: ...
...
class PropertyAnimationTarget(AnimationTarget):
    ...
    @classmethod
    def new_for_pspec(cls, object: GObject.Object, pspec: GObject.ParamSpec) -> AnimationTarget: ...
...
class SpringParams:
    ...
    @classmethod
    def new(cls, damping_ratio: float, mass: float, stiffness: float) -> SpringParams: ...
    @classmethod
    def new_full(cls, damping: float, mass: float, stiffness: float) -> SpringParams: ...
...
class ViewStack(Gtk.Widget):
    ...
    def add_titled_with_icon(self, child: Gtk.Widget, name: Union[str, None], title: str, icon_name: str) -> ViewStackPage: ...
    def get_child_by_name(self, name: str) -> Union[Gtk.Widget, None]: ...

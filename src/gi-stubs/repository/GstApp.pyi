...
class AppSink(GstBase.BaseSink, Gst.URIHandler):
    ...
    def try_pull_object(self, timeout: int) -> gi.repository.Gst.MiniObject | None: ...
...
class AppSinkClass(GObject.GPointer):
    ...
    pull_preroll: typing.Callable[[AppSink], Gst.Sample | None] = ...
    pull_sample: typing.Callable[[AppSink], Gst.Sample | None] = ...
    try_pull_preroll: typing.Callable[[AppSink, int], Gst.Sample | None] = ...
    try_pull_sample: typing.Callable[[AppSink, int], Gst.Sample | None] = ...
    try_pull_object: typing.Callable[[AppSink, int], Gst.MiniObject | None] = ...

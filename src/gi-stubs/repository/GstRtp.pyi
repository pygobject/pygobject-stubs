...
def buffer_add_rtp_source_meta(
    buffer: Gst.Buffer,
    ssrc: typing.Optional[int] = None,
    csrc: typing.Optional[typing.Sequence[int]] = None,
) -> RTPSourceMeta: ...
def buffer_get_rtp_source_meta(
    buffer: Gst.Buffer,
) -> typing.Optional[RTPSourceMeta]: ...
def rtcp_buffer_map(
    buffer: Gst.Buffer, flags: Gst.MapFlags, rtcp: RTCPBuffer
) -> bool: ...
def rtcp_buffer_new(mtu: int) -> Gst.Buffer: ...
def rtcp_buffer_new_copy_data(data: typing.Sequence[int]) -> Gst.Buffer: ...
def rtcp_buffer_new_take_data(data: typing.Sequence[int]) -> Gst.Buffer: ...
def rtcp_buffer_validate(buffer: Gst.Buffer) -> bool: ...
def rtcp_buffer_validate_data(data: typing.Sequence[int]) -> bool: ...
def rtcp_buffer_validate_data_reduced(data: typing.Sequence[int]) -> bool: ...
...
def rtp_buffer_ext_timestamp(timestamp: int) -> typing.Tuple[int, int]: ...
...
def rtp_buffer_new_copy_data(data: typing.Sequence[int]) -> Gst.Buffer: ...
def rtp_buffer_new_take_data(data: typing.Sequence[int]) -> Gst.Buffer: ...
def rtp_get_header_extension_list() -> list[Gst.ElementFactory]: ...
def rtp_hdrext_get_ntp_56(data: typing.Sequence[int]) -> typing.Tuple[bool, int]: ...
def rtp_hdrext_get_ntp_64(data: typing.Sequence[int]) -> typing.Tuple[bool, int]: ...
...
) -> typing.Optional[RTPPayloadInfo]: ...
def rtp_payload_info_for_pt(payload_type: int) -> typing.Optional[RTPPayloadInfo]: ...
def rtp_source_meta_api_get_type() -> typing.Type[typing.Any]: ...
...
class RTCPBuffer(GObject.GPointer):
    ...
    @staticmethod
    def new_copy_data(data: typing.Sequence[int]) -> Gst.Buffer: ...
    @staticmethod
    def new_take_data(data: typing.Sequence[int]) -> Gst.Buffer: ...
    def unmap(self) -> bool: ...
    @staticmethod
    def validate(buffer: Gst.Buffer) -> bool: ...
    @staticmethod
    def validate_data(data: typing.Sequence[int]) -> bool: ...
    @staticmethod
    def validate_data_reduced(data: typing.Sequence[int]) -> bool: ...
    @staticmethod
...
class RTCPPacket(GObject.GPointer):
    ...
    item_count: int = ...
    entry_offset: int = ...
    def add_profile_specific_ext(self, data: typing.Sequence[int]) -> bool: ...
    def add_rb(
        self,
        ssrc: int,
        fractionlost: int,
    ...
    def bye_add_ssrcs(self, ssrc: typing.Sequence[int]) -> bool: ...
    def bye_get_nth_ssrc(self, nth: int) -> int: ...
    def bye_get_reason(self) -> typing.Optional[str]: ...
    def bye_get_reason_len(self) -> int: ...
    def bye_get_ssrc_count(self) -> int: ...
    def bye_set_reason(self, reason: str) -> bool: ...
    def copy_profile_specific_ext(self) -> typing.Tuple[bool, bytes]: ...
    ...
    def get_profile_specific_ext(self) -> typing.Tuple[bool, bytes]: ...
    def get_profile_specific_ext_length(self) -> int: ...
    def get_rb(self, nth: int) -> typing.Tuple[int, int, int, int, int, int, int]: ...
    ...
    def sdes_add_entry(
        self, type: RTCPSDESType, data: typing.Sequence[int]
    ) -> bool: ...
    def sdes_add_item(self, ssrc: int) -> bool: ...
    def sdes_copy_entry(self, type: RTCPSDESType) -> typing.Tuple[bool, bytes]: ...
    def sdes_first_entry(self) -> bool: ...
    def sdes_first_item(self) -> bool: ...
    def sdes_get_entry(self, type: RTCPSDESType) -> typing.Tuple[bool, bytes]: ...
    ...
    def sr_get_sender_info(self) -> typing.Tuple[int, int, int, int, int]: ...
...
class RTPBaseAudioPayload(RTPBasePayload):
    ...
    def push(self, data: typing.Sequence[int], timestamp: int) -> Gst.FlowReturn: ...
...
class RTPBaseDepayloadClass(GObject.GPointer):
    ...
    set_caps: typing.Callable[[RTPBaseDepayload, Gst.Caps], bool] = ...
    process: typing.Callable[[RTPBaseDepayload, Gst.Buffer], Gst.Buffer] = ...
    packet_lost: typing.Callable[[RTPBaseDepayload, Gst.Event], bool] = ...
    handle_event: typing.Callable[[RTPBaseDepayload, Gst.Event], bool] = ...
    process_rtp_packet: typing.Callable[[RTPBaseDepayload, RTPBuffer], Gst.Buffer] = ...
...
class RTPBasePayload(Gst.Element):
    ...
    def set_outcaps_structure(
        self, s: typing.Optional[Gst.Structure] = None
    ) -> bool: ...
    def set_source_info_enabled(self, enable: bool) -> None: ...
...
class RTPBasePayloadClass(GObject.GPointer):
    ...
    parent_class: Gst.ElementClass = ...
    get_caps: typing.Callable[[RTPBasePayload, Gst.Pad, Gst.Caps], Gst.Caps] = ...
    set_caps: typing.Callable[[RTPBasePayload, Gst.Caps], bool] = ...
    handle_buffer: typing.Callable[[RTPBasePayload, Gst.Buffer], Gst.FlowReturn] = ...
    sink_event: typing.Callable[[RTPBasePayload, Gst.Event], bool] = ...
    src_event: typing.Callable[[RTPBasePayload, Gst.Event], bool] = ...
    query: typing.Callable[[RTPBasePayload, Gst.Pad, Gst.Query], bool] = ...
...
class RTPBuffer(GObject.GPointer):
    ...
    data: list[None] = ...
    size: list[int] = ...
    def add_extension_onebyte_header(
        self, id: int, data: typing.Sequence[int]
    ) -> bool: ...
    def add_extension_twobytes_header(
        self, appbits: int, id: int, data: typing.Sequence[int]
    ) -> bool: ...
    @staticmethod
    def allocate_data(
        buffer: Gst.Buffer, payload_len: int, pad_len: int, csrc_count: int
    ...
    @staticmethod
    def ext_timestamp(timestamp: int) -> typing.Tuple[int, int]: ...
    def get_csrc(self, idx: int) -> int: ...
    def get_csrc_count(self) -> int: ...
    def get_extension(self) -> bool: ...
    def get_extension_data(self) -> typing.Tuple[typing.Optional[GLib.Bytes], int]: ...
    def get_extension_onebyte_header(
        self, id: int, nth: int
    ) -> typing.Tuple[bool, bytes]: ...
    @staticmethod
...
class RTPHeaderExtensionClass(GObject.GPointer):
    ...
    parent_class: Gst.ElementClass = ...
    get_supported_flags: typing.Callable[
        [RTPHeaderExtension], RTPHeaderExtensionFlags
    ] = ...
    get_max_size: typing.Callable[[RTPHeaderExtension, Gst.Buffer], int] = ...
    ...
    read: typing.Callable[
        [RTPHeaderExtension, RTPHeaderExtensionFlags, typing.Sequence[int], Gst.Buffer],
        bool,
    ] = ...
    set_non_rtp_sink_caps: typing.Callable[[RTPHeaderExtension, Gst.Caps], bool] = ...
    update_non_rtp_src_caps: typing.Callable[[RTPHeaderExtension, Gst.Caps], bool] = ...
    set_attributes: typing.Callable[
        [RTPHeaderExtension, RTPHeaderExtensionDirection, str], bool
    ] = ...
    set_caps_from_attributes: typing.Callable[
        [RTPHeaderExtension, Gst.Caps], bool
    ] = ...
    def set_uri(self, uri: str) -> None: ...
...
class RTPPayloadInfo(GObject.GPointer):
    ...
    bitrate: int = ...
    @staticmethod
    def for_name(media: str, encoding_name: str) -> typing.Optional[RTPPayloadInfo]: ...
    @staticmethod
    def for_pt(payload_type: int) -> typing.Optional[RTPPayloadInfo]: ...
...
class RTPSourceMeta(GObject.GPointer):
    ...
    csrc: list[int] = ...
    csrc_count: int = ...
    def append_csrc(self, csrc: typing.Sequence[int]) -> bool: ...
    @staticmethod
    def get_info() -> Gst.MetaInfo: ...
    def get_source_count(self) -> int: ...
    def set_ssrc(self, ssrc: typing.Optional[int] = None) -> bool: ...
